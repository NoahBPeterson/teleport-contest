...
export function* u_entered_shop(enterstring) {
    ...
    if ((!((cptr.ldI32o((shkp), $monst_mpeaceful) & 1)))) {
        if (!Deaf() && !(helpless(shkp) || cptr.ld1uo(cptr.ldPtro((shkp), $monst_data), $permonst_msound) <= NHC.MS_ANIMAL)) {
            ...
            (yield* pline(__s_s_seems_s_over_your_return_to_s_s, (yield* Shknam(shkp)), cptr.ldPtro(angrytexts, (rng_log_enabled() ? (rng_log_set_caller(__s_shk_c, 820, __s_u_entered_shop), rn2(3)) : rn2(3)), 8), (cptr.ldPtro2(genders, pronoun_gender(shkp, 3), $sizeof_Gender, $Gender_his)), cptr.ldPtro(shtypes, (rt - NHC.SHOPBASE) | 0, $sizeof_shclass)));
        }
...
function* make_itemized_bill(shkp, ibill_p) {
    ...
    for (i = 0; i < ebillct; ++i) {
        ...
        if (cptr.ldI64o(otmp, $obj_quan) == 0n || cptr.ld1so(otmp, $obj_where) == NHM.OBJ_ONBILL) {
            ...
            cptr.st1o2(ibill, n, $sizeof_Bill, $sortbill_item_usedup, NHC.PartlyUsedUp);
            ++n;
        }
    ...
    cptr.stI32o2(ibill, n, $sizeof_Bill, $sortbill_item_bidx, -1);
    if (n > 1)
...
function* menu_pick_pay_items(ibillct, ibill) {
    ...
    for (i = 0; i < ibillct; ++i) {
        ...
        cptr.stI64o(otmp, $obj_quan, cptr.ldI64o2(ibill, i, $sizeof_Bill, $sortbill_item_quan));
    ...
    for (j = 0; j < n; ++j) {
        i = (cptr.ldI32o(pick_list.v, j, $sizeof_menu_item) - 1) | 0;
...
function* pay_billed_items(shkp, ibillct, ibill, stashed_gold, paid_p) {
    ...
    for (indx = 0; indx < ibillct; ++indx) {
        if (queuedpay && !cptr.ld1so2(ibill, indx, $sizeof_Bill, $sortbill_item_queuedpay))
            continue;
        otmp = cptr.ldPtro(ibill, indx, $sizeof_Bill);
...
function* buy_container(shkp, indx, ibillct, ibill) {
    ...
    for (j = 0; j < boidsct; ++j) {
        ...
        cptr.stI64o2(ibill, indx, $sizeof_Bill, $sortbill_item_cost, cptr.ldI64o2(ibill, indx, $sizeof_Bill, $sortbill_item_cost) - (BigInt.asIntN(64, cptr.ldI64o(bp, $bill_x_price) * cptr.ldI64o(bp, $bill_x_bquan))));
...
function* getcad(shkp, dmgstr, x, y, uinshp, animal, pursue) {
    ...
    if ((helpless(shkp) || cptr.ld1uo(cptr.ldPtro((shkp), $monst_data), $permonst_msound) <= NHC.MS_ANIMAL)) {
        ...
        if (!Deaf()) {
            ...
            (yield* pline(__s_s_is_s_that_you_decided_to_s_s_s, (yield* Shknam(shkp)), cptr.ldPtro(angrytexts, (rng_log_enabled() ? (rng_log_set_caller(__s_shk_c, 5155, __s_getcad), rn2(3)) : rn2(3)), 8), dmgstr, (cptr.ldPtro2(genders, pronoun_gender(shkp, 3), $sizeof_Gender, $Gender_his)), dugwall ? __s_shop : __s_door));
        }
    } else {
        if (!Deaf()) {
            ...
            (yield* pline(__s_s_is_s_that_someone_decided_to_s_s_s, (yield* Shknam(shkp)), cptr.ldPtro(angrytexts, (rng_log_enabled() ? (rng_log_set_caller(__s_shk_c, 5166, __s_getcad), rn2(3)) : rn2(3)), 8), dmgstr, (cptr.ldPtro2(genders, pronoun_gender(shkp, 3), $sizeof_Gender, $Gender_his)), dugwall ? __s_shop : __s_door));
        }
    }
    hot_pursuit(shkp);
}
