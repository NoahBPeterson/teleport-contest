...
function* io_type(L) {
    ...
    if (cptr.eq(p, (null)))
        (yield* lua_pushnil(L));
    else if ((cptr.ldPtro((p), FLD.LStream_closef) === (null)))
...
function* f_tostring(L) {
    ...
    if ((cptr.ldPtro((p), FLD.LStream_closef) === (null)))
...
function* tofile(L) {
    let p = ((yield* luaL_checkudata(L, 1, __sl2)));
    if ((__builtin_expect(BigInt((((cptr.ldPtro((p), FLD.LStream_closef) === (null))) != 0)), 0n)))
...
function* newprefile(L) {
    ...
    cptr.stPtro(p, FLD.LStream_closef, null);
...
function* aux_close(L) {
    let p = ((yield* luaL_checkudata(L, 1, __sl2)));
    let cf = cptr.ldPtro(p, FLD.LStream_closef);
    cptr.stPtro(p, FLD.LStream_closef, null);
...
function* f_gc(L) {
    let p = ((yield* luaL_checkudata(L, 1, __sl2)));
    if (!(cptr.ldPtro((p), FLD.LStream_closef) === (null)) && !cptr.eq(cptr.ldPtr(p), (null)))
        (yield* aux_close(L));
    return 0;
}
...
function* newfile(L) {
    ...
    cptr.stPtr(p, null);
    cptr.stPtro(p, FLD.LStream_closef, io_fclose);
    return p;
}
...
function* io_popen(L) {
    ...
    cptr.stPtro(p, FLD.LStream_closef, io_pclose);
    return (cptr.eq(cptr.ldPtr(p), (null))) ? (yield* luaL_fileresult(L, 0, filename)) : 1;
}
...
function* nextc(rn) {
    if ((__builtin_expect(BigInt(((cptr.ldI32o(rn, FLD.RN_n) >= 200) != 0)), 0n))) {
        cptr.st1o2(rn, 0, 1, FLD.RN_buff, 0);
        return 0;
    } else {
        cptr.st1o2(rn, (cptr.stI32o(rn, FLD.RN_n, cptr.ldI32o(rn, FLD.RN_n) + 1)) - (1), 1, FLD.RN_buff, schar(cptr.ldI32o(rn, FLD.RN_c)));
        cptr.stI32o(rn, FLD.RN_c, (cptr.stI32o((cptr.ldPtr(rn)), FLD.FILE__r, cptr.ldI32o((cptr.ldPtr(rn)), FLD.FILE__r) + -1) < 0 ? __srget(cptr.ldPtr(rn)) : (cptr.ld1u(cptr.postinc(() => cptr.ldPtr((cptr.ldPtr(rn))), (v) => { cptr.stPtr((cptr.ldPtr(rn)), v); })))));
        return 1;
    }
}
...
function* test2(rn, set) {
    if (cptr.ldI32o(rn, FLD.RN_c) == cptr.ld1so(set, 0) || cptr.ldI32o(rn, FLD.RN_c) == cptr.ld1so(set, 1))
...
function* readdigits(rn, hex) {
    let count = 0;
    while ((hex ? isxdigit(cptr.ldI32o(rn, FLD.RN_c)) : isdigit(cptr.ldI32o(rn, FLD.RN_c))) && (yield* nextc(rn)))
        count++;
    return count;
}
...
function* read_number(L, f) {
    ...
    ungetc(cptr.ldI32o(rn, FLD.RN_c), cptr.ldPtr(rn));
    funlockfile(cptr.ldPtr(rn));
    cptr.st1o2(rn, cptr.ldI32o(rn, FLD.RN_n), 1, FLD.RN_buff, 0);
    if ((__builtin_expect(BigInt((((yield* lua_stringtonumber(L, cptr.add(rn, FLD.RN_buff)))) != 0n)), 1n)))
        return 1;
    else {
        (yield* lua_pushnil(L));
        return 0;
...
function* read_line(L, f, chop) {
    ...
    do {
        ...
        let i = 0;
        flockfile(f);
        while (i < 1024 && (c = (cptr.stI32o((f), FLD.FILE__r, cptr.ldI32o((f), FLD.FILE__r) + -1) < 0 ? __srget(f) : (cptr.ld1u(cptr.postinc(() => cptr.ldPtr((f)), (v) => { cptr.stPtr((f), v); }))))) != -1 && c != 10)
            cptr.st1o(buff, i++, schar(c));
        funlockfile(f);
        (cptr.stU64o((b), FLD.luaL_Buffer_n, cptr.ldU64o((b), FLD.luaL_Buffer_n) + BigInt.asUintN(64, BigInt((i)))));
    } while (c != -1 && c != 10);
    if (!chop && c == 10)
        (void (cptr.ldU64o((b), FLD.luaL_Buffer_n) < cptr.ldU64o((b), FLD.luaL_Buffer_size) || (yield* luaL_prepbuffsize((b), 1n)) ? 1 : 0), (cptr.st1o(cptr.ldPtr((b)), (cptr.stU64o((b), FLD.luaL_Buffer_n, cptr.ldU64o((b), FLD.luaL_Buffer_n) + 1n)) - (1n), schar((c)))));
...
function* read_all(L, f) {
    ...
    do {
        ...
        (cptr.stU64o((b), FLD.luaL_Buffer_n, cptr.ldU64o((b), FLD.luaL_Buffer_n) + (nr)));
    } while (nr == 1024n);
    (yield* luaL_pushresult(b));
}
...
cptr.stPtro(iolib, 0 + FLD.luaL_Reg_func, io_close);
cptr.stPtro(iolib, 16, __sl35);
cptr.stPtro(iolib, 16 + FLD.luaL_Reg_func, io_flush);
cptr.stPtro(iolib, 32, __sl36);
cptr.stPtro(iolib, 32 + FLD.luaL_Reg_func, io_input);
cptr.stPtro(iolib, 48, __sl37);
cptr.stPtro(iolib, 48 + FLD.luaL_Reg_func, io_lines);
cptr.stPtro(iolib, 64, __sl38);
cptr.stPtro(iolib, 64 + FLD.luaL_Reg_func, io_open);
cptr.stPtro(iolib, 80, __sl39);
cptr.stPtro(iolib, 80 + FLD.luaL_Reg_func, io_output);
cptr.stPtro(iolib, 96, __sl40);
cptr.stPtro(iolib, 96 + FLD.luaL_Reg_func, io_popen);
cptr.stPtro(iolib, 112, __sl41);
cptr.stPtro(iolib, 112 + FLD.luaL_Reg_func, io_read);
cptr.stPtro(iolib, 128, __sl42);
cptr.stPtro(iolib, 128 + FLD.luaL_Reg_func, io_tmpfile);
cptr.stPtro(iolib, 144, __sl43);
cptr.stPtro(iolib, 144 + FLD.luaL_Reg_func, io_type);
cptr.stPtro(iolib, 160, __sl44);
cptr.stPtro(iolib, 160 + FLD.luaL_Reg_func, io_write);
cptr.stPtro(iolib, 176, null);
cptr.stPtro(iolib, 176 + FLD.luaL_Reg_func, null);

/** C ref: liolib.c:773 — luaL_Reg[8] */
const meth = cptr.alloc(8 * 16);
cptr.stPtro(meth, 0, __sl41);
cptr.stPtro(meth, 0 + FLD.luaL_Reg_func, f_read);
cptr.stPtro(meth, 16, __sl44);
cptr.stPtro(meth, 16 + FLD.luaL_Reg_func, f_write);
cptr.stPtro(meth, 32, __sl37);
cptr.stPtro(meth, 32 + FLD.luaL_Reg_func, f_lines);
cptr.stPtro(meth, 48, __sl35);
cptr.stPtro(meth, 48 + FLD.luaL_Reg_func, f_flush);
cptr.stPtro(meth, 64, __sl45);
cptr.stPtro(meth, 64 + FLD.luaL_Reg_func, f_seek);
cptr.stPtro(meth, 80, __sl34);
cptr.stPtro(meth, 80 + FLD.luaL_Reg_func, f_close);
cptr.stPtro(meth, 96, __sl46);
cptr.stPtro(meth, 96 + FLD.luaL_Reg_func, f_setvbuf);
cptr.stPtro(meth, 112, null);
cptr.stPtro(meth, 112 + FLD.luaL_Reg_func, null);

/** C ref: liolib.c:788 — luaL_Reg[5] */
const metameth = cptr.alloc(5 * 16);
cptr.stPtro(metameth, 0, __sl47);
cptr.stPtro(metameth, 0 + FLD.luaL_Reg_func, null);
cptr.stPtro(metameth, 16, __sl48);
cptr.stPtro(metameth, 16 + FLD.luaL_Reg_func, f_gc);
cptr.stPtro(metameth, 32, __sl49);
cptr.stPtro(metameth, 32 + FLD.luaL_Reg_func, f_gc);
cptr.stPtro(metameth, 48, __sl50);
cptr.stPtro(metameth, 48 + FLD.luaL_Reg_func, f_tostring);
cptr.stPtro(metameth, 64, null);
cptr.stPtro(metameth, 64 + FLD.luaL_Reg_func, null);
...
function* io_noclose(L) {
    let p = ((yield* luaL_checkudata(L, 1, __sl2)));
    cptr.stPtro(p, FLD.LStream_closef, io_noclose);
    (yield* lua_pushnil(L));
