...
export function* dohide() {
    ...
    if ((is_hider(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)) && !Flying()) && (Is_airlevel(cptr.add(u, $you_uz)) || Is_waterlevel(cptr.add(u, $you_uz)))) {
        (yield* There(__sl185));
        cptr.stI32o(u, $you_uundetected, 0);
        return NHM.ECMD_OK;
    }
