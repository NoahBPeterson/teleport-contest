...
export function* set_map_u(gmap, utf32ch, utf8str) {
    ...
    if (cptr.ldPtro(gmap, FLD.glyph_map_u) === null) {
        cptr.stPtro(gmap, FLD.glyph_map_u, (yield* alloc(16)));
    ...
    cptr.stPtro(cptr.ldPtro(gmap, FLD.glyph_map_u), FLD.unicode_representation_utf8str, (yield* dupstr(utf8str)));
...
export function* add_custom_urep_entry(customization_name, glyphidx, utf32ch, utf8str, which_set) {
    ...
    if (details) {
        while (details) {
            if (cptr.ldI32(details) == glyphidx) {
                ...
                if (utf32ch) {
                    cptr.stPtro(details, FLD.custom_urep_u + FLD.unicode_representation_utf8str, (yield* dupstr(utf8str)));
    ...
    if (utf8str && cptr.ld1u(utf8str)) {
        cptr.stPtro(newdetails, FLD.custom_urep_u + FLD.unicode_representation_utf8str, (yield* dupstr(utf8str)));
    } else {
...
export function* reset_customsymbols() {
    free_all_glyphmap_u();
    (yield* apply_customizations(cptr.ldI32o(gc, FLD.instance_globals_c_currentgraphics), NHC.do_custom_symbols));
}
