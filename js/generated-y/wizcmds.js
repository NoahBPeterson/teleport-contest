    ...
    for (; ; ) {
        ...
        if (((cptr.ldI16(cc)) == cptr.ldI16(u) && (cptr.ldI16o(cc, FLD.nhcoord_y)) == cptr.ldI16o(u, FLD.you_uy))) {
            if (cptr.ldPtro(u, FLD.you_usteed)) {
                void cptr.sprintf(cptr.decay(qbuf), __sl6, (yield* mon_nam(cptr.ldPtro(u, FLD.you_usteed))));
...
export function* wiz_flip_level() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        if (c && cptr.strchr(cptr.decay(__static_wiz_flip_level_choices), c)) {
            ...
            (yield* pline(__sl24, cptr.ldPtro(c_common_strings, FLD.c_common_strings_c_Never_mind)));
        }
    }
    return NHM.ECMD_OK;
}
    ...
    do {
        ...
        if ((((mtmp = (cptr.ldPtro3(svl, cptr.ldI16(cc), 168, cptr.ldI16o(cc, FLD.nhcoord_y), 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters))) !== null) && (canseemon(mtmp) || sensemon(mtmp))) || ((cptr.ldI16(cc)) == cptr.ldI16(u) && (cptr.ldI16o(cc, FLD.nhcoord_y)) == cptr.ldI16o(u, FLD.you_uy))) {
            if (!(yield* getdir(__sl32)))
                return NHM.ECMD_CANCEL;
            if (mtmp) {
                (yield* mhurtle(mtmp, cptr.ldI32o(u, FLD.you_dx), cptr.ldI32o(u, FLD.you_dy), 6));
                ...
                (yield* hurtle(cptr.ldI32o(u, FLD.you_dx), cptr.ldI32o(u, FLD.you_dy), 6, 0));
                cptr.stI16(cc, cptr.ldI16(u)), cptr.stI16o(cc, FLD.nhcoord_y, cptr.ldI16o(u, FLD.you_uy));
            }
        }
    ...
    do {
        ...
        if (mptr) {
            ...
            if (((glyph) == NHC.GLYPH_INVIS_OFF))
                (yield* unmap_invisible(cptr.ldI16(cc), cptr.ldI16o(cc, FLD.nhcoord_y)));
        }
    } while (1);
    return NHM.ECMD_OK;
}
...
function* you_sanity_check() {
    ...
    if (cptr.ldI32o(u, FLD.you_uen) > cptr.ldI32o(u, FLD.you_uenmax)) {
        (yield* impossible(__sl121, cptr.ldI32o(u, FLD.you_uen), cptr.ldI32o(u, FLD.you_uenmax)));
...
function* levl_sanity_check() {
    ...
    for (y = 0; y < NHM.ROWNO; y++) {
        for (x = 1; x < NHM.COLNO; x++) {
            if (((yield* does_block(x, y, cptr.add(cptr.add(cptr.add(svl, FLD.instance_globals_saved_l_level), x, 756), y, 36))) ? 1 : 0) != get_viz_clear(x, y))
...
export function* wiz_show_stats() {
    ...
    (yield* obj_chain(win, __sl144, cptr.ldPtro(gm, FLD.instance_globals_m_migrating_objs), 0, total_obj_count, total_obj_size));
    (yield* obj_chain(win, __sl145, cptr.ldPtro(gb, FLD.instance_globals_b_billobjs), 0, total_obj_count, total_obj_size));
...
export function* wiz_show_nhuuid() {
    (yield* pline(__sl165, cptr.add(svn, FLD.instance_globals_saved_n_nhuuid)));
    return NHM.ECMD_OK;
}
