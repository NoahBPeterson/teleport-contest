...
export function* intemple(roomno) {
    ...
    if ((priest = (yield* findpriest(schar(roomno)))) !== null) {
        ...
        if (!(rng_log_enabled() ? (rng_log_set_caller(__s_priest_c, 519, __s_intemple), rn2(5)) : rn2(5)) && (mtmp = (yield* makemon(cptr.add(mons, NHC.PM_GHOST, $sizeof_permonst), cptr.ldI16(u), cptr.ldI16o(u, $you_uy), NHM.MM_NOMSG))) !== null) {
