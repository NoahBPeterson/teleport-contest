...
export function* tactics(mtmp) {
    ...
    switch (strat) {
        ...
        if ((yield* In_W_tower(mx, my, cptr.add(u, $you_uz))) || ((cptr.ldI32o(mtmp, $monst_iswiz) & 1) | 0 && !sx.v && !mon_has_amulet(mtmp))) {
            if (!(yield* noteleport_level(mtmp)) && !(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 390, __s_tactics), rn2((3 + ((cptr.ldI32o(mtmp, $monst_mhp) / 10) | 0)) | 0)) : rn2((3 + ((cptr.ldI32o(mtmp, $monst_mhp) / 10) | 0)) | 0)))
        ...
        if (dist2((mx), (my), cptr.ldI16(u), cptr.ldI16o(u, $you_uy)) > 64)
            if (cptr.ldI32o(mtmp, $monst_mhp) <= ((cptr.ldI32o(mtmp, $monst_mhpmax) - 8) | 0)) {
                (yield* healmon(mtmp, (rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 406, __s_tactics), rnd(8)) : rnd(8)), 0));
                return 1;
            }
        // @FallThrough
        ;
        case 0n:
        if (!(yield* noteleport_level(mtmp)) && !(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 413, __s_tactics), rn2(!(cptr.ldI32o(mtmp, $monst_mflee) & 1) ? 5 : 33)) : rn2(!(cptr.ldI32o(mtmp, $monst_mflee) & 1) ? 5 : 33)))
        ...
        default:
        {
            ...
            if (where == 67108864n) {
                if (!(cptr.ldPtro3(svl, tx, 168, ty, 8, $instance_globals_saved_l_level + $dlevel_t_monsters) !== null) || (cptr.ldI16o(mtmp, $monst_mx) == tx && cptr.ldI16o(mtmp, $monst_my) == ty)) {
                    ...
                    if (!(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 453, __s_tactics), rn2(5)) : rn2(5)) && !(yield* noteleport_level(mtmp)))
                        (yield* mnexto(mtmp, NHM.RLOC_MSG));
                    return 0;
                }
            } else {
...
export function* cuss(mtmp) {
    ...
    if ((cptr.ldI32o(mtmp, $monst_iswiz) & 1)) {
        if (!(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 851, __s_cuss), rn2(5)) : rn2(5))) {
            ...
            ;
            (yield* verbalize(__s_relinquish_the_amulet_s, cptr.ldPtro(random_insult, (rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 856, __s_cuss), rn2(28)) : rn2(28)), 8)));
        } else if (cptr.ldI32o(u, $you_uhp) < 5 && !(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 857, __s_cuss), rn2(2)) : rn2(2))) {
            ;
            (yield* verbalize((rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 859, __s_cuss), rn2(2)) : rn2(2)) ? __s_even_now_thy_life_force_ebbs_s : __s_savor_thy_breath_s_it_be_thy_last, cptr.ldPtro(random_insult, (rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 861, __s_cuss), rn2(28)) : rn2(28)), 8)));
        } else if (cptr.ldI32o(mtmp, $monst_mhp) < 5 && !(rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 862, __s_cuss), rn2(2)) : rn2(2))) {
            ;
            (yield* verbalize((rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 864, __s_cuss), rn2(2)) : rn2(2)) ? __s_i_shall_return : __s_i_ll_be_back));
        } else {
            ;
            (yield* verbalize(__s_s_s, cptr.ldPtro(random_malediction, (rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 868, __s_cuss), rn2(11)) : rn2(11)), 8), cptr.ldPtro(random_insult, (rng_log_enabled() ? (rng_log_set_caller(__s_wizard_c, 869, __s_cuss), rn2(28)) : rn2(28)), 8)));
        }
        ...
        (yield* com_pager(__s_angel_cuss));
    } else {
