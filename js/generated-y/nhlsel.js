...
function* l_selection_line(L) {
    ...
    (yield* get_location_coord(x1, y1, NHM.ANY_LOC, cptr.ldPtro(gc, $instance_globals_c_coder) ? cptr.ldPtro(cptr.ldPtro(gc, $instance_globals_c_coder), $sp_coder_croom) : null, BigInt(SP_COORD_PACK(x1.v, y1.v))));
    (yield* get_location_coord(x2, y2, NHM.ANY_LOC, cptr.ldPtro(gc, $instance_globals_c_coder) ? cptr.ldPtro(cptr.ldPtro(gc, $instance_globals_c_coder), $sp_coder_croom) : null, BigInt(SP_COORD_PACK(x2.v, y2.v))));
    void (yield* l_selection_clone(L));
...
function* l_selection_flood(L) {
    ...
    (yield* get_location_coord(x, y, NHM.ANY_LOC, cptr.ldPtro(gc, $instance_globals_c_coder) ? cptr.ldPtro(cptr.ldPtro(gc, $instance_globals_c_coder), $sp_coder_croom) : null, BigInt(SP_COORD_PACK(x.v, y.v))));
    if (isok(x.v, y.v)) {
