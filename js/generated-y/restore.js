    ...
    while ((otmp = fobjtmp) !== null) {
        ...
        if (cptr.ldI16o(u, FLD.you_uz + FLD.d_level_dlevel)) {
            if (cptr.ldI64o(otmp, FLD.obj_owornmask) & 6291456n)
                (yield* setworn(otmp, cptr.ldI64o(otmp, FLD.obj_owornmask)));
        }
    }
}
...
function* restobj(nhfp, otmp) {
    ...
    if (cptr.ldPtro(otmp, FLD.obj_oextra)) {
        ...
        if (buflen.v > 0) {
            ...
            (yield* sfi_char(nhfp, (cptr.ldPtr(cptr.ldPtro((otmp), FLD.obj_oextra))), __sl7, buflen.v));
        }
        (yield* sfi_int(nhfp, buflen, __sl8));
        ;
        if (buflen.v > 0) {
            (yield* newomonst(otmp));
            (yield* restmon(nhfp, (cptr.ldPtro(cptr.ldPtro((otmp), FLD.obj_oextra), FLD.oextra_omonst))));
        }
...
function* restobjchn(nhfp, frozen) {
    ...
    while (1) {
        ...
        if (ghostly) {
            let nid = next_ident();
            (yield* add_id_mapping(cptr.ldI32o(otmp, FLD.obj_o_id), nid));
        ...
        if ((cptr.ldPtro((otmp), FLD.obj_cobj) !== null)) {
            let otmp3;
            cptr.stPtro(otmp, FLD.obj_cobj, (yield* restobjchn(nhfp, schar((cptr.ldI16o((otmp), FLD.obj_otyp) == NHC.ICE_BOX ? 1 : 0)))));
...
function* restmon(nhfp, mtmp) {
    ...
    if (cptr.ldPtro(mtmp, FLD.monst_mextra)) {
        ...
        if (buflen.v > 0) {
            ...
            (yield* sfi_char(nhfp, (cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra))), __sl19, buflen.v));
        }
        (yield* sfi_int(nhfp, buflen, __sl20));
        ;
        if (buflen.v > 0) {
            (yield* newegd(mtmp));
            (yield* sfi_egd(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_egd)), __sl21));
        }
        (yield* sfi_int(nhfp, buflen, __sl22));
        ;
        if (buflen.v > 0) {
            (yield* newepri(mtmp));
            (yield* sfi_epri(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_epri)), __sl23));
        }
        (yield* sfi_int(nhfp, buflen, __sl24));
        ;
        if (buflen.v > 0) {
            (yield* neweshk(mtmp));
            (yield* sfi_eshk(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_eshk)), __sl25));
        }
        (yield* sfi_int(nhfp, buflen, __sl26));
        ;
        if (buflen.v > 0) {
            (yield* newemin(mtmp));
            (yield* sfi_emin(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_emin)), __sl27));
        }
        (yield* sfi_int(nhfp, buflen, __sl28));
        ;
        if (buflen.v > 0) {
            (yield* newedog(mtmp));
            (yield* sfi_edog(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_edog)), __sl29));
        ...
        if (buflen.v > 0) {
            ...
            (yield* sfi_ebones(nhfp, (cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_ebones)), __sl31));
        }
...
function* restmonchn(nhfp) {
    ...
    while (1) {
        ...
        if (ghostly) {
            let nid = next_ident();
            (yield* add_id_mapping(cptr.ldI32o(mtmp, FLD.monst_m_id), nid));
        ...
        if (cptr.ldPtro(mtmp, FLD.monst_minvent)) {
            let obj;
            cptr.stPtro(mtmp, FLD.monst_minvent, (yield* restobjchn(nhfp, 0)));
...
function* ghostfruit(otmp) {
    ...
    if (!oldf)
        ...
        cptr.st1o(otmp, FLD.obj_spe, schar((yield* fruitadd(oldf, null))));
}
...
function* restgamestate(nhfp) {
    ...
    ;
    (yield* sfi_char(nhfp, cptr.add(cptr.add(svn, FLD.instance_globals_saved_n_nhuuid), 0, 1), __sl41, 37));
    (yield* sfi_long(nhfp, cptr.add(svm, FLD.instance_globals_saved_m_moves), __sl42));
    ;
    ...
    ;
    (yield* sfi_int32(nhfp, cptr.add(svw, FLD.instance_globals_saved_w_wtreserved), __sl47));
    ...
    cptr.stPtro(gi, FLD.instance_globals_i_invent, (yield* restobjchn(nhfp, 0)));
    bc_obj = (yield* restobjchn(nhfp, 0));
    while (bc_obj) {
        let nobj = cptr.ldPtr(bc_obj);
        cptr.stPtr(bc_obj, null);
        if (cptr.ldI64o(bc_obj, FLD.obj_owornmask))
            (yield* setworn(bc_obj, cptr.ldI64o(bc_obj, FLD.obj_owornmask)));
        bc_obj = nobj;
    }
    cptr.stPtro(gm, FLD.instance_globals_m_migrating_objs, (yield* restobjchn(nhfp, 0)));
    cptr.stPtro(gm, FLD.instance_globals_m_migrating_mons, (yield* restmonchn(nhfp)));
    for (i = 0; i < NHC.NUMMONS; ++i) {
        (yield* sfi_mvitals(nhfp, cptr.add(cptr.add(svm, FLD.instance_globals_saved_m_mvitals), i, 12), __sl53));
    }
    ...
    (yield* sfi_char(nhfp, cptr.add(svp, FLD.instance_globals_saved_p_pl_character), __sl56, 32));
    (yield* sfi_char(nhfp, cptr.add(svp, FLD.instance_globals_saved_p_pl_fruit), __sl57, 32));
    freefruitchn(cptr.ldPtro(gf, FLD.instance_globals_f_ffruit));
    cptr.stPtro(gf, FLD.instance_globals_f_ffruit, (yield* loadfruitchn(nhfp)));
...
export function* dorecover(nhfp) {
    ...
    rtmp = (yield* restlevelfile(schar(ledger_no(cptr.add(u, FLD.you_uz)))));
    if (rtmp < 2)
        return rtmp;
...
function* rest_stairs(nhfp) {
    ...
    while (1) {
        ...
        (yield* stairway_add(cptr.ldI16(stway), cptr.ldI16o(stway, FLD.stairway_sy), cptr.ld1so(stway, FLD.stairway_up), cptr.ld1so(stway, FLD.stairway_isladder), cptr.add(stway, FLD.stairway_tolev)));
...
function* rest_levl(nhfp) {
    ...
    for (c = 0; c < NHM.COLNO; ++c) {
        for (r = 0; r < NHM.ROWNO; ++r) {
            (yield* sfi_rm(nhfp, cptr.add(cptr.add(cptr.add(svl, FLD.instance_globals_saved_l_level), c, 756), r, 36), __sl65));
        }
    }
}
...
export function* getlev(nhfp, pid, lev) {
    ...
    if (ghostly)
        clear_id_mapping();
    if (ghostly)
        cptr.stPtro(go, FLD.instance_globals_o_oldfruit, (yield* loadfruitchn(nhfp)));
    ...
    (yield* restcemetery(nhfp, cptr.add(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_bonesinfo)));
    ...
    (yield* sfi_long(nhfp, cptr.add(svo, FLD.instance_globals_saved_o_omoves), __sl76));
    ;
    ...
    (yield* sfi_dest_area(nhfp, cptr.add(svd, FLD.instance_globals_saved_d_dndest), __sl78));
    (yield* sfi_levelflags(nhfp, cptr.add(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags), __sl79));
    ...
    (yield* sfi_int(nhfp, cptr.add(svd, FLD.instance_globals_saved_d_doors_alloc), __sl80));
    ;
    if (cptr.ldI32o(svd, FLD.instance_globals_saved_d_doors_alloc)) {
        cptr.stPtro(svd, FLD.instance_globals_saved_d_doors, (yield* alloc(Number(BigInt.asUintN(32, BigInt.asUintN(64, BigInt.asUintN(64, BigInt(cptr.ldI32o(svd, FLD.instance_globals_saved_d_doors_alloc))) * 4n))))));
    ...
    (yield* restore_light_sources(nhfp));
    cptr.stPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monlist, (yield* restmonchn(nhfp)));
    ...
    cptr.free((trap));
    cptr.stPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_objlist, (yield* restobjchn(nhfp, 0)));
    (yield* find_lev_obj());
    cptr.stPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_buriedobjlist, (yield* restobjchn(nhfp, 0)));
    cptr.stPtro(gb, FLD.instance_globals_b_billobjs, (yield* restobjchn(nhfp, 0)));
    ...
    if (ghostly) {
        ...
        if (lev > ledger_no(cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_medusa_level)) && lev < ledger_no(cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_stronghold_level)) && !stway) {
            ...
            (yield* mazexy(cc));
            (yield* stairway_add(cptr.ldI16(cc), cptr.ldI16o(cc, FLD.nhcoord_y), 0, 0, dest));
...
function* restore_gamelog(nhfp) {
    ...
    while (1) {
        ...
        (yield* gamelog_add(cptr.ldI64o(tmp, FLD.gamelog_line_flags), cptr.ldI64(tmp), cptr.decay(msg)));
    }
}
