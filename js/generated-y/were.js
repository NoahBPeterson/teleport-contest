...
export function* were_change(mon) {
    ...
    if (((cptr.ldU64o((cptr.ldPtro(mon, 8)), 80) & 8n) != 0n)) {
        if (!(cptr.ldI64o2(u, NHC.PROT_FROM_SHAPE_CHANGERS, 24, 128) || cptr.ldI64o2(u, NHC.PROT_FROM_SHAPE_CHANGERS, 24, 112)) && !(rng_log_enabled() ? (rng_log_set_caller(__sl0, 17, __sl1), rn2((yield* night()) ? (cptr.ldI32o(flags, 64) == NHM.FULL_MOON ? 3 : 30) : (cptr.ldI32o(flags, 64) == NHM.FULL_MOON ? 10 : 50))) : rn2((yield* night()) ? (cptr.ldI32o(flags, 64) == NHM.FULL_MOON ? 3 : 30) : (cptr.ldI32o(flags, 64) == NHM.FULL_MOON ? 10 : 50)))) {
            (yield* new_were(mon));
...
export function* new_were(mon) {
    ...
    if (cptr.ld1so(svc, 77) && !(cptr.ldI32o(mon, 168) & 1) && (yield* onscary(cptr.ldI16o(mon, 32), cptr.ldI16o(mon, 34), mon)) && monnear(mon, cptr.ldI16o(mon, 32), cptr.ldI16o(mon, 34)))
...
export function* you_unwere(purify) {
    ...
    if (!(cptr.ldI64o2(u, NHC.UNCHANGING, 24, 128) || cptr.ldI64o2(u, NHC.UNCHANGING, 24, 112)) && ((cptr.ldU64o((cptr.ldPtro(gy, 16)), 80) & 4n) != 0n) && !(yield* monster_nearby()) && (!controllable_poly || !(yield* paranoid_query(schar((((cptr.ldI32o(flags, 80) & NHM.PARANOID_WERECHANGE) >>> 0) != 0)), __sl13))))
        (yield* rehumanize());
