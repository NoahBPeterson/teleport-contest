...
export function* self_lookat(outbuf) {
    ...
    if (cptr.ldPtro(u, FLD.you_usteed))
        void cptr.sprintf(eos(outbuf), __sl5, (yield* y_monnam(cptr.ldPtro(u, FLD.you_usteed))));
    if ((cptr.ldI32o(u, FLD.you_uundetected) & 1) | 0 || ((cptr.ldI32o(u, FLD.you_umonnum) != cptr.ldI32o(u, FLD.you_umonster)) && (cptr.ld1uo(gy, FLD.instance_globals_y_youmonst + FLD.monst_m_ap_type) & NHM.M_AP_TYPMASK)) || visible_region_at(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)))
        (yield* mhidden_description(cptr.add(gy, FLD.instance_globals_y_youmonst), 11, eos(outbuf)));
    if ((uball.v !== null))
...
export function* mhidden_description(mon, mhid_flags, outbuf) {
    ...
    if (__go_objfrommap) {
        ...
        what = (otmp.v && cptr.ldI16o(otmp.v, FLD.obj_otyp) != NHC.STRANGE_OBJECT) ? (yield* simpleonames(otmp.v)) : cptr.ldPtro(obj_descr, NHC.STRANGE_OBJECT, 16);
...
export function* object_from_map(glyph, x, y, obj_p) {
    ...
    if (!otmp || cptr.ldI16o(otmp, FLD.obj_otyp) != glyphotyp) {
        if ((cptr.ldPtro(obj_descr, cptr.ldI16((cptr.add(objects, glyphotyp, 120))), 16))) {
            ...
            otmp = (yield* mkobj(cptr.ld1so2(objects, glyphotyp, 120, FLD.objclass_oc_class), 0));
        }
        ...
        cptr.stI32o(otmp, FLD.obj_no_charge, (cptr.ldI16o(otmp, FLD.obj_otyp) == NHC.STRANGE_OBJECT && (yield* costly_spot(x, y)) ? 1 : 0) >>> 0);
    }
...
function* look_at_object(buf, x, y, glyph) {
    ...
    if (otmp.v) {
        void cptr.strcpy(buf, (cptr.ldI16o(otmp.v, FLD.obj_otyp) != NHC.STRANGE_OBJECT) ? (yield* distant_name(otmp.v, (cptr.ldI32o(otmp.v, FLD.obj_dknown) & 1) | 0 ? doname_with_price : doname_vague_quan)) : cptr.ldPtro(obj_descr, NHC.STRANGE_OBJECT, 16));
        if (fakeobj) {
            cptr.st1o(otmp.v, FLD.obj_where, NHM.OBJ_FREE);
...
function* look_at_monster(buf, monbuf, mtmp, x, y) {
    ...
    name = (cptr.eq(cptr.ldPtro(mtmp, FLD.monst_data), cptr.add(mons, NHC.PM_COYOTE, 96)) && accurate) ? (yield* coyotename(mtmp, cptr.decay(monnambuf))) : (yield* distant_monnam(mtmp, NHM.ARTICLE_NONE, cptr.decay(monnambuf)));
...
function* lookat(x, y, buf, monbuf) {
    ...
    if (((x) == cptr.ldI16(u) && (y) == cptr.ldI16o(u, FLD.you_uy)) && ((((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked)) || (cptr.ldI32o(u, FLD.you_uswallow) & 1) | 0 || (!(((cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops + FLD.prop_blocked)) && !(cptr.ldI64o2(u, NHC.SEE_INVIS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.SEE_INVIS, 24, FLD.you_uprops))) && !(cptr.ldI32o(u, FLD.you_uundetected) & 1))) || ((cptr.ldI64o2(u, NHC.TELEPAT, 24, FLD.you_uprops)) || (cptr.ldI64o2(u, NHC.DETECT_MONSTERS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.DETECT_MONSTERS, 24, FLD.you_uprops)))) && !((cptr.ldI32o(iflags, FLD.instance_flags_save_uswallow) & 1) | 0 && glyph == ((((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? ((yield* Y.icall((rn2_on_display_rng)(NHC.NUMMONS)))) : (cptr.ldI32o((cptr.ldPtro((cptr.ldPtro(u, FLD.you_ustuck)), FLD.monst_data)), FLD.permonst_pmidx))) + ((((cptr.ldI32o((cptr.ldPtro(u, FLD.you_ustuck)), FLD.monst_female) & 1) | 0) == 0) ? NHC.GLYPH_MON_MALE_OFF : NHC.GLYPH_MON_FEM_OFF)) | 0)) && (!cptr.ldI32o(iflags, FLD.instance_flags_terrainmode) || ((cptr.ldI32o(iflags, FLD.instance_flags_terrainmode) & NHM.TER_MON) >>> 0) != 0)) {
        ...
        void cptr.sprintf(buf, __sl85, (yield* mon_nam(cptr.ldPtro(u, FLD.you_ustuck))));
                ...
                if (found_in_file) {
                    ...
                    if (user_typed_name || without_asking || yes_to_moreinfo) {
                        ...
                        for (i = 0; i < entry_count.v; i++) {
                            ...
                            (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(datawin, 0, tp)));
                        }
                        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(datawin, 0)));
                        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(datawin))), datawin = -1;
                    }
...
function* add_cmap_descr(found, idx, glyph, article, cc, x_str, prefix, hit_trap, firstmatch, out_str) {
    ...
    if (glyph == NHC.MAX_GLYPH) {
        ...
        mbuf = (yield* mon_nam(cptr.add(gy, FLD.instance_globals_y_youmonst)));
        if (absidx == NHC.S_pool) {
        ...
        if (cptr.eq(x_str, cptr.decay(__static_do_screen_description_unreconnoitered)))
            {
                if (looked) {
                    ...
                    if (found > 1 || need_to_look) {
                        ...
                        pm = (yield* lookat(cptr.ldI16(cc), cptr.ldI16o(cc, FLD.nhcoord_y), cptr.decay(__static_do_screen_description_look_buf), cptr.decay(monbuf)));
                        ...
                        if (!strcmp(cptr.decay(__static_do_screen_description_look_buf), __sl151) && on_level(cptr.add(u, FLD.you_uz), cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_qstart_level)) && !(yield* ok_to_quest()))
        ...
        if (!cptr.ldI32o(iflags, FLD.instance_flags_terrainmode) || ((cptr.ldI32o(iflags, FLD.instance_flags_terrainmode) & NHM.TER_MON) >>> 0) != 0) {
            for (i = 1; i < NHC.MAXMCLASSES; i++) {
                ...
                if (sym == (looked ? cptr.ld1uo2(gs, (i + (((((0) + NHC.MAXPCHARS) | 0) + NHC.MAXOCLASSES) | 0)) | 0, 1, FLD.instance_globals_s_showsyms) : cptr.ld1so(def_monsyms, i, 24)) && cptr.ldPtro2(def_monsyms, i, 24, FLD.class_sym_explain) && cptr.ld1s(cptr.ldPtro2(def_monsyms, i, 24, FLD.class_sym_explain))) {
                    need_to_look = 1;
                    if (!found) {
                        void cptr.sprintf(out_str, __sl148, cptr.decay(prefix), (yield* an(cptr.ldPtro2(def_monsyms, i, 24, FLD.class_sym_explain))));
                        cptr.stPtr(firstmatch, cptr.ldPtro2(def_monsyms, i, 24, FLD.class_sym_explain));
                        found++;
                    } else {
                        found = (found + (yield* append_str(out_str, (yield* an(cptr.ldPtro2(def_monsyms, i, 24, FLD.class_sym_explain)))))) | 0;
                    }
                }
            }
...
export function* do_look(mode, click_cc) {
    ...
    __dispatch: while (true) {
        ...
        if (quick) {
            ...
            cptr.st1(any, 47);
            (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 47 : 121)), NHM.ATR_NONE, clr, __sl175, NHM.MENU_ITEMFLAGS_NONE));
            cptr.st1(any, 105);
            (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), 0, NHM.ATR_NONE, clr, __sl176, NHM.MENU_ITEMFLAGS_NONE));
            cptr.st1(any, 63);
            (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 63 : 110)), NHM.ATR_NONE, clr, __sl177, NHM.MENU_ITEMFLAGS_NONE));
            if (!(cptr.ldI32o(u, FLD.you_uswallow) & 1) && !(cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops)))) {
                ...
                cptr.st1(any, 109);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 0)), NHM.ATR_NONE, clr, __sl178, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 77);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 0)), NHM.ATR_NONE, clr, __sl179, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 111);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 0)), NHM.ATR_NONE, clr, __sl180, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 79);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 0)), NHM.ATR_NONE, clr, __sl181, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 116);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 94)), NHM.ATR_NONE, clr, __sl182, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 84);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 34)), NHM.ATR_NONE, clr, __sl183, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 101);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : 96)), NHM.ATR_NONE, clr, __sl184, NHM.MENU_ITEMFLAGS_NONE));
                cptr.st1(any, 69);
                (yield* add_menu(win, nul_glyphinfo.v, any, schar((cptr.ld1so(flags, FLD.flag_lootabc) ? 0 : cptr.ld1s(any))), schar((cptr.ld1so(flags, FLD.flag_lootabc) ? cptr.ld1s(any) : 124)), NHM.ATR_NONE, clr, __sl185, NHM.MENU_ITEMFLAGS_NONE));
            }
            (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_end_menu))(win, __sl186)));
        ...
        do {
            ...
            if (found) {
                (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putmixed))(WIN_MESSAGE.v, 0, cptr.decay(out_str))));
                {
        ...
        for (x = lo_x.v; x <= hi_x.v; x++) {
            ...
            if (cptr.ld1s(cptr.decay(lookbuf))) {
                ...
                if (count == 1) {
                    ...
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(outbuf))));
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl197)));
                }
                ...
                (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putmixed))(win, 0, cptr.decay(outbuf))));
            }
        }
    }
    if (count)
    ...
    for (y = lo_y.v; y <= hi_y.v; y++) {
        for (x = lo_x.v; x <= hi_x.v; x++) {
            ...
            if (((glyph) >= ((NHC.GLYPH_CMAP_B_OFF + ((NHC.S_arrow_trap - NHC.S_grave) | 0)) | 0) && (glyph) < (((((NHC.GLYPH_CMAP_B_OFF + ((NHC.S_arrow_trap - NHC.S_grave) | 0)) | 0)) + ((NHC.TRAPNUM - 1) | 0)) | 0))) {
                ...
                void cptr.strcpy(cptr.decay(lookbuf), (yield* trapname((cptr.ldI32o(t, FLD.trap_ttyp) & 31) | 0, 0)));
            ...
            if (cptr.ld1s(cptr.decay(lookbuf))) {
                ...
                if (count == 1) {
                    ...
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, upstart(cptr.decay(outbuf)))));
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl197)));
                }
        ...
        if (bp || bp2) {
            ...
            if (yes_to_moreinfo) {
                ...
                for (i = 0; cptr.ldPtro(textp, i, 8); i++) {
                    ...
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(datawin, 0, txt)));
                }
                (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(datawin, 0)));
                (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(datawin))), datawin = -1;
            }
...
export function* doidtrap() {
    ...
    for (trap = cptr.ldPtr(gf); trap; trap = cptr.ldPtr(trap))
        if (cptr.ldI16o(trap, FLD.trap_tx) == x && cptr.ldI16o(trap, FLD.trap_ty) == y) {
            ...
            (yield* pline(__sl238, (yield* an((yield* trapname(tt, 0)))), !(cptr.ldI32o(trap, FLD.trap_madeby_u) & 1) ? __sl4 : ((tt == NHC.WEB) ? __sl239 : ((tt == NHC.HOLE || tt == NHC.PIT) ? __sl240 : __sl241)), !(cptr.ldI32o(trap, FLD.trap_madeby_u) & 1) ? __sl4 : __sl242));
            return NHM.ECMD_OK;
        }
    (yield* pline(__sl243));
    return NHM.ECMD_OK;
...
export function* dowhatdoes() {
    ...
    if (!__static_dowhatdoes_once) {
        (yield* pline(__sl247, cptr.ld1so(iflags, FLD.instance_flags_altmeta) ? __sl248 : __sl4));
...
/** C ref: pager.c:2718 */
function* docontact() {
    let cwin = (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_create_nhwindow))(NHM.NHW_TEXT)));
    let buf = new Uint8Array(256);
    if (cptr.ldPtr(sysopt)) {
        void cptr.sprintf(cptr.decay(buf), __sl254, cptr.ldPtr(sysopt));
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, cptr.decay(buf))));
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, __sl4)));
    ...
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, __sl256)));
    void cptr.sprintf(cptr.decay(buf), __sl257, __sl258);
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, cptr.decay(buf))));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, __sl4)));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, __sl259)));
    void cptr.sprintf(cptr.decay(buf), __sl260, __sl261);
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(cwin, 0, cptr.decay(buf))));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(cwin, 0)));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(cwin)));
}

/** C ref: pager.c:2748 */
function* dispfile_help() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl262, 1)));
}

/** C ref: pager.c:2754 */
function* dispfile_shelp() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl263, 1)));
}

/** C ref: pager.c:2760 */
function* dispfile_optionfile() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl264, 1)));
}

/** C ref: pager.c:2766 */
function* dispfile_optmenu() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl265, 1)));
}

/** C ref: pager.c:2772 */
function* dispfile_license() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl266, 1)));
}

/** C ref: pager.c:2778 */
function* dispfile_debughelp() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl267, 1)));
}

/** C ref: pager.c:2784 */
function* dispfile_usagehelp() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl268, 1)));
}
...
export function* dohelp() {
    ...
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_end_menu))(tmpwin, __sl286)));
...
export function* dohistory() {
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_display_file))(__sl294, 1)));
    return NHM.ECMD_OK;
}
