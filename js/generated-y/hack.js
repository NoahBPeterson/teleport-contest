    ...
    if (!ufall) {
        ...
        for (obj = cptr.ldPtro3(svl, cptr.ldI16(u), 168, cptr.ldI16o(u, $you_uy), 8, $instance_globals_saved_l_level + $dlevel_t_objects); obj; obj = cptr.ldPtro(obj, $obj_v))
            if (cptr.ld1so(obj, $obj_oclass) == NHC.WEAPON_CLASS || is_weptool(obj)) {
                ...
                (yield* losehp(((Half_physical_damage()) ? ((((((rng_log_enabled() ? (rng_log_set_caller(__s_hack_c, 870, __s_dosinkfall), rnd(3)) : rnd(3))) + 1) | 0) / 2) | 0) : ((rng_log_enabled() ? (rng_log_set_caller(__s_hack_c, 870, __s_dosinkfall), rnd(3)) : rnd(3)))), cptr.decay(__static_dosinkfall_fell_on_sink), NHM.NO_KILLER_PREFIX));
...
function* maybe_smudge_engr(x1, y1, x2, y2) {
    ...
    if (can_reach_floor(1)) {
        if ((ep = engr_at(x1, y1)) && cptr.ld1so(ep, $engr_engr_type) != NHM.HEADSTONE)
            (yield* wipe_engr_at(x1, y1, i16((rng_log_enabled() ? (rng_log_set_caller(__s_hack_c, 3026, __s_maybe_smudge_engr), rnd(5)) : rnd(5))), 0));
        if ((x2 != x1 || y2 != y1) && (ep = engr_at(x2, y2)) && cptr.ld1so(ep, $engr_engr_type) != NHM.HEADSTONE)
            (yield* wipe_engr_at(x2, y2, i16((rng_log_enabled() ? (rng_log_set_caller(__s_hack_c, 3029, __s_maybe_smudge_engr), rnd(5)) : rnd(5))), 0));
    }
}
    ...
    if ((cptr.ldI32o(u, $you_uinwater) & 1)) {
        ...
        if (!is_pool(cptr.ldI16(u), cptr.ldI16o(u, $you_uy))) {
            if ((((cptr.ldI16o((cptr.add(svd, $instance_globals_saved_d_dungeon_topology + $dgn_topology_d_water_level)), $d_level_dlevel) || cptr.ldI16((cptr.add(svd, $instance_globals_saved_d_dungeon_topology + $dgn_topology_d_water_level)))) && on_level(cptr.add(u, $you_uz), cptr.add(svd, $instance_globals_saved_d_dungeon_topology + $dgn_topology_d_water_level))))) {
                ...
                (yield* You(__s_leave_the_s, hliquid(__s_water)));
            } else {
...
export function* unmul(msg_override) {
    ...
    if (cptr.ld1s(cptr.ldPtro(gn, $instance_globals_n_nomovemsg))) {
        ...
        if (Upolyd() && !(yield* strncmpi(cptr.ldPtro(gn, $instance_globals_n_nomovemsg), __s_you_survived_that, 18)))
            (yield* You(__s_are_s, (yield* an(pmname(cptr.add(mons, cptr.ldI32o(u, $you_umonnum), 96), Ugender())))));
    }
...
export function* dump_weights() {
    ...
    for (i = 0; i < mcount; ++i) {
        if (i != NHC.PM_LONG_WORM_TAIL) {
            ...
            nh_snprintf(__s_dump_weights, 4444, cptr.add(cptr.decay(nmbuf), 7, 1), 249n, __s_s_s__3, __s_the_body_of, (cm) ? (yield* the(cptr.ldPtro3(mons, i, 96, NHC.NEUTRAL, 8, 0))) : (cptr.ld1so2(weightlist, cnt, 32, $weight_table_entry_unique) ? cptr.ldPtro3(mons, i, 96, NHC.NEUTRAL, 8, 0) : (yield* an(cptr.ldPtro3(mons, i, 96, NHC.NEUTRAL, 8, 0)))));
    ...
    for (i = 0; i < ocount; ++i) {
        ...
        if (wt && oc_name) {
            ...
            nh_snprintf(__s_dump_weights, 4463, cptr.decay(nmbuf), 256n, __s_07u_s, wt, (cptr.ld1so2(weightlist, cnt, 32, $weight_table_entry_unique)) ? (yield* the(cptr.decay(nmbufbase))) : (yield* an(cptr.decay(nmbufbase))));
            cptr.stPtro2(weightlist, cnt, 32, $weight_table_entry_nm, (yield* dupstr(cptr.decay(nmbuf))));
            cnt++;
        }
    }
    ...
    for (i = 0; i < cnt; ++i) {
        if (cptr.ldPtro2(weightlist, i, 32, $weight_table_entry_nm)) {
            (yield* raw_printf(__s_7u_s_s, cptr.ldI32o2(weightlist, i, 32, $weight_table_entry_wt), (i == ((cnt - 1) | 0)) ? __s_sp : __s_comma, -nmwidth, cptr.add(cptr.ldPtro2(weightlist, i, 32, $weight_table_entry_nm), 7)));
