    ...
    for (n = (rng_log_enabled() ? (rng_log_set_caller(__s_mkobj_c, 338, __s_mkbox_cnts), rn2((n + 1) | 0)) : rn2((n + 1) | 0)); n > 0; n--) {
        if (cptr.ldI16o(box, $obj_otyp) == NHC.ICE_BOX) {
            ...
            if (cptr.ld1so(otmp, $obj_oclass) == NHC.COIN_CLASS) {
                cptr.stI64o(otmp, $obj_quan, BigInt((Math.imul((rng_log_enabled() ? (rng_log_set_caller(__s_mkobj_c, 362, __s_mkbox_cnts), rnd(((yield* level_difficulty()) + 2) | 0)) : rnd(((yield* level_difficulty()) + 2) | 0)), (rng_log_enabled() ? (rng_log_set_caller(__s_mkobj_c, 362, __s_mkbox_cnts), rnd(75)) : rnd(75))))));
...
function* mksobj_init(obj, artif) {
    ...
    switch (let$) {
        ...
        if (cptr.ldI16o(otmp, $obj_otyp) == NHC.STATUE) {
            ...
            if (!(cptr.ld1uo((cptr.add(mons, cptr.ldI32o(otmp, $obj_corpsenm), 96)), $permonst_msize) < NHM.MZ_SMALL) && (rng_log_enabled() ? (rng_log_set_caller(__s_mkobj_c, 1155, __s_mksobj_init), rn2(((((yield* level_difficulty()) / 2) | 0) + 10) | 0)) : rn2(((((yield* level_difficulty()) / 2) | 0) + 10) | 0)) > 10)
        ...
        break;
        default:
        (yield* panic(__s_mksobj_tried_to_make_type_d_class_d, cptr.ldI16o(otmp, $obj_otyp), cptr.ld1so2(objects, cptr.ldI16o(otmp, $obj_otyp), 120, $objclass_oc_class)));
    }
    mkobj_erosions(otmp);
...
export function* rnd_treefruit_at(x, y) {
    return (yield* mksobj_at(cptr.ldI32o(treefruits, (rng_log_enabled() ? (rng_log_set_caller(__s_mkobj_c, 1986, __s_rnd_treefruit_at), rn2(5)) : rn2(5)), 4), x, y, 1, 0));
}
...
function* mon_obj_sanity(monlist, mesg) {
    ...
    for (mon = monlist; mon; mon = cptr.ldPtr(mon)) {
        ...
        if (mwep) {
            (yield* impossible(__s_monst_s_u_wielding_s_u_not_in_s, pmname(cptr.ldPtro(mon, $monst_data), Mgender(mon)), cptr.ldI32o(mon, $monst_m_id), (yield* safe_typename(cptr.ldI16o(mwep, $obj_otyp))), cptr.ldI32o(mwep, $obj_o_id), (cptr.ldPtro2(genders, pronoun_gender(mon, NHM.PRONOUN_HALLU), 48, $Gender_his))));
        }
    }
}
