...
function* mkshobj_at(shp, sx, sy, mkspecl) {
    ...
    if ((rng_log_enabled() ? (rng_log_set_caller(__sl369, 470, __sl372), rn2(100)) : rn2(100)) < depth(cptr.add(u, $you_uz)) && !MON_AT(sx, sy) && (ptr = (yield* mkclass(NHC.S_MIMIC, 0))) !== null && (mtmp = (yield* makemon(ptr, i16(sx), i16(sy), NHM.NO_MM_FLAGS))) !== null) {
    } else {
