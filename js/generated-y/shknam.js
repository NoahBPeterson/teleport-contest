...
function* shkinit(shp, sroom) {
    ...
    if (sh < 0) {
        if (wizard()) {
            ...
            while (j--) {
                (yield* pline(__s_door_d_d, cptr.ldI16o(cptr.ldPtro(svd, $instance_globals_saved_d_doors), sh, 4), cptr.ldI16o2(cptr.ldPtro(svd, $instance_globals_saved_d_doors), sh, 4, $nhcoord_y)));
                sh++;
            }
