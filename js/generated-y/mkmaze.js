...
export function* restore_waterlevel(nhfp) {
    ...
    if (b) {
        ...
        (yield* impossible(__sl49, (Is_waterlevel(cptr.add(u, $you_uz)) || Is_waterlevel(cptr.add(gu, $instance_globals_u_uz_save))) ? __sl50 : ((Is_airlevel(cptr.add(u, $you_uz)) || Is_airlevel(cptr.add(gu, $instance_globals_u_uz_save))) ? __sl51 : __sl52)));
