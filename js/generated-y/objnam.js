...
function rnd_otyp_by_wpnskill(skill) {
    ...
    if (n > 0) {
        n = (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 3444, __s_rnd_otyp_by_wpnskill), rn2(n)) : rn2(n));
        for (i = cptr.ldI32o2(svb, NHC.WEAPON_CLASS, 4, $instance_globals_saved_b_bases); i < NHC.NUM_OBJECTS && cptr.ld1so2(objects, i, $sizeof_objclass, $objclass_oc_class) == NHC.WEAPON_CLASS; i++)
            if (cptr.ld1so2(objects, i, $sizeof_objclass, $objclass_oc_subtyp) == skill)
                if (--n < 0)
                    return i16(i);
...
function* rnd_otyp_by_namedesc(name, oclass, xtra_prob) {
    ...
    if (n > 0 && maxprob) {
        prob = (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 3522, __s_rnd_otyp_by_namedesc), rn2(maxprob)) : rn2(maxprob));
        for (i = 0; i < ((n - 1) | 0); i++)
...
function* wizterrainwish(d) {
    ...
    if (!(cptr.cmp((cptr.add(p, -(8))), bp) < 0 || (yield* strncmpi(((cptr.add(p, -(8)))), (__s_fountain), -1)))) {
        ...
        if (!(yield* strncmpi(bp, __s_chaotic, 8)))
            ...
            al = schar((!(rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 3702, __s_wizterrainwish), rn2(6)) : rn2(6)) ? -128 : (((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 3702, __s_wizterrainwish), rn2(3)) : rn2(3)) - 1) | 0)));
    ...
    for (; ; ) {
        ...
        if (!(yield* strncmpi(cptr.ldPtro(d, $_readobjnam_data_bp), __s_an, l = 3)) || !(yield* strncmpi(cptr.ldPtro(d, $_readobjnam_data_bp), __s_a_sp, l = 2))) {
            ...
            if (!(yield* strncmpi(cptr.ldPtro(d, $_readobjnam_data_bp), __s_wet, 4)))
                cptr.stI32o(d, $_readobjnam_data_wetness, (3 + (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 4025, __s_readobjnam_preparse), rn2(3)) : rn2(3))) | 0);
            else
                cptr.stI32o(d, $_readobjnam_data_wetness, (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 4027, __s_readobjnam_preparse), rnd(2)) : rnd(2)));
...
function* readobjnam_postparse1(d) {
    ...
    if (!(yield* strncmpi((cptr.ldPtro(d, $_readobjnam_data_bp)), (__s_glob), -1)) || !(cptr.cmp((cptr.add(cptr.add(cptr.ldPtro(d, $_readobjnam_data_bp), i), -(5))), cptr.ldPtro(d, $_readobjnam_data_bp)) < 0 || (yield* strncmpi(((cptr.add(cptr.add(cptr.ldPtro(d, $_readobjnam_data_bp), i), -(5)))), (__s_glob__2), -1))) || !(yield* strncmpi((cptr.ldPtro(d, $_readobjnam_data_bp)), (__s_globs), -1)) || !(cptr.cmp((cptr.add(cptr.add(cptr.ldPtro(d, $_readobjnam_data_bp), i), -(6))), cptr.ldPtro(d, $_readobjnam_data_bp)) < 0 || (yield* strncmpi(((cptr.add(cptr.add(cptr.ldPtro(d, $_readobjnam_data_bp), i), -(6)))), (__s_globs__2), -1))) || (cptr.stPtro(d, $_readobjnam_data_p, (yield* strstri(cptr.ldPtro(d, $_readobjnam_data_bp), __s_glob_of)))) !== null || (cptr.stPtro(d, $_readobjnam_data_p, (yield* strstri(cptr.ldPtro(d, $_readobjnam_data_bp), __s_globs_of)))) !== null) {
        ...
        if (cptr.ldI32o(d, $_readobjnam_data_mntmp) == NHC.NON_PM)
            cptr.stI32o(d, $_readobjnam_data_mntmp, (((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 4354, __s_readobjnam_postparse1), rn2(((NHC.PM_BLACK_PUDDING - NHC.PM_GRAY_OOZE) | 0))) : rn2(((NHC.PM_BLACK_PUDDING - NHC.PM_GRAY_OOZE) | 0))) + NHC.PM_GRAY_OOZE) | 0));
...
function* readobjnam_postparse2(d) {
    ...
    if (!(cptr.cmp((cptr.add(cptr.ldPtro(d, $_readobjnam_data_p), -(6))), cptr.ldPtro(d, $_readobjnam_data_bp)) < 0 || (yield* strncmpi(((cptr.add(cptr.ldPtro(d, $_readobjnam_data_p), -(6)))), (__s_stone), -1))) || !(cptr.cmp((cptr.add(cptr.ldPtro(d, $_readobjnam_data_p), -(4))), cptr.ldPtro(d, $_readobjnam_data_bp)) < 0 || (yield* strncmpi(((cptr.add(cptr.ldPtro(d, $_readobjnam_data_p), -(4)))), (__s_gem), -1)))) {
        ...
        if (!(yield* strncmpi((s), (__s_glass__2), -1))) {
            cptr.stI32o(d, $_readobjnam_data_typ, (NHC.FIRST_GLASS_GEM + (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 4705, __s_readobjnam_postparse2), rn2(NHC.NUM_GLASS_GEMS)) : rn2(NHC.NUM_GLASS_GEMS))) | 0);
...
export function* readobjnam(bp, no_wish) {
    ...
    __dispatch: while (true) {
        ...
        case 4 /* any: */: {
        if (!cptr.ld1so(d, $_readobjnam_data_oclass))
            cptr.st1o(d, $_readobjnam_data_oclass, cptr.ld1so(cptr.decay(wrpsym), (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 4996, __s_readobjnam), rn2(13)) : rn2(13)), 1));
        __pc = 5;
        continue;
        }
        case 5 /* typfnd: */: {
        ...
        if ((cptr.ldI32o(cptr.ldPtr(d), $obj_globby) & 1)) {
            ...
            if (cptr.ldI32o(d, $_readobjnam_data_cnt) > 1) {
                rn1cnt = (((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5059, __s_readobjnam), rn2(5)) : rn2(5)) + 2) | 0);
            ...
            if ((cptr.ldI32o2(objects, cptr.ldI32o(d, $_readobjnam_data_typ), $sizeof_objclass, $objclass_oc_merge) & 1) | 0 && (wizard() || cptr.ldI32o(d, $_readobjnam_data_cnt) < (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5077, __s_readobjnam), rnd(6)) : rnd(6)) || (cptr.ldI32o(d, $_readobjnam_data_cnt) <= 7 && Is_candle(cptr.ldPtr(d))) || (cptr.ldI32o(d, $_readobjnam_data_cnt) <= 20 && (cptr.ldI32o(d, $_readobjnam_data_typ) == NHC.ROCK || cptr.ldI32o(d, $_readobjnam_data_typ) == NHC.FLINT || is_missile(cptr.ldPtr(d)) || (cptr.ld1so(d, $_readobjnam_data_oclass) == NHC.WEAPON_CLASS && is_ammo(cptr.ldPtr(d)))))))
                cptr.stI64o(cptr.ldPtr(d), $obj_quan, BigInt(cptr.ldI32o(d, $_readobjnam_data_cnt)));
        }
        ...
        if (cptr.ldI32o(d, $_readobjnam_data_spesgn) == 0) {
            ...
            if (cptr.ldI32o(d, $_readobjnam_data_spe) > (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5102, __s_readobjnam), rnd(5)) : rnd(5)) && cptr.ldI32o(d, $_readobjnam_data_spe) > cptr.ld1so(cptr.ldPtr(d), $obj_spe))
        ...
        switch (cptr.ldI32o(d, $_readobjnam_data_typ)) {
            ...
            case NHC.CORPSE:
            {
                ...
                if (P && cptr.ld1so(cptr.ldPtr(d), $obj_spe) == NHM.CORPSTAT_RANDOM)
                    cptr.st1o(cptr.ldPtr(d), $obj_spe, schar((((cptr.ldU64o((P), $permonst_mflags2) & 65536n) != 0n) ? NHM.CORPSTAT_MALE : (((cptr.ldU64o((P), $permonst_mflags2) & 131072n) != 0n) ? NHM.CORPSTAT_FEMALE : ((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5163, __s_readobjnam), rn2(2)) : rn2(2)) ? NHM.CORPSTAT_MALE : NHM.CORPSTAT_FEMALE)))));
            ...
            if (!wizard()) {
                cptr.st1o(cptr.ldPtr(d), $obj_spe, schar(((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5182, __s_readobjnam), rn2(10)) : rn2(10)) ? -1 : 0)));
                break;
            }
            // @FallThrough
            ;
        ...
        if (ismnum(cptr.ldI32o(d, $_readobjnam_data_mntmp))) {
            ...
            switch (cptr.ldI32o(d, $_readobjnam_data_typ)) {
                ...
                if (cptr.ld1so(d, $_readobjnam_data_zombify) && zombie_form(cptr.add(mons, cptr.ldI32o(d, $_readobjnam_data_mntmp), $sizeof_permonst))) {
                    void (yield* start_timer(BigInt((((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5223, __s_readobjnam), rn2(5)) : rn2(5)) + 10) | 0)), NHC.TIMER_OBJECT, NHC.ZOMBIFY_MON, obj_to_any(cptr.ldPtr(d))));
                }
                break;
                case NHC.EGG:
        ...
        if (cptr.ldI16o(cptr.ldPtr(d), $obj_otyp) == NHC.TIN && cptr.ldI32o(d, $_readobjnam_data_tvariety) >= 0 && ((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5343, __s_readobjnam), rn2(4)) : rn2(4)) || wizard()))
        ...
        if ((is_quest_artifact(cptr.ldPtr(d)) || (cptr.ld1so(cptr.ldPtr(d), $obj_oartifact) && (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5374, __s_readobjnam), rn2(nartifact_exist())) : rn2(nartifact_exist())) > 1)) && !wizard()) {
...
export function rnd_class(first, last) {
    ...
    if (last > first) {
        ...
        if (!sum)
            return (((rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5411, __s_rnd_class), rn2((((last - first) | 0) + 1) | 0)) : rn2((((last - first) | 0) + 1) | 0)) + (first)) | 0);
        x = (rng_log_enabled() ? (rng_log_set_caller(__s_objnam_c, 5413, __s_rnd_class), rnd(sum)) : rnd(sum));
        for (i = first; i <= last; i++)
