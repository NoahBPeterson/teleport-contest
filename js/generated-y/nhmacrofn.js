...
export function* random_monster(rng) { return ((yield* Y.icall((rng)(NHC.NUMMONS)))); }

/** C: include/display.h — the `random_object(rng)` macro body */
export function* random_object(rng) { return (((yield* Y.icall((rng)(((NHC.NUM_OBJECTS - NHC.FIRST_OBJECT) | 0)))) + NHC.FIRST_OBJECT) | 0); }
