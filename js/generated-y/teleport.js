...
export function* goodpos(x, y, mtmp, gpflags) {
    ...
    if (mtmp) {
        ...
        if (((cptr.ldU64o((mdat), 72) & 4n) != 0n) && closed_door(x, y))
            return 1;
        if (checkscary && (cptr.ldI32o(mtmp, 16) ? (yield* onscary(x, y, mtmp)) : (yield* goodpos_onscary(x, y, mdat))))
            return 0;
    }
    if (!accessible(x, y)) {
...
export function* enexto_core(cc, xx, yy, mdat, entflags) {
    ...
    if (allow_xx_yy && (yield* goodpos(cptr.ldI16(cc), cptr.ldI16o(cc, 2), fakemon, entflags)))
        return 1;
    do {
        if ((yield* debugcore(__sl1, 1))) {
            let save_plnmsg = cptr.ldI32o(iflags, 40);
...
export function* teleds(nux, nuy, teleds_flags) {
    ...
    if (!(yield* hideunder(cptr.add(gy, 8))) && cptr.ld1so(cptr.ldPtro(gy, 16), 28) == NHC.S_MIMIC) {
    ...
    if (is_teleport && cptr.ld1so(flags, 48))
        (yield* You(__sl5, (nux == cptr.ldI16o(u, 20) && nuy == cptr.ldI16o(u, 22)) ? __sl6 : __sl7));
...
function* vault_tele() {
    ...
    let c = cptr.alloc(4);
    if (croom && somexyspace(croom, c) && (yield* teleok(cptr.ldI16(c), cptr.ldI16o(c, 2), 0))) {
...
export function* scrolltele(scroll) {
    let cc = cptr.alloc(4);
    if ((yield* noteleport_level(cptr.add(gy, 8))) && !cptr.ld1so(flags, 10)) {
        (yield* pline(__sl17));
        if (scroll)
    ...
    if (((cptr.ldI32o(u, 1944) & 1) | 0 || On_W_tower_level(cptr.add(u, 24))) && !(rng_log_enabled() ? (rng_log_set_caller(__sl1, 865, __sl18), rn2(3)) : rn2(3))) {
        ...
        if (!cptr.ld1so(flags, 10) || (yield* yn_function(__sl20, cptr.decay(ynchars), 110, 1)) != 121)
            return;
    }
    ...
    if (!trap && !break_the_rules) {
        ...
        if (!(cptr.ldI64o2(u, NHC.TELEPORT, 24, 128) || cptr.ldI64o2(u, NHC.TELEPORT, 24, 112)) || (cptr.ldI32o(u, 48) < ((cptr.ldI16o(gu, 216) == NHC.PM_WIZARD) ? 8 : 12) && !((cptr.ldU64o((cptr.ldPtro(gy, 16)), 72) & 33554432n) != 0n))) {
            ...
            if (!castit && !break_the_rules) {
                (yield* You(__sl37, (!(cptr.ldI64o2(u, NHC.TELEPORT, 24, 128) || cptr.ldI64o2(u, NHC.TELEPORT, 24, 112)) ? ((knownsp != NHC.spe_Unknown) ? __sl38 : __sl39) : __sl40)));
                return 0;
            }
        }
        cantdoit = null;
...
export function* level_tele() {
    ...
    __dispatch: while (true) {
        ...
        if ((cptr.ldI16((newlevel)) == cptr.ldI16((cptr.add(svd, 1868)))) && !(cptr.ldI16((cptr.add(u, 24))) == cptr.ldI16((cptr.add(svd, 1868))))) {
            if (!(cptr.ldI32o(u, 1944) & 1) && (amu = (yield* mksobj(NHC.AMULET_OF_YENDOR, 1, 0))) !== null) {
...
export function* tele_trap(trap) {
    ...
    if ((cptr.ldI16((cptr.add(u, 24))) == cptr.ldI16((cptr.add(svd, 1868)))) || (cptr.ldI64o2(u, NHC.ANTIMAGIC, 24, 128) || cptr.ldI64o2(u, NHC.ANTIMAGIC, 24, 112)) || (yield* noteleport_level(cptr.add(gy, 8)))) {
...
export function* level_tele_trap(trap, trflags) {
    ...
    if ((cptr.ldI64o2(u, NHC.HALLUC, 24, 128) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 128) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 112))) || (cptr.ldI64o2(u, NHC.TELEPORT_CONTROL, 24, 128) || cptr.ldI64o2(u, NHC.TELEPORT_CONTROL, 24, 112)))
        (yield* You(__sl94, (cptr.ldI64o2(u, NHC.HALLUC, 24, 128) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 128) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 112))) ? __sl95 : __sl96));
    else
    ...
    if (!xx) {
        ...
        if ((cptr.ldI32o(mtmp, 180) & 1) | 0 && (yield* inhishop(mtmp))) {
            if (((cptr.ldI32o3(svl, x, 756, y, 36, 1704) & 63) | 0) != uchar(cptr.ld1so((cptr.ldPtro(cptr.ldPtro((mtmp), 312), 24)), 44)))
                return 0;
        } else if ((cptr.ldI32o(mtmp, 192) & 1) | 0 && (yield* inhistemple(mtmp))) {
...
function* rloc_to_core(mtmp, x, y, rlocflags) {
    ...
    if (domsg && ((canseemon(mtmp) || sensemon(mtmp)) || appearmsg || cptr.eq(mtmp, cptr.ldPtro(u, 2416)))) {
        ...
        if (cptr.eq(mtmp, cptr.ldPtro(u, 2416)) && !((cptr.ldI16o(u, 20)) == cptr.ldI16(u) && (cptr.ldI16o(u, 22)) == cptr.ldI16o(u, 2))) {
            ...
            (yield* pline(__sl106, appearmsg ? (yield* Amonnam(mtmp)) : (yield* Monnam(mtmp)), appearmsg ? __sl107 : __sl68, !((cptr.ldI64o2(u, NHC.BLINDED, 24, 128) || cptr.ldI64o2(u, NHC.BLINDED, 24, 112)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, 120)) ? __sl108 : __sl109, next ? next : (nearu ? nearu : __sl68)));
        }
    ...
    if (cptr.ldPtro(mtmp, 280) && !(yield* costly_spot(x, y))) {
        let otmp;
...
export function* control_mon_tele(mon, cc_p, rlocflags, via_rloc) {
    ...
    if ((yield* getpos(cc_p, 0, cptr.decay(tcbuf))) >= 0 && !((cptr.ldI16(cc_p)) == cptr.ldI16(u) && (cptr.ldI16o(cc_p, 2)) == cptr.ldI16o(u, 2))) {
...
function* mvault_tele(mtmp) {
    let croom = search_special(NHC.VAULT);
    let c = cptr.alloc(4);
    if (croom && somexyspace(croom, c) && (yield* goodpos(cptr.ldI16(c), cptr.ldI16o(c, 2), mtmp, 0))) {
...
export function* mlevel_tele_trap(mtmp, trap, force_it, in_sight) {
    ...
    if ((yield* teleport_pet(mtmp, force_it))) {
        ...
        if (((tt) == NHC.HOLE || (tt) == NHC.TRAPDOOR)) {
            ...
            let nlev;
            if (mon_has_amulet(mtmp) || (cptr.ldI16((cptr.add(u, 24))) == cptr.ldI16((cptr.add(svd, 1868)))) || (tt == NHC.NO_TRAP && (yield* onscary(0, 0, mtmp)))) {
                if (in_sight)
...
export function* u_teleport_mon(mtmp, give_feedback) {
    ...
    if (cptr.ldI64o(svl, 89200) >= cptr.ldI64o(svm, 8)) {
        ...
        return 0;
    } else if ((cptr.ldI32o(mtmp, 192) & 1) | 0 && cptr.ld1s((yield* in_rooms(cptr.ldI16o(mtmp, 28), cptr.ldI16o(mtmp, 30), NHC.TEMPLE)))) {
        if (give_feedback)
            (yield* pline(__sl137, (yield* Monnam(mtmp))));
        return 0;
    } else if (((cptr.ldI32o(u, 1848) & 1) | 0 && (cptr.eq(cptr.ldPtro(u, 2416), (mtmp)))) && (yield* noteleport_level(mtmp))) {
        if (give_feedback)
            (yield* You(__sl138, (yield* mon_nam(mtmp))));
        (yield* unstuck(mtmp));
        if (!(yield* rloc(mtmp, NHM.RLOC_MSG)))
            (yield* m_into_limbo(mtmp));
    } else if (((cptr.eq((cptr.ldPtro(mtmp, 8)), cptr.add(mons, NHC.PM_DEATH, 96)) || cptr.eq((cptr.ldPtro(mtmp, 8)), cptr.add(mons, NHC.PM_FAMINE, 96)) || cptr.eq((cptr.ldPtro(mtmp, 8)), cptr.add(mons, NHC.PM_PESTILENCE, 96))) || ((cptr.ldU64o((cptr.ldPtro(mtmp, 8)), 72) & 67108864n) != 0n)) && (rng_log_enabled() ? (rng_log_set_caller(__sl1, 2285, __sl139), rn2(13)) : rn2(13)) && (yield* enexto(cc, cptr.ldI16(u), cptr.ldI16o(u, 2), cptr.ldPtro(mtmp, 8)))) {
        (yield* rloc_to(mtmp, cptr.ldI16(cc), cptr.ldI16o(cc, 2)));
    } else {
        if (!(yield* rloc(mtmp, NHM.RLOC_MSG)))
            return 0;
