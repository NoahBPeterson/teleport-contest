...
export function* hatch_egg(arg, timeout) {
    ...
    if (mon) {
        ...
        switch (cptr.ld1so(egg, FLD.obj_where)) {
            ...
            if (yours) {
                (yield* pline(__sl174, siblings ? __sl175 : __sl176, (yield* ing_suffix(cry_sound(mon))), ((cptr.ld1uo((cptr.ldPtro(mon, FLD.monst_data)), FLD.permonst_msound) == NHC.MS_SILENT) || Deaf()) ? __sl177 : __sl178, cptr.ld1so(flags, FLD.flag_female) ? __sl179 : __sl180, cptr.ld1so(egg, FLD.obj_spe) ? __sl159 : __sl181));
