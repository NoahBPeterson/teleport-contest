...
function* stoned_dialogue() {
    let i = (cptr.ldI64o2(u, NHC.STONED, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    if (i > 0n && i <= BigInt(5)) {
        let buf = new Uint8Array(256);
        void cptr.strcpy(cptr.decay(buf), cptr.ldPtro(stoned_texts, BigInt.asIntN(64, BigInt(5) - i), 8));
        if (((cptr.ldU64o((cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data)), FLD.permonst_mflags1) & 24576n) == 24576n) && (yield* strstri(cptr.decay(buf), __sl73)))
    ...
    switch (Number(BigInt.asIntN(32, i))) {
        ...
        break;
        case 2:
        if ((cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) > 0n && (cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) < 5n)
...
function* vomiting_dialogue() {
    let txt = null;
    let buf = new Uint8Array(256);
    let v = (cptr.ldI64o2(u, NHC.VOMITING, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    switch (Number(BigInt.asIntN(32, (BigInt.asIntN(64, v - 1n))))) {
        ...
        if ((yield* strstri(txt, __sl82)) && cptr.ldI64o2(u, NHC.CONFUSION, 24, FLD.you_uprops + FLD.prop_intrinsic))
            txt = strsubst(cptr.strcpy(cptr.decay(buf), txt), __sl82, __sl83);
        break;
        case 6:
        (yield* make_stunned(BigInt.asIntN(64, (cptr.ldI64o2(u, NHC.STUNNED, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) + BigInt((rng_log_enabled() ? (rng_log_set_caller(__sl84, 215, __sl85), d(2, 4)) : d(2, 4)))), 0));
        if (!Popeye(NHC.VOMITING))
            (yield* stop_occupation());
        // @FallThrough
        ;
        case 9:
        (yield* make_confused(BigInt.asIntN(64, (cptr.ldI64o2(u, NHC.CONFUSION, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) + BigInt((rng_log_enabled() ? (rng_log_set_caller(__sl84, 221, __sl85), d(2, 4)) : d(2, 4)))), 0));
        if (cptr.ldI64o(gm, FLD.instance_globals_m_multi) > 0n)
            nomul(0);
        break;
        case 8:
        txt = cptr.ldPtro(vomiting_texts, 2, 8);
        if ((yield* strstri(txt, __sl86)) && cptr.ldI64o2(u, NHC.STUNNED, 24, FLD.you_uprops + FLD.prop_intrinsic))
        ...
        if (!cantvomit(cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data))) {
            ...
            if (cptr.ldI32o(u, FLD.you_uhs) < NHC.FAINTING)
                (yield* You(__sl91, !(cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? __sl92 : __sl93));
        }
        (yield* vomit());
        break;
        default:
...
function* sleep_dialogue() {
    let i = (cptr.ldI64o2(u, NHC.SLEEPY, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    if (i == 4n)
        (yield* You(__sl94));
}
...
function* choke_dialogue() {
    let i = (cptr.ldI64o2(u, NHC.STRANGLED, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    if (i > 0n && i <= BigInt(5)) {
        if ((cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops) || ((cptr.ldU64o((cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data)), FLD.permonst_mflags1) & 1024n) != 0n)) || !(rng_log_enabled() ? (rng_log_set_caller(__sl84, 300, __sl104), rn2(50)) : rn2(50))) {
            ...
            if (cptr.strchr(str, 37))
                (yield* urgent_pline(str, hcolor(cptr.ldPtro(c_color_names, FLD.c_color_names_c_blue))));
            else
...
function* sickness_dialogue() {
    let j = (cptr.ldI64o2(u, NHC.SICK, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    let i = j / 2n;
    if (i > 0n && i <= BigInt(3) && (j % 2n) != 0n) {
        ...
        if ((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) && (yield* strstri(cptr.decay(buf), __sl110))) {
...
function* levitation_dialogue() {
    let i = ((BigInt.asIntN(64, (cptr.ldI64o2(u, NHC.LEVITATION, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) - 1n)) / 2n);
    if (cptr.ldI64o2(u, NHC.LEVITATION, 24, FLD.you_uprops))
        return;
    if (!((cptr.ld1so3(svl, cptr.ldI16(u), 756, cptr.ldI16o(u, FLD.you_uy), 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) >= NHC.DOOR) && !is_pool_or_lava(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)))
        return;
    if (((cptr.ldI64o2(u, NHC.LEVITATION, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) % 2n) && i > 0n && i <= BigInt(2)) {
        ...
        if (cptr.strchr(s, 37)) {
            ...
            (yield* urgent_pline(s, danger ? __sl115 : __sl116, danger ? surface(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)) : __sl117));
        } else
...
function* slime_dialogue() {
    let t = (cptr.ldI64o2(u, NHC.SLIMED, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    let i = t / 2n;
    if (t == 1n) {
        ...
        if (cptr.strchr(cptr.decay(buf), 37)) {
            if (i == 4n) {
                if (!((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked)))
                    (yield* urgent_pline(cptr.decay(buf), hcolor(cptr.ldPtro(c_color_names, FLD.c_color_names_c_green))));
            } else {
                (yield* urgent_pline(cptr.decay(buf), (yield* an((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? (yield* rndmonnam(null)) : __sl123))));
            }
        } else {
            (yield* urgent_pline(__sl75, cptr.decay(buf)));
        }
...
function* slimed_to_death(kptr) {
    let save_mvflags;
    if ((cptr.ldI32o(u, FLD.you_umonnum) != cptr.ldI32o(u, FLD.you_umonster)) && cptr.eq(cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data), cptr.add(mons, NHC.PM_GREEN_SLIME, 96))) {
...
function* phaze_dialogue() {
    let i = ((cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) / 2n);
    if (cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops) || (cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops + FLD.prop_intrinsic) & -16777216n))
        return;
    if (((cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) % 2n) && i > 0n && i <= BigInt(2))
...
function* region_dialogue() {
    ...
    let r = (cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n);
    let i = r / 2n;
...
export function* nh_timeout() {
    ...
    if (cptr.ldI64o2(u, NHC.LEVITATION, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n)
        (yield* levitation_dialogue());
    if (cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n)
        (yield* phaze_dialogue());
    if (cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n)
        (yield* region_dialogue());
    if (cptr.ldI64o2(u, NHC.SLEEPY, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n)
    ...
    if (cptr.ld1uo(u, FLD.you_usptime)) {
        if (cptr.st1o(u, FLD.you_usptime, cptr.ld1uo(u, FLD.you_usptime) + -1) == 0 && cptr.ld1uo(u, FLD.you_uspellprot)) {
            ...
            find_ac();
            if (!((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked)))
                (yield* Norep(__sl135, hcolor(cptr.ldPtro(c_color_names, FLD.c_color_names_c_golden)), cptr.ld1uo(u, FLD.you_uspellprot) ? __sl136 : __sl137));
        }
    }
    if (cptr.ldI64o(u, FLD.you_ugallop)) {
        if (cptr.stI64o(u, FLD.you_ugallop, cptr.ldI64o(u, FLD.you_ugallop) + -1n) == 0n && cptr.ldPtro(u, FLD.you_usteed))
            (yield* pline(__sl138, (yield* Monnam(cptr.ldPtro(u, FLD.you_usteed)))));
    }
    ...
    for (upp = cptr.add(u, FLD.you_uprops); cptr.cmp(upp, cptr.add(cptr.add(u, FLD.you_uprops), Number(BigInt.asIntN(32, (1656n / 24n))), 24)) < 0; upp = cptr.add(upp, 1, 24))
        if ((cptr.ldI64o(upp, FLD.prop_intrinsic) & 16777215n) && !(cptr.stI64o(upp, FLD.prop_intrinsic, cptr.ldI64o(upp, FLD.prop_intrinsic) + -1n) & 16777215n)) {
            ...
            switch (cptr.diff(upp, cptr.add(u, FLD.you_uprops)) / 24n) {
                ...
                (yield* dealloc_killer(kptr));
                if ((m_idx = (yield* name_to_mon(cptr.add(svk, FLD.kinfo_name), null))) >= NHC.LOW_PM) {
                    if (((cptr.ldU64o((cptr.add(mons, m_idx, 96)), FLD.permonst_mflags2) & 524288n) != 0n)) {
                        ...
                        void cptr.strcpy(cptr.add(svk, FLD.kinfo_name), (yield* the(cptr.add(svk, FLD.kinfo_name))));
                        cptr.stI32o(svk, FLD.kinfo_format, NHM.KILLED_BY);
                    }
                }
                ...
                if (!((cptr.ldI64o2(u, NHC.FAST, 24, FLD.you_uprops + FLD.prop_intrinsic) & -117440513n) || cptr.ldI64o2(u, NHC.FAST, 24, FLD.you_uprops)))
                    (yield* You_feel(__sl142, (cptr.ldI64o2(u, NHC.FAST, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.FAST, 24, FLD.you_uprops)) ? __sl143 : __sl144));
                break;
                case 14n:
                ...
                if (!((cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops + FLD.prop_blocked)) && !cptr.ldI64o2(u, NHC.INVIS, 24, FLD.you_uprops + FLD.prop_blocked) && !((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked))) {
                    (yield* You(!(cptr.ldI64o2(u, NHC.SEE_INVIS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.SEE_INVIS, 24, FLD.you_uprops)) ? __sl145 : __sl146));
                    (yield* stop_occupation());
                }
                break;
                case 29n:
                ...
                break;
                case 27n:
                if (unconscious() || (cptr.ldI64o2(u, NHC.SLEEP_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.SLEEP_RES, 24, FLD.you_uprops))) {
                ...
                } else if ((cptr.ldI64o2(u, NHC.SLEEPY, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.SLEEPY, 24, FLD.you_uprops))) {
                    (yield* You(__sl147));
                ...
                break;
                case 48n:
                if ((cptr.ldI64o2(u, NHC.FLYING, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n) == 1n)
                ...
                if (!(cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.PASSES_WALLS, 24, FLD.you_uprops))) {
                    if (stuck_in_wall())
                        ...
                        (yield* pline(__sl155, !(cptr.ldI32o(u, FLD.you_umonnum) != cptr.ldI32o(u, FLD.you_umonster)) ? __sl156 : __sl157));
                }
                break;
                case 52n:
                if (!(cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.MAGICAL_BREATHING, 24, FLD.you_uprops) || ((cptr.ldU64o((cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data)), FLD.permonst_mflags1) & 1024n) != 0n))) {
                    if (region_danger())
                        (yield* You(__sl158, (cptr.ldI64o2(u, NHC.POISON_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.POISON_RES, 24, FLD.you_uprops)) ? __sl159 : __sl160));
                }
                break;
                case 19n:
                cptr.stI32o(svk, FLD.kinfo_format, NHM.KILLED_BY);
...
export function* hatch_egg(arg, timeout) {
    ...
    if (get_obj_location(egg, x, y, 0)) {
        ...
        if (!(cptr.ldU16o2(mons, mnum, 96, FLD.permonst_geno) & NHM.G_UNIQ) && !(cptr.ld1uo2(svm, mnum, 12, FLD.instance_globals_saved_m_mvitals + FLD.mvitals_mvflags) & 3)) {
            for (i = hatchcount; i > 0; i--) {
                if (!(yield* enexto(cc, x.v, y.v, cptr.add(mons, mnum, 96))) || !(mon = (yield* makemon(cptr.add(mons, mnum, 96), cptr.ldI16(cc), cptr.ldI16o(cc, FLD.nhcoord_y), 131073))))
                    break;
    ...
    if (mon) {
        ...
        switch (cptr.ld1so(egg, FLD.obj_where)) {
            ...
            knows_egg = 1;
            if (!cansee_hatchspot)
                (yield* You_feel(__sl171, cptr.ldPtro(c_common_strings, FLD.c_common_strings_c_something), locomotion(cptr.ldPtro(mon, FLD.monst_data), __sl172)));
            else
                (yield* You_see(__sl173, cptr.decay(monnambuf), locomotion(cptr.ldPtro(mon, FLD.monst_data), __sl172)));
            if (yours) {
                (yield* pline(__sl174, siblings ? __sl175 : __sl176, (yield* ing_suffix(cry_sound(mon))), ((cptr.ld1uo((cptr.ldPtro(mon, FLD.monst_data)), FLD.permonst_msound) == NHC.MS_SILENT) || (cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops) || cptr.ld1so(u, FLD.you_uroleplay + FLD.u_roleplay_deaf))) ? __sl177 : __sl178, cptr.ld1so(flags, FLD.flag_female) ? __sl179 : __sl180, cptr.ld1so(egg, FLD.obj_spe) ? __sl159 : __sl181));
            } else if (cptr.ld1so(cptr.ldPtro(mon, FLD.monst_data), FLD.permonst_mlet) == NHC.S_DRAGON && !(cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.DEAF, 24, FLD.you_uprops) || cptr.ld1so(u, FLD.you_uroleplay + FLD.u_roleplay_deaf))) {
                ;
            ...
            if (cansee_hatchspot) {
                ...
                (yield* You_see(__sl187, cptr.decay(monnambuf), locomotion(cptr.ldPtro(mon, FLD.monst_data), __sl172), cptr.decay(carriedby)));
            }
            break;
            default:
            (yield* impossible(__sl188, cptr.ld1so(egg, FLD.obj_where)));
            break;
        }
        ...
        if (cptr.ldI64o(egg, FLD.obj_quan) > 0n) {
            ...
            if ((mon = (cptr.ldPtro3(svl, x.v, 168, y.v, 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters))) && !(yield* hideunder(mon)) && ((cptr.ld1uo(cptr.ldPtro(cptr.ldPtro(gv, FLD.instance_globals_v_viz_array), y.v, 8), x.v) & NHM.IN_SIGHT) != 0))
                redraw = 1;
        }
        if (redraw)
...
function* slip_or_trip() {
    ...
    if (otmp && on_foot && !(cptr.ldI32o(u, FLD.you_uinwater) & 1) && is_pool(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)))
        otmp = null;
    if (otmp && on_foot) {
        what = (cptr.ldI32o(iflags, FLD.instance_flags_last_msg) == NHC.PLNMSG_ONE_ITEM_HERE) ? ((cptr.ldI64o(otmp, FLD.obj_quan) == 1n) ? __sl190 : ((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? __sl191 : __sl192)) : (((cptr.ldI32o(otmp, FLD.obj_dknown) & 1) | 0 || !((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked))) ? (yield* doname(otmp)) : ((otmp2 = sobj_at(NHC.ROCK, cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy))) === null ? cptr.ldPtro(c_common_strings, FLD.c_common_strings_c_something) : (cptr.ldI64o(otmp2, FLD.obj_quan) == 1n ? __sl193 : __sl194)));
        if ((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops)))) {
            what = cptr.strcpy(cptr.decay(buf), what);
            cptr.st1o(cptr.decay(buf), 0, highc(cptr.ld1so(cptr.decay(buf), 0, 1)), 1);
            (yield* pline(__sl195, what, (!otmp || cptr.ldI64o(otmp, FLD.obj_quan) == 1n) ? __sl196 : __sl144, (yield* body_part(NHC.FOOT))));
        } else {
            (yield* You(__sl197, what));
        }
        if (!uarmf.v && cptr.ldI16o(otmp, FLD.obj_otyp) == NHC.CORPSE && (cptr.eq((cptr.add(mons, cptr.ldI32o(otmp, FLD.obj_corpsenm), 96)), cptr.add(mons, NHC.PM_COCKATRICE, 96)) || cptr.eq((cptr.add(mons, cptr.ldI32o(otmp, FLD.obj_corpsenm), 96)), cptr.add(mons, NHC.PM_CHICKATRICE, 96))) && !(cptr.ldI64o2(u, NHC.STONE_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.STONE_RES, 24, FLD.you_uprops))) {
            void cptr.sprintf(cptr.add(svk, FLD.kinfo_name), __sl198, (yield* an(cptr.ldPtro3(mons, cptr.ldI32o(otmp, FLD.obj_corpsenm), 96, NHC.NEUTRAL, 8, 0))));
            (yield* instapetrify(cptr.add(svk, FLD.kinfo_name)));
        }
    } else if ((cptr.ldI64o2(u, NHC.FUMBLING, 24, FLD.you_uprops + FLD.prop_intrinsic) & 67108864n) || (is_ice(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)) && !(rng_log_enabled() ? (rng_log_set_caller(__sl84, 1262, __sl199), rn2(3)) : rn2(3)))) {
        let ice_only = schar((!(cptr.ldI64o2(u, NHC.FUMBLING, 24, FLD.you_uprops) || (cptr.ldI64o2(u, NHC.FUMBLING, 24, FLD.you_uprops + FLD.prop_intrinsic) & -67108865n))));
        (yield* pline(__sl200, cptr.ldPtro(u, FLD.you_usteed) ? upstart((yield* x_monnam(cptr.ldPtro(u, FLD.you_usteed), NHM.ARTICLE_THE, null, NHM.SUPPRESS_SADDLE, 0))) : __sl201, (yield* vtense(cptr.ldPtro(u, FLD.you_usteed) ? __sl202 : __sl203, (rng_log_enabled() ? (rng_log_set_caller(__sl84, 1273, __sl199), rn2(2)) : rn2(2)) ? __sl204 : __sl205)), is_ice(cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)) ? __sl206 : __sl207));
        if (!on_foot && ((saddle = (yield* which_armor(cptr.ldPtro(u, FLD.you_usteed), 1048576n))) === null || !(cptr.ldI32o(saddle, FLD.obj_cursed) & 1)) && (!ice_only || !(rng_log_enabled() ? (rng_log_set_caller(__sl84, 1284, __sl199), rn2(3)) : rn2(3)))) {
            (yield* You(__sl208));
            ...
            if (((cptr.ldI16(u) + cptr.ldI32o(u, FLD.you_dx)) | 0) != cptr.ldI16o(u, FLD.you_ux0) || ((cptr.ldI16o(u, FLD.you_uy) + cptr.ldI32o(u, FLD.you_dy)) | 0) != cptr.ldI16o(u, FLD.you_uy0))
                (yield* hurtle(cptr.ldI32o(u, FLD.you_dx), cptr.ldI32o(u, FLD.you_dy), 1, 0));
        }
    } else {
        if (on_foot) {
            switch ((rng_log_enabled() ? (rng_log_set_caller(__sl84, 1302, __sl199), rn2(4)) : rn2(4))) {
                case 1:
                (yield* You(__sl209, (cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? __sl210 : (yield* makeplural((yield* body_part(NHC.FOOT))))));
                break;
                case 2:
                (yield* You(__sl211, (cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? __sl212 : __sl213));
                break;
                case 3:
                (yield* You(__sl214));
                break;
        ...
        } else if ((saddle = (yield* which_armor(cptr.ldPtro(u, FLD.you_usteed), 1048576n))) === null || !(cptr.ldI32o(saddle, FLD.obj_cursed) & 1)) {
...
function* lantern_message(obj) {
    switch (cptr.ld1so(obj, FLD.obj_where)) {
        ...
        break;
        case NHM.OBJ_MINVENT:
        (yield* pline(__sl225, (yield* s_suffix((yield* Monnam(cptr.ldPtro(obj, FLD.obj_v)))))));
        break;
    }
}
...
export function* burn_object(arg, timeout) {
    ...
    if (get_obj_location(obj, x, y, 0)) {
        canseeit = schar((!((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked)) && ((cptr.ld1uo(cptr.ldPtro(cptr.ldPtro(gv, FLD.instance_globals_v_viz_array), y.v, 8), x.v) & NHM.IN_SIGHT) != 0) ? 1 : 0));
        ...
        switch (Number(BigInt.asIntN(32, cptr.ldI64o(obj, FLD.obj_age)))) {
            ...
            if (canseeit) {
                if (cptr.ldI16o(obj, FLD.obj_otyp) == NHC.BRASS_LANTERN)
                    ...
                    (yield* see_lamp_flicker(obj, cptr.ldI64o(obj, FLD.obj_age) == 50n ? __sl228 : __sl144));
            }
            break;
            case 25:
            if (canseeit) {
        ...
        switch (cptr.ldI64o(obj, FLD.obj_age)) {
            ...
            if (canseeit || bytouch) {
                if (menorah) {
                    ...
                    (yield* pline((cptr.ldI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, FLD.you_uprops))) ? (many ? __sl253 : __sl254) : (((cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_intrinsic) || cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops)) && !cptr.ldI64o2(u, NHC.BLINDED, 24, FLD.you_uprops + FLD.prop_blocked)) ? __sl144 : (many ? __sl255 : __sl256))));
                }
            }
            (yield* end_burn(obj, 0));
            if (menorah) {
...
function* print_queue(win, base) {
    ...
    let buf = new Uint8Array(256);
    if (!base) {
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl282)));
    } else {
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl283)));
        for (curr = base; curr; curr = cptr.ldPtr(curr)) {
            void cptr.sprintf(cptr.decay(buf), __sl284, cptr.ldI64o(curr, FLD.timer_element_timeout), BigInt.asIntN(64, cptr.ldU64o(curr, FLD.timer_element_tid)), (yield* kind_name(cptr.ldI16o(curr, FLD.timer_element_kind))), cptr.ldPtro2(timeout_funcs, cptr.ldI16o(curr, FLD.timer_element_func_index), 24, FLD.ttable_name), fmt_ptr(cptr.ldPtro(curr, FLD.timer_element_arg)));
...
export function* wiz_timeout_queue() {
    ...
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(buf))));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl144)));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl286)));
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl144)));
    (yield* print_queue(win, cptr.ldPtro(gt, FLD.instance_globals_t_timer_base)));
    count = (longestlen = 0);
    ...
    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl144)));
    if (!count) {
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl287)));
    } else {
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl288)));
        (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl144)));
        for (i = 0; (propname = cptr.ldPtro2(propertynames, i, 16, FLD.propname_prop_name)) !== null; ++i) {
            p = cptr.ldI32o(propertynames, i, 16);
            intrinsic = cptr.ldI64o2(u, p, 24, FLD.you_uprops + FLD.prop_intrinsic);
            if (intrinsic & 16777215n) {
                if (specindx > 0 && i >= specindx) {
                    (yield* Y.icall((cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl289)));
                    specindx = 0;
                }
        ...
        switch (cptr.ldI16o(curr, FLD.timer_element_kind)) {
            case NHC.TIMER_OBJECT:
            {
                ...
                if (owhere == NHM.OBJ_MIGRATING || (owhere == NHM.OBJ_MINVENT && !mon_is_local(cptr.ldPtro(top, FLD.obj_v)))) {
                    ...
                    (yield* impossible(__sl300, obj_adr, cptr.ld1so(obj, FLD.obj_where), t_id));
                } else if (!isok(x.v, y.v)) {
                    (yield* impossible(__sl301, obj_adr, cptr.ld1so(obj, FLD.obj_where), x.v, y.v, t_id));
                }
                break;
            }
            case NHC.TIMER_MONSTER:
            ...
            case NHC.TIMER_LEVEL:
            {
                ...
                if (isok(x.v, y.v)) {
                    ...
                    if (cptr.ldI16o(curr, FLD.timer_element_func_index) == NHC.MELT_ICE_AWAY && !is_ice(x.v, y.v) && !(cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ) == NHC.DRAWBRIDGE_DOWN && (((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.DB_UNDER) == NHM.DB_ICE))
                        (yield* impossible(__sl304, t_id, cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ), x.v, y.v));
                } else {
            ...
            break;
            default:
            (yield* impossible(__sl307, t_id, cptr.ldI16o(curr, FLD.timer_element_kind)));
            break;
        }
    }
}
...
export function* run_timers() {
    ...
    while (cptr.ldPtro(gt, FLD.instance_globals_t_timer_base) && cptr.ldI64o(cptr.ldPtro(gt, FLD.instance_globals_t_timer_base), FLD.fe_timeout) <= cptr.ldI64o(svm, FLD.instance_globals_saved_m_moves)) {
        ...
        (yield* Y.icall((cptr.ldPtro(timeout_funcs, cptr.ldI16o(curr, FLD.timer_element_func_index), 24))(cptr.add(curr, FLD.timer_element_arg), cptr.ldI64o(curr, FLD.timer_element_timeout))));
...
export function* obj_split_timers(src, dest) {
    ...
    for (curr = cptr.ldPtro(gt, FLD.instance_globals_t_timer_base); curr; curr = next_timer) {
        ...
        if (cptr.ldI16o(curr, FLD.timer_element_kind) == NHC.TIMER_OBJECT && cptr.eq(cptr.ldPtro(curr, FLD.timer_element_arg), src)) {
            void (yield* start_timer(BigInt.asIntN(64, cptr.ldI64o(curr, FLD.timer_element_timeout) - cptr.ldI64o(svm, FLD.instance_globals_saved_m_moves)), NHC.TIMER_OBJECT, cptr.ldI16o(curr, FLD.timer_element_func_index), obj_to_any(dest)));
        }
    }
}
    ...
    for (prev = null, curr = cptr.ldPtro(gt, FLD.instance_globals_t_timer_base); curr; curr = next_timer) {
        ...
        if (cptr.ldI16o(curr, FLD.timer_element_kind) == NHC.TIMER_OBJECT && cptr.eq(cptr.ldPtro(curr, FLD.timer_element_arg), obj)) {
            ...
            if ((cleanup_func = cptr.ldPtro2(timeout_funcs, cptr.ldI16o(curr, FLD.timer_element_func_index), 24, FLD.ttable_cleanup)) !== null)
                (yield* Y.icall((cleanup_func)(cptr.add(curr, FLD.timer_element_arg), cptr.ldI64o(curr, FLD.timer_element_timeout))));
            void __builtin___memset_chk(curr, 0, 48n, __builtin_object_size(curr, 0));
            cptr.free(curr);
        } else {
            prev = curr;
...
export function* obj_is_local(obj) {
    switch (cptr.ld1so(obj, FLD.obj_where)) {
        ...
        return (yield* obj_is_local(cptr.ldPtro(obj, FLD.obj_v)));
        case NHM.OBJ_MINVENT:
...
function* timer_is_local(timer) {
    switch (cptr.ldI16o(timer, FLD.timer_element_kind)) {
        ...
        return 0;
        case NHC.TIMER_OBJECT:
        return (yield* obj_is_local(cptr.ldPtro(timer, FLD.timer_element_arg)));
        case NHC.TIMER_MONSTER:
...
export function* save_timers(nhfp, range) {
    ...
    if ((cptr.ldI32o((nhfp), FLD.NHFILE_mode) & 3)) {
        if (range == NHM.RANGE_GLOBAL) {
            (yield* sfo_ulong(nhfp, cptr.add(svt, FLD.instance_globals_saved_t_timer_id), __sl316));
            ;
        }
...
export function* restore_timers(nhfp, range, adjust) {
    ...
    if (range == NHM.RANGE_GLOBAL) {
        (yield* sfi_ulong(nhfp, cptr.add(svt, FLD.instance_globals_saved_t_timer_id), __sl316));
        ;
    }
