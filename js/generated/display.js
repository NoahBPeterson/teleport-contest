    ...
    if (!mon_mimic || sensed) {
        ...
        if (cptr.ld1so(mon, $monst_mtame) && !Hallucination()) {
            if (worm_tail)
                ...
                num = (((Hallucination() ? ((rn2_on_display_rng)(NHC.NUMMONS)) : monsndx(mon)) + ((((cptr.ldI32o((mon), $monst_female) & 1) | 0) == 0) ? NHC.GLYPH_PET_MALE_OFF : NHC.GLYPH_PET_FEM_OFF)) | 0);
            ...
            if (worm_tail)
                ...
                num = (((Hallucination() ? ((rn2_on_display_rng)(NHC.NUMMONS)) : monsndx(mon)) + ((((cptr.ldI32o((mon), $monst_female) & 1) | 0) == 0) ? NHC.GLYPH_DETECT_MALE_OFF : NHC.GLYPH_DETECT_FEM_OFF)) | 0);
        } else {
            if (worm_tail)
                ...
                num = (((Hallucination() ? ((rn2_on_display_rng)(NHC.NUMMONS)) : monsndx(mon)) + ((((cptr.ldI32o((mon), $monst_female) & 1) | 0) == 0) ? NHC.GLYPH_MON_MALE_OFF : NHC.GLYPH_MON_FEM_OFF)) | 0);
        }
...
function display_warning(mon) {
    ...
    if ((Warning() && !(cptr.ldI32o((mon), $monst_mpeaceful) & 1) && (dist2((cptr.ldI16o((mon), $monst_mx)), (cptr.ldI16o((mon), $monst_my)), cptr.ldI16(u), cptr.ldI16o(u, $you_uy)) < 100) && ((((cptr.ld1uo((mon), $monst_m_lev) / 4) | 0)) >= cptr.ldI32o(svc, $context_info_warnlevel)))) {
        ...
        glyph = (((Hallucination() ? ((rn2_on_display_rng)(NHC.NUMMONS)) : monsndx(mon)) + ((((cptr.ldI32o((mon), $monst_female) & 1) | 0) == 0) ? NHC.GLYPH_MON_MALE_OFF : NHC.GLYPH_MON_FEM_OFF)) | 0);
    } else {
        impossible(__sl1);
        return;
    }
