...
import { IS_POOL, altar_to_glyph, engraving_to_defsym, glyph_is_cmap, glyph_is_detected_female_monster, glyph_is_detected_male_monster, glyph_is_female_pet, glyph_is_male_pet, glyph_is_normal_female_monster, glyph_is_normal_generic_obj, glyph_is_normal_male_monster, glyph_is_piletop_generic_obj, glyph_is_ridden_female_monster, glyph_is_ridden_male_monster, glyph_is_trap, has_mcorpsenm, is_cmap_furniture, is_cmap_room, is_cmap_wall, is_lightblocker_mappear, obj_is_generic, spot_shows_engravings } from './nhmacrofn.js';
...
export function map_object(obj, show) {
    ...
    if ((glyph_is_normal_generic_obj(glyph) || glyph_is_piletop_generic_obj(glyph)) && ((cptr.ld1uo(cptr.ldPtro(cptr.ldPtro(gv, $instance_globals_v_viz_array), y, 8), x) & NHM.IN_SIGHT) != 0) && !Hallucination()) {
...
export function map_glyphinfo(x, y, glyph, mgflags, glyphinfo) {
    let offset;
    let is_you = schar((((x) == cptr.ldI16(u) && (y) == cptr.ldI16o(u, $you_uy)) && ((glyph_is_normal_male_monster(glyph) || glyph_is_normal_female_monster(glyph)) || (glyph_is_male_pet(glyph) || glyph_is_female_pet(glyph)) || (glyph_is_ridden_male_monster(glyph) || glyph_is_ridden_female_monster(glyph)) || (glyph_is_detected_male_monster(glyph) || glyph_is_detected_female_monster(glyph))) ? 1 : 0));
