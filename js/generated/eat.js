...
function done_eating(message) {
    ...
    if (cptr.ldPtro(gn, $instance_globals_n_nomovemsg)) {
        ...
        You(__s_finish_s_s, (cptr.eq(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data), cptr.add(mons, NHC.PM_FIRE_ELEMENTAL, 96))) ? __s_consuming : __s_eating, food_xname(piece, 1));
    }
...
export function eat_brains(magr, mdef, visflag, dmg_p) {
    ...
    if (cptr.eq(magr, cptr.add(gy, $instance_globals_y_youmonst))) {
        ...
        if (((cptr.ldU64o((pd), $permonst_mflags1) & 65536n) != 0n)) {
            ...
            morehungry(-(rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 678, __s_eat_brains), rnd(30)) : rnd(30)));
...
function cprefx(pm) {
    ...
    switch (pm) {
        ...
        if (!((cptr.ldI16o(gu, $instance_globals_u_urole + $Role_mnum) == NHC.PM_CAVE_DWELLER) || (cptr.ldI16o(gu, $instance_globals_u_urace + $Race_mnum) == NHC.PM_ORC))) {
            You_feel(__s_that_eating_the_s_was_a_bad_idea, cptr.ldPtro3(mons, pm, 96, NHC.NEUTRAL, 8, 0));
            cptr.stI64o2(u, NHC.AGGRAVATE_MONSTER, 24, $you_uprops + $prop_intrinsic, cptr.ldI64o2(u, NHC.AGGRAVATE_MONSTER, 24, $you_uprops + $prop_intrinsic) | 67108864n);
        }
        break;
        case NHC.PM_LIZARD:
...
function consume_tin(mesg) {
    ...
    if (r != -1) {
        ...
        if (mnum == NHC.NON_PM) {
            if (Hallucination())
                pline(__s_it_s_full_of_s, (rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1551, __s_consume_tin), rn2(2)) : rn2(2)) ? __s_air_elemental_souffle : __s_dehydrated_water);
            else
        ...
        cptr.memcpy(cptr.add(svc, $context_info_victual), zero_victual, 40);
        You(__s_consume_s_s, cptr.ldPtro(tintxts, r, 24), cptr.ldPtro3(mons, mnum, 96, NHC.NEUTRAL, 8, 0));
        ...
        if (cptr.ldI32o2(tintxts, r, 24, 8) < 0) {
            make_vomiting(BigInt((((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1618, __s_consume_tin), rn2(15)) : rn2(15)) + 10) | 0)), 0);
        } else {
        ...
        if ((cptr.ldI32o2(tintxts, r, 24, 16) & 1)) {
            ...
            make_glib((alreadyglib + (((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1641, __s_consume_tin), rn2(11)) : rn2(11)) + 5) | 0)) | 0);
...
function rottenfood(obj) {
    ...
    if (!(rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1817, __s_rottenfood), rn2(4)) : rn2(4))) {
        ...
        make_confused(BigInt.asIntN(64, HConfusion() + BigInt((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1822, __s_rottenfood), d(2, 4)) : d(2, 4)))), 0);
        ...
        make_blinded(BigInt.asIntN(64, BlindedTimeout() + BigInt((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1827, __s_rottenfood), d(2, 10)) : d(2, 10)))), 0);
        if (!Blind())
...
function eatcorpse(otmp) {
    ...
    if (!glob && !stoneable && !slimeable && rotted > 5n) {
        ...
        pline(__s_ulch_that_s_was_tainted_s, (cptr.ld1so2(mons, mnum, 96, $permonst_mlet) == NHC.S_FUNGUS) ? __s_fungoid_vegetation : (vegetarian(cptr.add(mons, mnum, 96)) ? __s_protoplasm : __s_meat), cannibal ? __s_you_cannibal : __s_empty);
        ...
        losehp((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1926, __s_eatcorpse), rnd(15)) : rnd(15)), !glob ? __s_acidic_corpse : __s_acidic_glob, NHM.KILLED_BY_AN);
        ...
        if (!Poison_resistance()) {
            poison_strdmg((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1932, __s_eatcorpse), rnd(4)) : rnd(4)), (rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1932, __s_eatcorpse), rnd(15)) : rnd(15)), !glob ? __s_poisonous_corpse : __s_poisonous_glob, NHM.KILLED_BY_AN);
        } else
            You(__s_seem_unaffected_by_the_poison);
    } else if ((rotted > 5n || (rotted > 3n && (rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1939, __s_eatcorpse), rn2(5)) : rn2(5)))) && !(cptr.ldI64o2(u, NHC.SICK_RES, 24, $you_uprops + $prop_intrinsic) || cptr.ldI64o2(u, NHC.SICK_RES, 24, $you_uprops) || defended(cptr.add(gy, $instance_globals_y_youmonst), NHM.AD_DISE))) {
        tp++;
        You_feel(__s_ssick, (Sick()) ? __s_very__2 : __s_empty);
        losehp((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 1942, __s_eatcorpse), rnd(8)) : rnd(8)), !glob ? __s_cadaver : __s_rotted_glob, NHM.KILLED_BY_AN);
    }
...
function start_eating(otmp, already_partly_eaten) {
    ...
    }
    {
        if (debugcore(__s_eat_c, 1)) {
            let save_plnmsg = cptr.ldI32o(iflags, $instance_flags_last_msg);
            pline(__s_original_reqtime_d, cptr.ld1so2(objects, cptr.ldI16o(otmp, $obj_otyp), 120, $objclass_oc_delay));
            cptr.stI32o(iflags, $instance_flags_last_msg, save_plnmsg);
        }
    }
    {
    ...
    switch (cptr.ldI16o(otmp, $obj_otyp)) {
        ...
        if (cptr.ldI32o(otmp, $obj_corpsenm) == NHC.PM_PYROLISK) {
            if ((cptr.ld1so((otmp), $obj_where) == NHM.OBJ_INVENT))
                ...
                useupf(otmp, 1n);
            explode(cptr.ldI16(u), cptr.ldI16o(u, $you_uy), -11, (rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2108, __s_fprefx), d(3, 6)) : d(3, 6)), 0, NHC.EXPL_FIERY);
            return 0;
            ...
            make_vomiting(BigInt.asIntN(64, (Vomiting() & 16777215n) + BigInt((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2115, __s_fprefx), d(10, 4)) : d(10, 4)))), 1);
        } else
            {
        ...
        if (((cptr.ldU64o((cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)), $permonst_mflags1) & 536870912n) != 0n) && !((cptr.ldU64o((cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)), $permonst_mflags1) & 131072n) != 0n)) {
            ...
            if ((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2143, __s_fprefx), rn2(2)) : rn2(2)) && !((cptr.ldI16o(gu, $instance_globals_u_urole + $Role_mnum) == NHC.PM_CAVE_DWELLER) || (cptr.ldI16o(gu, $instance_globals_u_urace + $Race_mnum) == NHC.PM_ORC)))
                make_vomiting(BigInt((((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2144, __s_fprefx), rn2(cptr.ldI32o(svc, $context_info_victual + $victual_info_reqtime))) : rn2(cptr.ldI32o(svc, $context_info_victual + $victual_info_reqtime))) + 14) | 0)), 0);
        }
        break;
        ...
        if (((cptr.ldU64o((cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)), $permonst_mflags2) & 2n) != 0n)) {
            make_vomiting(BigInt((((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2164, __s_fprefx), rn2(cptr.ldI32o(svc, $context_info_victual + $victual_info_reqtime))) : rn2(cptr.ldI32o(svc, $context_info_victual + $victual_info_reqtime))) + 5) | 0)), 0);
            break;
        }
...
function fpostfx(otmp) {
    switch (cptr.ldI16o(otmp, $obj_otyp)) {
        ...
        if ((cptr.ldI32o(otmp, $obj_cursed) & 1) | 0 && !Sleep_resistance()) {
            ...
            fall_asleep(-(((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2595, __s_fpostfx), rn2(11)) : rn2(11)) + 20) | 0), 1);
        }
        break;
    }
    return;
...
function doeat_nonfood(otmp) {
    ...
    if (cptr.ld1so(otmp, $obj_oclass) == NHC.WEAPON_CLASS && (cptr.ldI32o(otmp, $obj_otrapped) & 1) | 0) {
        pline(__s_ecch_that_must_have_been_poisonous);
        if (!Poison_resistance()) {
            poison_strdmg((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2798, __s_doeat_nonfood), rnd(4)) : rnd(4)), (rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2798, __s_doeat_nonfood), rnd(15)) : rnd(15)), xname(otmp), NHM.KILLED_BY_AN);
        } else
            You(__s_seem_unaffected_by_the_poison);
    } else if (!nodelicious) {
...
export function doeat() {
    ...
    if (is_metallic(otmp.v) && cptr.ldI32o(u, $you_umonnum) == NHC.PM_RUST_MONSTER && (cptr.ldI32o(otmp.v, $obj_oerodeproof) & 1) | 0) {
        ...
        make_stunned(BigInt.asIntN(64, (HStun() & 16777215n) + BigInt((rng_log_enabled() ? (rng_log_set_caller(__s_eat_c, 2888, __s_doeat), rn2(10)) : rn2(10)))), 1);
