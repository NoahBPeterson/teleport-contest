...
export function luaS_init(L) {
    ...
    cptr.stPtro(g, FLD.global_State_memerrmsg, (luaS_newlstr(L, __sl0, BigInt.asUintN(64, (18n / 1n) - 1n))));
...
export function luaS_createlngstrobj(L, l) {
    let ts = createstrobj(L, l, 20, cptr.ldI32o((cptr.ldPtro(L, FLD.lua_State_l_G)), FLD.global_State_seed));
...
function growstrtab(L, tb) {
    ...
    if (cptr.ldI32o(tb, FLD.stringtable_size) <= 1073741823)
        luaS_resize(L, Math.imul(cptr.ldI32o(tb, FLD.stringtable_size), 2));
}
