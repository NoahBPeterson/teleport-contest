...
export function dodrink() {
    ...
    if (objdescr_is(otmp, __s_milky) && !(cptr.ld1uo2(svm, NHC.PM_GHOST, $sizeof_mvitals, $instance_globals_saved_m_mvitals + $mvitals_mvflags) & 3) && !rn2(((13 + Math.imul(2, (cptr.ld1uo2(svm, NHC.PM_GHOST, $sizeof_mvitals, $instance_globals_saved_m_mvitals)))) | 0))) {
        ghost_from_bottle();
        useup(otmp);
        return NHM.ECMD_TIME;
    } else if (objdescr_is(otmp, __s_smoky) && !(cptr.ld1uo2(svm, NHC.PM_DJINNI, $sizeof_mvitals, $instance_globals_saved_m_mvitals + $mvitals_mvflags) & 3) && !rn2(((13 + Math.imul(2, (cptr.ld1uo2(svm, NHC.PM_DJINNI, $sizeof_mvitals, $instance_globals_saved_m_mvitals)))) | 0))) {
...
function peffect_hallucination(otmp) {
    ...
    void make_hallucinated(itimeout_incr(HHallucination(), ((rn2(200) + ((600 - Math.imul(300, bcsign(otmp))) | 0)) | 0)), 1, 0n);
    if (((cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 && !rn2(3)) || (!(cptr.ldI32o(otmp, $obj_cursed) & 1) && !rn2(6))) {
...
function peffect_water(otmp) {
    ...
    if (mon_hates_blessings(cptr.add(gy, $instance_globals_y_youmonst)) || cptr.ld1so(u, $you_ualign) == -1) {
        if ((cptr.ldI32o(otmp, $obj_blessed) & 1)) {
            ...
            losehp(((Half_physical_damage()) ? ((((d(2, 6) + 1) | 0) / 2) | 0) : d(2, 6)), __s_potion_of_holy_water, NHM.KILLED_BY_AN);
        ...
        if ((cptr.ldI32o(otmp, $obj_blessed) & 1)) {
            ...
            if (cptr.ld1so(u, $you_ualign) == NHM.A_LAWFUL) {
                pline(__s_this_burns_like_s, hliquid(__s_acid));
                losehp(((Half_physical_damage()) ? ((((d(2, 6) + 1) | 0) / 2) | 0) : d(2, 6)), __s_potion_of_unholy_water, NHM.KILLED_BY_AN);
            } else
...
function peffect_booze(otmp) {
    ...
    if (!(cptr.ldI32o(otmp, $obj_blessed) & 1)) {
        ...
        make_confused(itimeout_incr(HConfusion(), d(((2 + cptr.ldI32o(u, $you_uhs)) >>> 0) | 0, 8)), 0);
    }
...
function peffect_invisibility(otmp) {
    ...
    if ((cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 && !rn2(HInvis() ? 15 : 30))
        ...
        incr_itimeout(cptr.add(cptr.add(cptr.add(u, $you_uprops), NHC.INVIS, $sizeof_prop), $prop_intrinsic), (d(((6 - Math.imul(3, bcsign(otmp))) | 0), 100) + 100) | 0);
...
function peffect_see_invisible(otmp) {
    ...
    if ((cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 && !rn2(permchance))
        ...
        incr_itimeout(cptr.add(cptr.add(cptr.add(u, $you_uprops), NHC.SEE_INVIS, $sizeof_prop), $prop_intrinsic), ((rn2(100) + 750) | 0));
        ...
        if ((cptr.ldI16o(gu, $instance_globals_u_urole + $Role_mnum) == NHC.PM_HEALER)) {
            ...
            if (!Poison_resistance()) {
                if (cptr.ldI32o(otmp, $obj_corpsenm))
                    losehp((rnd(10) + Math.imul(5, !!((cptr.ldI32o(otmp, $obj_cursed) & 1)))) | 0, cptr.decay(contaminant), NHM.KILLED_BY);
                else
                    losehp((rnd(10) + Math.imul(5, !!((cptr.ldI32o(otmp, $obj_cursed) & 1)))) | 0, cptr.decay(contaminant), NHM.KILLED_BY_AN);
            } else {
                /* rnd loss is so that unblessed poorer than blessed */
                losehp((1 + rn2(2)) | 0, cptr.decay(contaminant), schar(((cptr.ldI32o(otmp, $obj_corpsenm)) ? NHM.KILLED_BY : NHM.KILLED_BY_AN)));
            }
            exercise(NHC.A_CON, 0);
        }
    }
...
function peffect_confusion(otmp) {
    if (!HConfusion()) {
        ...
        (cptr.stI32o(gp, $instance_globals_p_potion_nothing, cptr.ldI32o(gp, $instance_globals_p_potion_nothing) + 1)) - (1);
    make_confused(itimeout_incr(HConfusion(), ((rn2(7) + ((16 - Math.imul(8, bcsign(otmp))) | 0)) | 0)), 0);
}
...
function peffect_blindness(otmp) {
    if (Blind() || ((HBlinded() || EBlinded()) && BBlinded()))
        (cptr.stI32o(gp, $instance_globals_p_potion_nothing, cptr.ldI32o(gp, $instance_globals_p_potion_nothing) + 1)) - (1);
    make_blinded(itimeout_incr(BlindedTimeout(), ((rn2(200) + ((250 - Math.imul(125, bcsign(otmp))) | 0)) | 0)), schar((!Blind())));
}
...
function peffect_healing(otmp) {
    ...
    healup((8 + d(((4 + Math.imul(2, bcsign(otmp))) | 0), 4)) | 0, !(cptr.ldI32o(otmp, $obj_cursed) & 1) ? 1 : 0, schar((!!(cptr.ldI32o(otmp, $obj_blessed) & 1))), schar((!(cptr.ldI32o(otmp, $obj_cursed) & 1))));
    exercise(NHC.A_CON, 1);
}
...
function peffect_extra_healing(otmp) {
    ...
    healup((16 + d(((4 + Math.imul(2, bcsign(otmp))) | 0), 8)) | 0, (cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 ? 5 : (!(cptr.ldI32o(otmp, $obj_cursed) & 1) ? 2 : 0), schar((!(cptr.ldI32o(otmp, $obj_cursed) & 1))), 1);
...
function peffect_levitation(otmp) {
    ...
    if ((cptr.ldI32o(otmp, $obj_cursed) & 1)) {
        ...
        incr_itimeout(cptr.add(cptr.add(cptr.add(u, $you_uprops), NHC.LEVITATION, $sizeof_prop), $prop_intrinsic), ((rn2(50) + 250) | 0));
        ...
        incr_itimeout(cptr.add(cptr.add(cptr.add(u, $you_uprops), NHC.LEVITATION, $sizeof_prop), $prop_intrinsic), ((rn2(140) + 10) | 0));
...
function peffect_gain_energy(otmp) {
     ...
     */
    num = d(((cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 ? 3 : (!(cptr.ldI32o(otmp, $obj_cursed) & 1) ? 2 : 1)), 6);
    if ((cptr.ldI32o(otmp, $obj_cursed) & 1))
...
function peffect_acid(otmp) {
    if (Acid_resistance()) {
        ...
        dmg = d(((cptr.ldI32o(otmp, $obj_cursed) & 1) | 0 ? 2 : 1), ((cptr.ldI32o(otmp, $obj_blessed) & 1) | 0 ? 4 : 8));
    ...
    if (!Unchanging()) {
        if (!(cptr.ldI32o(otmp, $obj_blessed) & 1) || (cptr.ldI32o(u, $you_umonnum) != cptr.ldI32o(u, $you_umonster)))
            ...
            if (cptr.ldI32o(u, $you_mtimedone) && cptr.ldI32o(u, $you_umonnum) != cptr.ldI32o(u, $you_umonster))
                cptr.stI32o(u, $you_mtimedone, ((cptr.ldI32o(u, $you_mtimedone)) < ((rn2(15) + 10) | 0) ? (cptr.ldI32o(u, $you_mtimedone)) : ((rn2(15) + 10) | 0)));
        }
    }
}
...
export function potionhit(mon, obj, how) {
    ...
    __dispatch: while (true) {
        ...
        if (isyou) {
            ...
            losehp(((Half_physical_damage()) ? ((((rnd(2) + 1) | 0) / 2) | 0) : rnd(2)), (how == NHM.POTHIT_OTHER_THROW) ? __s_propelled_potion : __s_thrown_potion, NHM.KILLED_BY_AN);
        } else {
            tx = cptr.ldI16o(mon, $monst_mx), ty = cptr.ldI16o(mon, $monst_my);
            /* sometimes it hits the saddle */
            if (((cptr.ldI64o(mon, $monst_misc_worn_check) & 1048576n) && (saddle = which_armor(mon, 1048576n))) && (!rn2(10) || (cptr.ldI16o(obj, $obj_otyp) == NHC.POT_WATER && ((rnl(10) > 7 && (cptr.ldI32o(obj, $obj_cursed) & 1) | 0) || (rnl(10) < 4 && (cptr.ldI32o(obj, $obj_blessed) & 1) | 0) || !rn2(3)))))
                hit_saddle = 1;
        ...
        switch (cptr.ldI16o(obj, $obj_otyp)) {
            ...
            if (!Acid_resistance()) {
                ...
                dmg = d(((cptr.ldI32o(obj, $obj_cursed) & 1) | 0 ? 2 : 1), ((cptr.ldI32o(obj, $obj_blessed) & 1) | 0 ? 4 : 8));
                losehp(((Half_physical_damage()) ? (((((dmg) + 1) | 0) / 2) | 0) : (dmg)), __s_potion_of_acid, NHM.KILLED_BY_AN);
            }
            break;
        }
        ...
        if (((cptr.ldU64o((cptr.ldPtro(mon, $monst_data)), $permonst_mflags1) & 4096n) == 0n) && !mon_perma_blind(mon)) {
            btmp = (((64 + rn2(32)) | 0) + Math.imul(rn2(32), !resist(mon, NHC.POTION_CLASS, 0, NHM.NOTELL))) | 0;
        ...
        if (!Resists_Elem(mon, NHC.ACID_RES) && !resist(mon, NHC.POTION_CLASS, 0, NHM.NOTELL)) {
            ...
            if (!(cptr.ld1uo((cptr.ldPtro(mon, $monst_data)), $permonst_msound) == NHC.MS_SILENT))
                wake_nearto(i16(tx), i16(ty), Math.imul(cptr.ld1so(cptr.ldPtro(mon, $monst_data), $permonst_mlevel), 10));
            cptr.stI32o(mon, $monst_mhp, (cptr.ldI32o(mon, $monst_mhp) - d(((cptr.ldI32o(obj, $obj_cursed) & 1) | 0 ? 2 : 1), ((cptr.ldI32o(obj, $obj_blessed) & 1) | 0 ? 4 : 8))) | 0);
            if ((cptr.ldI32o((mon), $monst_mhp) < 1)) {
                if (your_fault)
                    killed(mon);
                else
...
export function potionbreathe(obj) {
    ...
    switch (Half_gas_damage() ? NHC.TOWEL : cptr.ldI16o(obj, $obj_otyp)) {
        ...
        incr_itimeout(cptr.add(cptr.add(cptr.add(u, $you_uprops), NHC.FAST, $sizeof_prop), $prop_intrinsic), rnd(5));
...
function dip_potion_explosion(obj, dmg) {
    if ((cptr.ldI32o(obj, $obj_cursed) & 1) | 0 || cptr.ldI16o(obj, $obj_otyp) == NHC.POT_ACID || (cptr.ldI16o(obj, $obj_otyp) == NHC.POT_OIL && (cptr.ldI32o(obj, $obj_lamplit) & 1) | 0) || !rn2((uarmc.v && cptr.ldI16o(uarmc.v, $obj_otyp) == NHC.ALCHEMY_SMOCK) ? 30 : 10)) {
