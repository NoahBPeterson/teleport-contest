...
export function mk_mplayer(ptr, x, y, special) {
    ...
    if ((cptr.ldPtro3(svl, x, 168, y, 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters) !== null))
        void rloc((cptr.ldPtro3(svl, x, 168, y, 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters)), 5);
...
export function mplayer_talk(mtmp) {
    if ((cptr.ldI32o(mtmp, FLD.monst_mpeaceful) & 1))
        return;
    ;
    verbalize(__sl51, cptr.eq(cptr.ldPtro(mtmp, FLD.monst_data), cptr.add(mons, cptr.ldI16o(gu, FLD.instance_globals_u_urole + FLD.Role_mnum), 96)) ? cptr.ldPtro(__static_mplayer_talk_same_class_msg, (rng_log_enabled() ? (rng_log_set_caller(__sl40, 375, __sl52), rn2(3)) : rn2(3)), 8) : cptr.ldPtro(__static_mplayer_talk_other_class_msg, (rng_log_enabled() ? (rng_log_set_caller(__sl40, 376, __sl52), rn2(3)) : rn2(3)), 8));
}
