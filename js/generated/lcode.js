...
function fixjump(fs, pc, dest) {
    ...
    if (!(-16777215 <= offset && offset <= 16777216))
        luaX_syntaxerror(cptr.ldPtro(fs, FLD.FuncState_ls), __sl0);
    (void 0);
...
function savelineinfo(fs, f, line) {
    ...
    if (Math.abs(linedif) >= 128 || cptr.postinc1(cptr.add(fs, FLD.FuncState_iwthabs)) >= 128) {
        (cptr.stPtro(f, FLD.Proto_abslineinfo, ((luaM_growaux_(cptr.ldPtro(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_L), cptr.ldPtro(f, FLD.Proto_abslineinfo), cptr.ldI32o(fs, FLD.FuncState_nabslineinfo), cptr.add(f, FLD.Proto_sizeabslineinfo), 8, 2147483647, __sl1)))));
    ...
    (cptr.stPtro(f, FLD.Proto_lineinfo, ((luaM_growaux_(cptr.ldPtro(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_L), cptr.ldPtro(f, FLD.Proto_lineinfo), pc, cptr.add(f, FLD.Proto_sizelineinfo), 1, 2147483647, __sl2)))));
...
export function luaK_code(fs, i) {
    let f = cptr.ldPtr(fs);
    (cptr.stPtro(f, FLD.Proto_code, ((luaM_growaux_(cptr.ldPtro(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_L), cptr.ldPtro(f, FLD.Proto_code), cptr.ldI32o(fs, FLD.FuncState_pc), cptr.add(f, FLD.Proto_sizecode), 4, 2147483647, __sl2)))));
    cptr.stI32o(cptr.ldPtro(f, FLD.Proto_code), (cptr.stI32o(fs, FLD.FuncState_pc, cptr.ldI32o(fs, FLD.FuncState_pc) + 1)) - (1), i, 4);
    savelineinfo(fs, f, cptr.ldI32o(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_lastline));
...
export function luaK_checkstack(fs, n) {
    ...
    if (newstack > cptr.ld1uo(cptr.ldPtr(fs), FLD.Proto_maxstacksize)) {
        if (newstack >= 255)
            luaX_syntaxerror(cptr.ldPtro(fs, FLD.FuncState_ls), __sl3);
...
function addk(fs, key, v) {
    ...
    if (((cptr.ld1uo(((idx)), FLD.TValue_tt_)) == 3)) {
        ...
        if (k < cptr.ldI32o(fs, FLD.FuncState_nk) && (((cptr.ld1uo((cptr.add(cptr.ldPtro(f, FLD.Proto_k), k, 16)), FLD.TValue_tt_))) & 63) == (((cptr.ld1uo((v), FLD.TValue_tt_))) & 63) && luaV_equalobj(null, cptr.add(cptr.ldPtro(f, FLD.Proto_k), k, 16), v))
            return k;
    }
    ...
    ;
    luaH_finishset(L, cptr.ldPtro(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_h), key, idx, val);
    (cptr.stPtro(f, FLD.Proto_k, ((luaM_growaux_(L, cptr.ldPtro(f, FLD.Proto_k), k, cptr.add(f, FLD.Proto_sizek), 16, 33554431, __sl4)))));
...
function str2K(fs, e) {
    (void 0);
    cptr.stI32o(e, FLD.expdesc_u, stringK(fs, cptr.ldPtro(e, FLD.expdesc_u)));
    cptr.stI32(e, NHC.VK);
}
...
export function luaK_dischargevars(fs, e) {
    switch (cptr.ldI32(e)) {
        ...
        case NHC.VUPVAL:
        {
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_GETUPVAL, 0, cptr.ldI32o(e, FLD.expdesc_u), 0, 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        case NHC.VINDEXUP:
        {
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_GETTABUP, 0, cptr.ld1uo(e, FLD.expdesc_u + 2), cptr.ldI16o(e, FLD.expdesc_u), 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        case NHC.VINDEXI:
        {
            ...
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_GETI, 0, cptr.ld1uo(e, FLD.expdesc_u + 2), cptr.ldI16o(e, FLD.expdesc_u), 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        case NHC.VINDEXSTR:
        {
            freereg(fs, cptr.ld1uo(e, FLD.expdesc_u + 2));
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_GETFIELD, 0, cptr.ld1uo(e, FLD.expdesc_u + 2), cptr.ldI16o(e, FLD.expdesc_u), 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        case NHC.VINDEXED:
        {
            ...
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_GETTABLE, 0, cptr.ld1uo(e, FLD.expdesc_u + 2), cptr.ldI16o(e, FLD.expdesc_u), 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        case NHC.VVARARG:
...
function discharge2reg(fs, e, reg) {
    ...
    switch (cptr.ldI32(e)) {
        ...
        case NHC.VK:
        {
            luaK_codek(fs, reg, cptr.ldI32o(e, FLD.expdesc_u));
            break;
        }
        case NHC.VKFLT:
        {
            luaK_float(fs, reg, cptr.ldF64o(e, FLD.expdesc_u));
            break;
        }
        case NHC.VKINT:
        {
            luaK_int(fs, reg, cptr.ldI64o(e, FLD.expdesc_u));
            break;
        }
        case NHC.VRELOC:
        {
        ...
        case NHC.VNONRELOC:
        {
            if (reg != cptr.ldI32o(e, FLD.expdesc_u))
                luaK_codeABCk(fs, NHC.OP_MOVE, reg, cptr.ldI32o(e, FLD.expdesc_u), 0, 0);
            break;
        }
        default:
        {
...
function discharge2anyreg(fs, e) {
    if (cptr.ldI32(e) != NHC.VNONRELOC) {
        luaK_reserveregs(fs, 1);
        discharge2reg(fs, e, (cptr.ld1uo(fs, FLD.FuncState_freereg) - 1) | 0);
    }
}
...
function exp2reg(fs, e, reg) {
    ...
    if (cptr.ldI32(e) == NHC.VJMP)
        luaK_concat(fs, cptr.add(e, FLD.expdesc_t), cptr.ldI32o(e, FLD.expdesc_u));
    if ((cptr.ldI32o((e), FLD.expdesc_t) != cptr.ldI32o((e), FLD.expdesc_f))) {
        let final;
        let p_f = -1;
        let p_t = -1;
        ...
        patchlistaux(fs, cptr.ldI32o(e, FLD.expdesc_f), final, reg, p_f);
        patchlistaux(fs, cptr.ldI32o(e, FLD.expdesc_t), final, reg, p_t);
    }
...
export function luaK_exp2nextreg(fs, e) {
    ...
    freeexp(fs, e);
    luaK_reserveregs(fs, 1);
    exp2reg(fs, e, (cptr.ld1uo(fs, FLD.FuncState_freereg) - 1) | 0);
}
...
export function luaK_exp2anyreg(fs, e) {
    ...
    if (cptr.ldI32(e) == NHC.VNONRELOC) {
        ...
        if (cptr.ldI32o(e, FLD.expdesc_u) >= luaY_nvarstack(fs)) {
            exp2reg(fs, e, cptr.ldI32o(e, FLD.expdesc_u));
            return cptr.ldI32o(e, FLD.expdesc_u);
        }
    }
...
function luaK_exp2K(fs, e) {
    if (!(cptr.ldI32o((e), FLD.expdesc_t) != cptr.ldI32o((e), FLD.expdesc_f))) {
        ...
        switch (cptr.ldI32(e)) {
            ...
            break;
            case NHC.VKINT:
            info = luaK_intK(fs, cptr.ldI64o(e, FLD.expdesc_u));
            break;
            case NHC.VKFLT:
            info = luaK_numberK(fs, cptr.ldF64o(e, FLD.expdesc_u));
            break;
            case NHC.VKSTR:
            info = stringK(fs, cptr.ldPtro(e, FLD.expdesc_u));
            break;
            case NHC.VK:
...
function codeABRK(fs, o, a, b, ec) {
    let k = exp2RK(fs, ec);
    luaK_codeABCk(fs, o, a, b, cptr.ldI32o(ec, FLD.expdesc_u), k);
}
...
export function luaK_storevar(fs, var$, ex) {
    switch (cptr.ldI32(var$)) {
        ...
        {
            freeexp(fs, ex);
            exp2reg(fs, ex, cptr.ld1uo(var$, FLD.expdesc_u));
            return;
        }
        case NHC.VUPVAL:
        {
            let e = luaK_exp2anyreg(fs, ex);
            luaK_codeABCk(fs, NHC.OP_SETUPVAL, e, cptr.ldI32o(var$, FLD.expdesc_u), 0, 0);
            break;
        }
        case NHC.VINDEXUP:
        {
            codeABRK(fs, NHC.OP_SETTABUP, cptr.ld1uo(var$, FLD.expdesc_u + 2), cptr.ldI16o(var$, FLD.expdesc_u), ex);
            break;
        }
        case NHC.VINDEXI:
        {
            codeABRK(fs, NHC.OP_SETI, cptr.ld1uo(var$, FLD.expdesc_u + 2), cptr.ldI16o(var$, FLD.expdesc_u), ex);
            break;
        }
        case NHC.VINDEXSTR:
        {
            codeABRK(fs, NHC.OP_SETFIELD, cptr.ld1uo(var$, FLD.expdesc_u + 2), cptr.ldI16o(var$, FLD.expdesc_u), ex);
            break;
        }
        case NHC.VINDEXED:
        {
            codeABRK(fs, NHC.OP_SETTABLE, cptr.ld1uo(var$, FLD.expdesc_u + 2), cptr.ldI16o(var$, FLD.expdesc_u), ex);
            break;
        }
        default:
        (void 0);
...
export function luaK_self(fs, e, key) {
    ...
    codeABRK(fs, NHC.OP_SELF, cptr.ldI32o(e, FLD.expdesc_u), ereg, key);
    freeexp(fs, key);
}
...
function jumponcond(fs, e, cond) {
    ...
    freeexp(fs, e);
    return condjump(fs, NHC.OP_TESTSET, 255, cptr.ldI32o(e, FLD.expdesc_u), 0, cond);
}
...
export function luaK_goiftrue(fs, e) {
    ...
    luaK_concat(fs, cptr.add(e, FLD.expdesc_f), pc);
    luaK_patchtohere(fs, cptr.ldI32o(e, FLD.expdesc_t));
...
export function luaK_goiffalse(fs, e) {
    ...
    luaK_concat(fs, cptr.add(e, FLD.expdesc_t), pc);
    luaK_patchtohere(fs, cptr.ldI32o(e, FLD.expdesc_f));
...
function codenot(fs, e) {
    switch (cptr.ldI32(e)) {
        ...
        case NHC.VNONRELOC:
        {
            discharge2anyreg(fs, e);
            freeexp(fs, e);
            cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, NHC.OP_NOT, 0, cptr.ldI32o(e, FLD.expdesc_u), 0, 0));
            cptr.stI32(e, NHC.VRELOC);
            break;
        }
        default:
...
export function luaK_indexed(fs, t, k) {
    ...
    if (cptr.ldI32(t) == NHC.VUPVAL) {
        ...
        if (isKstr(fs, k)) {
            ...
            cptr.stI16o(t, FLD.expdesc_u, i16(luaK_exp2anyreg(fs, k)));
...
function constfolding(fs, op, e1, e2) {
    ...
    if (!tonumeral(e1, v1) || !tonumeral(e2, v2) || !validop(op, v1, v2))
        return 0;
    luaO_rawarith(cptr.ldPtro(cptr.ldPtro(fs, FLD.FuncState_ls), FLD.LexState_L), op, v1, v2, res);
...
function codeunexpval(fs, op, e, line) {
    ...
    freeexp(fs, e);
    cptr.stI32o(e, FLD.expdesc_u, luaK_codeABCk(fs, op, 0, r, 0, 0));
    cptr.stI32(e, NHC.VRELOC);
...
function codeorder(fs, opr, e1, e2) {
    ...
    freeexps(fs, e1, e2);
    cptr.stI32o(e1, FLD.expdesc_u, condjump(fs, op, r1, r2, isfloat.v, 1));
...
function codeeq(fs, opr, e1, e2) {
    ...
    freeexps(fs, e1, e2);
    cptr.stI32o(e1, FLD.expdesc_u, condjump(fs, op, r1, r2, isfloat.v, (opr == NHC.OPR_EQ)));
    cptr.stI32(e1, NHC.VJMP);
}
...
function codeconcat(fs, e1, e2, line) {
    ...
    if (((((((cptr.ldI32(ie2)) >>> 0) & (((~(((~0) << 7) >>> 0)) << 0) >>> 0)) >>> 0))) == NHC.OP_CONCAT) {
        ...
        luaK_codeABCk(fs, NHC.OP_CONCAT, cptr.ldI32o(e1, FLD.expdesc_u), 2, 0, 0);
        freeexp(fs, e2);
        luaK_fixline(fs, line);
    }
}
...
export function luaK_posfix(fs, opr, e1, e2, line) {
    ...
    switch (opr) {
        ...
        {
            (void 0);
            luaK_concat(fs, cptr.add(e2, FLD.expdesc_f), cptr.ldI32o(e1, FLD.expdesc_f));
            cptr.memcpy(e1, e2, 24);
            break;
        }
        case NHC.OPR_OR:
        {
            (void 0);
            luaK_concat(fs, cptr.add(e2, FLD.expdesc_t), cptr.ldI32o(e1, FLD.expdesc_t));
            cptr.memcpy(e1, e2, 24);
            break;
        }
        case NHC.OPR_CONCAT:
