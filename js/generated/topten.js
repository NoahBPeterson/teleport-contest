...
function score_wanted(current_ver, rank, t1, playerct, players, uid) {
    ...
    for (i = 0; i < playerct; i++) {
        ...
        if (cptr.ld1so(arg, 0) == 45 && cptr.strchr(__sl147, cptr.ld1so(arg, 1)) && !cptr.ld1so(arg, 2) && ((i + 1) | 0) < playerct) {
            ...
            if ((cptr.ld1so(arg, 1) == 112 && str2role(nxt) == str2role(cptr.add(t1, 76))) || (cptr.ld1so(arg, 1) == 114 && str2race(nxt) == str2race(cptr.add(t1, 80))) || (cptr.ld1so(arg, 1) == 117 && (!strcmp(nxt, __sl148) || !cptr.strncmp(cptr.add(t1, 92), nxt, 10n))))
                return 1;
            i++;
