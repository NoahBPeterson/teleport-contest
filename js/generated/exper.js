...
export function losexp(drainer) {
    ...
    if (drainer && !strcmp(drainer, __sl2))
        drainer = null;
    else if (resists_drli(cptr.add(gy, FLD.instance_globals_y_youmonst)))
        return;
    if (cptr.ldI32o(u, FLD.you_ulevel) > 1 || drainer)
        pline(__sl3, Goodbye(), cptr.ldI32o(u, FLD.you_ulevel));
    if (cptr.ldI32o(u, FLD.you_ulevel) > 1) {
        cptr.stI32o(u, FLD.you_ulevel, (cptr.ldI32o(u, FLD.you_ulevel) - 1) | 0);
        adjabil((cptr.ldI32o(u, FLD.you_ulevel) + 1) | 0, cptr.ldI32o(u, FLD.you_ulevel));
        livelog_printf(4096n, __sl4, (cptr.ldI32o(u, FLD.you_ulevel) + 1) | 0);
        ;
    } else {
        if (drainer) {
...
export function pluslvl(incr) {
    ...
    if (cptr.ldI32o(u, FLD.you_ulevel) < NHM.MAXULEV) {
        ...
        pline(__sl10, (cptr.ldI32o(u, FLD.you_ulevelmax) < cptr.ldI32o(u, FLD.you_ulevel)) ? __sl11 : __sl12, cptr.ldI32o(u, FLD.you_ulevel));
        ...
        if (count_achievements() == old_ach_cnt)
            livelog_printf(4096n, __sl13, (cptr.ldI32o(u, FLD.you_ulevel) <= cptr.ldI32o(u, FLD.you_ulevelpeak)) ? __sl14 : __sl11, cptr.ldI32o(u, FLD.you_ulevel));
