...
function attributes_enlightenment(unused_mode, final) {
    ...
    if ((HBlinded() || EBlinded()) && BBlinded())
        enlght_line(cptr.decay((You_)), final ? cptr.decay((could)) : cptr.decay((can)), ((__s_see)), ((from_what(-15))));
    ...
    if (Warn_of_mon() && ismnum(warnspecies)) {
        void cptr.sprintf(cptr.decay(buf), __s_aware_of_the_presence_of_s, makeplural(cptr.ldPtro3(mons, warnspecies, 96, NHC.NEUTRAL, 8, 0)));
        enlght_line(cptr.decay((You_)), final ? cptr.decay((were)) : cptr.decay((are)), cptr.decay(((buf))), ((from_what(NHC.WARN_OF_MON))));
    }
    if (Undead_warning())
...
export function record_achievement(achidx) {
    ...
    if (absidx >= NHC.ACH_RNK1 && absidx <= NHC.ACH_RNK8) {
        livelog_printf(cptr.ldI64o(achieve_msg, absidx, 16), __s_attained_the_rank_of_s_level_d, rank_of(rank_to_xlev((absidx - ((NHC.ACH_RNK1 - 1) | 0)) | 0), Role_switch(), schar(((achidx < 0) ? 1 : 0))), cptr.ldI32o(u, $you_ulevel));
        ...
        livelog_printf(cptr.ldI64o(achieve_msg, achidx, 16), __s_s_s__2, cptr.ldPtro2(achieve_msg, achidx, 16, $ll_achieve_msg_msg), (cptr.ldPtro(obj_descr, cptr.ldI16((cptr.add(objects, otyp, 120))), 16)));
    } else {
        livelog_printf(cptr.ldI64o(achieve_msg, absidx, 16), __s_pct_s, cptr.ldPtro2(achieve_msg, absidx, 16, $ll_achieve_msg_msg));
    }
}
            ...
            for (ni = 0; ni < ntypes; ni++) {
                ...
                if (((cptr.ldU16o2(mons, i, 96, $permonst_geno) & NHM.G_UNIQ) != 0 && i != NHC.PM_HIGH_CLERIC)) {
                    ...
                    if (nkilled == 1)
                        ...
                        void cptr.sprintf(cptr.decay(buf), __s_3d_s, nkilled, makeplural(cptr.ldPtro3(mons, i, 96, NHC.NEUTRAL, 8, 0)));
                }
...
export function num_genocides() {
    ...
    for (i = NHC.LOW_PM; i < NHC.NUMMONS; ++i) {
        if (cptr.ld1uo2(svm, i, 12, $instance_globals_saved_m_mvitals + $mvitals_mvflags) & NHM.G_GENOD) {
            ++n;
            if (((cptr.ldU16o2(mons, i, 96, $permonst_geno) & NHM.G_UNIQ) != 0 && i != NHC.PM_HIGH_CLERIC))
                impossible(__s_unique_creature_d_s_genocided, i, cptr.ldPtro3(mons, i, 96, NHC.NEUTRAL, 8, 0));
        }
    }
    return n;
}
    ...
    if (ngone > 0) {
        ...
        if (c == 121 || c == 97) {
            ...
            for (i = 0; i < ngone; ++i) {
                ...
                void cptr.sprintf(cptr.decay(buf), __s_sp_pct_s, makeplural(cptr.ldPtro3(mons, mndx, 96, NHC.NEUTRAL, 8, 0)));
