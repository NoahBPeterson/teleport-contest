...
function background_enlightenment(unused_mode, final) {
    ...
    enlght_line(cptr.decay((You_)), final ? cptr.decay((were)) : cptr.decay((are)), cptr.decay(((buf))), ((__sl0)));
    void cptr.sprintf(cptr.decay(buf), __sl104, cptr.decay(You_), !final ? cptr.decay(are) : cptr.decay(were), align_str(cptr.ld1so(u, 2172)), (cptr.ld1so(u, 2172) != cptr.ld1so2(u, NHM.A_CURRENT, 1, 2184)) ? (!final ? __sl99 : __sl105) : ((cptr.ld1so(u, 2172) != cptr.ld1so2(u, NHM.A_ORIGINAL, 1, 2184)) ? (!final ? __sl106 : __sl107) : ((!cptr.ldI64o(u, 1992) && cptr.ldI64o(svm, 8) > 1000n) ? __sl108 : __sl0)), u_gname());
    enlght_out(cptr.decay(buf));
...
function status_enlightenment(mode, final) {
    ...
    if (((cptr.ldI32o(u, 1852) & 1))) {
        ...
        enlght_line(cptr.decay((You_)), final ? cptr.decay((were)) : cptr.decay((are)), (((cptr.ldI64o2(u, NHC.SWIMMING, 24, 128) || cptr.ldI64o2(u, NHC.SWIMMING, 24, 112) || (cptr.ldPtro(u, 2424) && ((cptr.ldU64o((cptr.ldPtro(cptr.ldPtro(u, 2424), 8)), 72) & 2n) != 0n))) ? __sl213 : __sl214)), ((from_what(NHC.SWIMMING))));
...
function attributes_enlightenment(unused_mode, final) {
    ...
    if ((cptr.ldI64o2(u, NHC.FAST, 24, 128) || cptr.ldI64o2(u, NHC.FAST, 24, 112)))
        enlght_line(cptr.decay((You_)), final ? cptr.decay((were)) : cptr.decay((are)), ((((cptr.ldI64o2(u, NHC.FAST, 24, 128) & -117440513n) || cptr.ldI64o2(u, NHC.FAST, 24, 112)) ? __sl463 : __sl464)), ((from_what(NHC.FAST))));
    ...
    if (cptr.ld1so(flags, 10) && debugcore(__sl488, 0)) {
        let f;
        reorder_fruit(1);
