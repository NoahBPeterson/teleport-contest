...
export function scrolltele(scroll) {
    ...
    if (((cptr.ldI32o(u, $you_uhave) & 1) | 0 || On_W_tower_level(cptr.add(u, $you_uz))) && !rn2(3)) {
...
export function level_tele() {
    ...
    __dispatch: while (true) {
        ...
        if (cptr.ld1so(iflags, $instance_flags_debug_fuzzer)) {
            ...
            cptr.stI16o(newlevel, $d_level_dlevel, i16(((1 + rn2(dunlevs_in_dungeon(newlevel))) | 0)));
...
export function mlevel_tele_trap(mtmp, trap, force_it, in_sight) {
    ...
    if (teleport_pet(mtmp, force_it)) {
        ...
        if (((tt) == NHC.HOLE || (tt) == NHC.TRAPDOOR)) {
            ...
            if ((cptr.ldI16((cptr.add(u, $you_uz))) == cptr.ldI16((cptr.add(svd, $instance_globals_saved_d_dungeon_topology + $dgn_topology_d_astral_level)))) && (mon_has_amulet(mtmp) || is_home_elemental(cptr.ldPtro(mtmp, $monst_data)) || rn2(7))) {
...
export function random_teleport_level() {
    ...
    if (!rn2(5) || single_level_branch(cptr.add(u, $you_uz)) || (cptr.ldI16((cptr.add(u, $you_uz))) == cptr.ldI16((cptr.add(svd, $instance_globals_saved_d_dungeon_topology + $dgn_topology_d_astral_level)))))
        return cur_depth;
...
export function u_teleport_mon(mtmp, give_feedback) {
    ...
    if (cptr.ldI64o(svl, $instance_globals_saved_l_level + $dlevel_t_flags + $levelflags_stasis_until) >= cptr.ldI64o(svm, $instance_globals_saved_m_moves)) {
        ...
        if (!rloc(mtmp, NHM.RLOC_MSG))
            m_into_limbo(mtmp);
    } else if ((is_rider(cptr.ldPtro(mtmp, $monst_data)) || ((cptr.ldU64o((cptr.ldPtro(mtmp, $monst_data)), $permonst_mflags1) & 67108864n) != 0n)) && rn2(13) && enexto(cc, cptr.ldI16(u), cptr.ldI16o(u, $you_uy), cptr.ldPtro(mtmp, $monst_data))) {
        rloc_to(mtmp, cptr.ldI16(cc), cptr.ldI16o(cc, $nhcoord_y));
    } else {
        if (!rloc(mtmp, NHM.RLOC_MSG))
            return 0;
