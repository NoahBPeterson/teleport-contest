...
import { DEADMONSTER, In_endgame, Is_stronghold, Is_waterlevel, MON_AT, amorphous, can_teleport, canspotmon, carried, control_teleport, couldsee, distu, dunlev_reached, engulfing_u, haseyes, is_covetous, is_demon, is_hole, is_lord, is_pit, is_prince, is_rider, is_silent, is_swimmer, is_xport, likes_lava, m_next2u, max, min, mon_offmap, passes_walls, throws_rocks, u_at, unique_corpstat, within_bounded_area } from './nhmacrofn.js';
...
function m_blocks_teleporting(mtmp) {
    if ((is_demon(cptr.ldPtro(mtmp, $monst_data)) && is_lord(cptr.ldPtro(mtmp, $monst_data))) || (is_demon(cptr.ldPtro(mtmp, $monst_data)) && is_prince(cptr.ldPtro(mtmp, $monst_data))))
        return 1;
    return 0;
}
...
export function noteleport_level(mon) {
    if (In_hell(cptr.add(u, $you_uz)) && !((is_demon(cptr.ldPtro(mon, $monst_data)) && is_lord(cptr.ldPtro(mon, $monst_data))) || (is_demon(cptr.ldPtro(mon, $monst_data)) && is_prince(cptr.ldPtro(mon, $monst_data)))))
        if (get_iter_mons(m_blocks_teleporting))
            return 1;
    if ((cptr.ldI32o(svl, $instance_globals_saved_l_level + $dlevel_t_flags + $levelflags_noteleport) & 1) | 0 && !is_covetous(cptr.ldPtro(mon, $monst_data)))
        return 1;
...
function goodpos_onscary(x, y, mptr) {
    if (cptr.ld1so(mptr, $permonst_mlet) == NHC.S_HUMAN || cptr.ld1so(mptr, $permonst_mlet) == NHC.S_ANGEL || is_rider(mptr) || unique_corpstat(mptr))
        return 0;
    ...
    if (In_hell(cptr.add(u, $you_uz)) || In_endgame(cptr.add(u, $you_uz)))
        return 0;
    if (cptr.eq(mptr, cptr.add(mons, NHC.PM_MINOTAUR, 96)) || !haseyes(mptr))
        return 0;
...
export function goodpos(x, y, mtmp, gpflags) {
    ...
    if (!isok(x, y))
        return 0;
    if (!allow_u) {
        if (u_at(x, y) && !cptr.eq(mtmp, cptr.add(gy, $instance_globals_y_youmonst)) && (!cptr.eq(mtmp, cptr.ldPtro(u, $you_ustuck)) || !(cptr.ldI32o(u, $you_uswallow) & 1)) && (!cptr.ldPtro(u, $you_usteed) || !cptr.eq(mtmp, cptr.ldPtro(u, $you_usteed))))
            return 0;
    }
    ...
    if (sobj_at(NHC.BOULDER, x, y) && (!mdat || !throws_rocks(mdat)))
        return 0;
...
function tele_jump_ok(x1, y1, x2, y2) {
    ...
    if (cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx) > 0) {
        if (within_bounded_area(x1, y1, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy)) && !within_bounded_area(x2, y2, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy)))
            return 0;
        if (!within_bounded_area(x1, y1, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy)) && within_bounded_area(x2, y2, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy)))
            return 0;
    }
    if (cptr.ldI16o(svu, $dest_area_nlx) > 0) {
        if (within_bounded_area(x1, y1, cptr.ldI16o(svu, $dest_area_nlx), cptr.ldI16o(svu, $dest_area_nly), cptr.ldI16o(svu, $dest_area_nhx), cptr.ldI16o(svu, $dest_area_nhy)) && !within_bounded_area(x2, y2, cptr.ldI16o(svu, $dest_area_nlx), cptr.ldI16o(svu, $dest_area_nly), cptr.ldI16o(svu, $dest_area_nhx), cptr.ldI16o(svu, $dest_area_nhy)))
            return 0;
        if (!within_bounded_area(x1, y1, cptr.ldI16o(svu, $dest_area_nlx), cptr.ldI16o(svu, $dest_area_nly), cptr.ldI16o(svu, $dest_area_nhx), cptr.ldI16o(svu, $dest_area_nhy)) && within_bounded_area(x2, y2, cptr.ldI16o(svu, $dest_area_nlx), cptr.ldI16o(svu, $dest_area_nly), cptr.ldI16o(svu, $dest_area_nhx), cptr.ldI16o(svu, $dest_area_nhy)))
            return 0;
    }
...
export function teleds(nux, nuy, teleds_flags) {
    ...
    if (!ball_active || near_capacity() > NHC.SLT_ENCUMBER || distmin(cptr.ldI16(u), cptr.ldI16o(u, $you_uy), nux, nuy) > 1)
        allow_drag = 0;
    if (ball_active) {
        if (!carried(uball.v) && distmin(nux, nuy, cptr.ldI16o(uball.v, $obj_ox), cptr.ldI16o(uball.v, $obj_oy)) <= 2)
...
export function tele_to_rnd_pet() {
    ...
    for (mtmp = cptr.ldPtro(svl, $instance_globals_saved_l_level + $dlevel_t_monlist); mtmp; mtmp = cptr.ldPtr(mtmp))
        if (!DEADMONSTER(mtmp) && cptr.ld1so(mtmp, $monst_mtame) && !mon_offmap(mtmp)) {
            cnt++;
    ...
    if (((Teleport_control() || (scroll && (cptr.ldI32o(scroll, $obj_blessed) & 1) | 0)) && !HStun()) || wizard()) {
        if (unconscious()) {
            ...
            if (teleok(cptr.ldI16(cc), cptr.ldI16o(cc, $nhcoord_y), 0)) {
                ...
                if (u_at(cptr.ldI16o(iflags, $instance_flags_travelcc), cptr.ldI16o(iflags, $instance_flags_travelcc + $nhcoord_y)))
...
export function dotele(break_the_rules) {
    ...
    if (!trap && !break_the_rules) {
        let castit = 0;
        let energy = 0;
        if (!Teleportation() || (cptr.ldI32o(u, $you_ulevel) < ((cptr.ldI16o(gu, $instance_globals_u_urole + $Role_mnum) == NHC.PM_WIZARD) ? 8 : 12) && !can_teleport(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)))) {
...
export function level_tele() {
    ...
    __dispatch: while (true) {
        ...
        if (((cptr.ldI32o(u, $you_uhave) & 1) | 0 || In_endgame(cptr.add(u, $you_uz)) || (cptr.ldI16((cptr.add(u, $you_uz))) == sokoban_dnum())) && !wizard()) {
            You_feel(__sl49);
            return;
        }
        ...
        if (In_endgame(newlevel) && !In_endgame(cptr.add(u, $you_uz))) {
        ...
        if (yn_function(__sl58, cptr.decay(ynqchars), 113, 1) != 121)
            return;
        You(__sl59, is_silent(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)) ? __sl60 : __sl61);
...
export function domagicportal(ttmp) {
    ...
    if (!on_level(cptr.add(u, $you_uz), cptr.add(u, $you_uz0)))
        return;
    You(__sl84);
    if (In_endgame(cptr.add(u, $you_uz)) && !(cptr.ldI32o(u, $you_uhave) & 1)) {
        You_feel(__sl85);
        return;
    }
...
export function tele_trap(trap) {
    ...
    if (In_endgame(cptr.add(u, $you_uz)) || Antimagic() || noteleport_level(cptr.add(gy, $instance_globals_y_youmonst))) {
        if (Antimagic())
...
export function level_tele_trap(trap, trflags) {
    ...
    if ((Antimagic() && !intentional) || In_endgame(cptr.add(u, $you_uz))) {
        You_feel(__sl89);
        return;
    }
    deltrap(trap);
...
function rloc_pos_ok(x, y, mtmp) {
    ...
    if (!xx) {
        if (cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx) && On_W_tower_level(cptr.add(u, $you_uz)))
            return schar((((yy & 2) != 0) ^ !within_bounded_area(x, y, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy))));
        if (cptr.ldI16(svu) && (yy & 1) != 0)
            return schar((within_bounded_area(x, y, cptr.ldI16(svu), cptr.ldI16o(svu, $dest_area_ly), cptr.ldI16o(svu, $dest_area_hx), cptr.ldI16o(svu, $dest_area_hy)) && (!cptr.ldI16o(svu, $dest_area_nlx) || !within_bounded_area(x, y, cptr.ldI16o(svu, $dest_area_nlx), cptr.ldI16o(svu, $dest_area_nly), cptr.ldI16o(svu, $dest_area_nhx), cptr.ldI16o(svu, $dest_area_nhy))) ? 1 : 0));
        if (cptr.ldI16o(svd, $instance_globals_saved_d_dndest) && (yy & 1) == 0)
            return schar((within_bounded_area(x, y, cptr.ldI16o(svd, $instance_globals_saved_d_dndest), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_ly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_hx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_hy)) && (!cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx) || !within_bounded_area(x, y, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy))) ? 1 : 0));
    } else {
...
function rloc_to_core(mtmp, x, y, rlocflags) {
    ...
    if (domsg && (canspotmon(mtmp) || appearmsg || cptr.eq(mtmp, cptr.ldPtro(u, $you_ustuck)))) {
        ...
        if (cptr.eq(mtmp, cptr.ldPtro(u, $you_ustuck)) && !u_at(cptr.ldI16o(u, $you_ux0), cptr.ldI16o(u, $you_uy0))) {
            You(__sl102, mon_nam(mtmp));
        } else if (telemsg && (couldsee(x, y) || sensemon(mtmp))) {
            pline(__sl103, Monnam(mtmp), next ? next : (nearu ? nearu : (((olddu = distu(oldx, oldy)) == du) ? __sl68 : ((du < olddu) ? __sl104 : __sl105))));
        } else {
...
export function control_mon_tele(mon, cc_p, rlocflags, via_rloc) {
    ...
    if (getpos(cc_p, 0, cptr.decay(tcbuf)) >= 0 && !u_at(cptr.ldI16(cc_p), cptr.ldI16o(cc_p, $coord_y))) {
...
export function mtele_trap(mtmp, trap, in_sight) {
    ...
    if (teleport_pet(mtmp, 0)) {
        ...
        if ((cptr.ldI32o(trap, $trap_once) & 1))
            ...
            if (!((cptr.ldPtro3(svl, cptr.ldI16o(trap, $trap_launch), 168, cptr.ldI16o(trap, $trap_launch + $nhcoord_y), 8, $instance_globals_saved_l_level + $dlevel_t_monsters)) || u_at(cptr.ldI16o(trap, $trap_launch), cptr.ldI16o(trap, $trap_launch + $nhcoord_y)))) {
...
export function mlevel_tele_trap(mtmp, trap, force_it, in_sight) {
    ...
    if (teleport_pet(mtmp, force_it)) {
        ...
        if (((tt) == NHC.HOLE || (tt) == NHC.TRAPDOOR)) {
            ...
            if (In_endgame(cptr.add(u, $you_uz)) && (mon_has_amulet(mtmp) || is_home_elemental(cptr.ldPtro(mtmp, $monst_data)) || (rng_log_enabled() ? (rng_log_set_caller(__sl1, 2036, __sl124), rn2(7)) : rn2(7)))) {
            ...
            let nlev;
            if (mon_has_amulet(mtmp) || In_endgame(cptr.add(u, $you_uz)) || (tt == NHC.NO_TRAP && onscary(0, 0, mtmp))) {
                if (in_sight)
        ...
        if (is_xport(tt) && !control_teleport(cptr.ldPtro(mtmp, $monst_data)))
...
export function rloco(obj) {
    ...
    do {
        ...
        if (!--try_limit)
            break;
    } while (!goodpos(tx, ty, null, 0) || (restricted_fall && (!within_bounded_area(tx, ty, cptr.ldI16o(svd, $instance_globals_saved_d_dndest), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_ly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_hx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_hy)) || (cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx) && within_bounded_area(tx, ty, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy))))) || (cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx) && On_W_tower_level(cptr.add(u, $you_uz)) && within_bounded_area(tx, ty, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy)) != within_bounded_area(otx, oty, cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nlx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nly), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhx), cptr.ldI16o(svd, $instance_globals_saved_d_dndest + $dest_area_nhy))));
...
export function random_teleport_level() {
    ...
    if (!(rng_log_enabled() ? (rng_log_set_caller(__sl1, 2196, __sl135), rn2(5)) : rn2(5)) || single_level_branch(cptr.add(u, $you_uz)) || In_endgame(cptr.add(u, $you_uz)))
        return cur_depth;
    if (In_quest(cptr.add(u, $you_uz))) {
        ...
        if (dunlev_reached(cptr.add(u, $you_uz)) < qlocate_depth)
...
export function u_teleport_mon(mtmp, give_feedback) {
    ...
    if (cptr.ldI64o(svl, $instance_globals_saved_l_level + $dlevel_t_flags + $levelflags_stasis_until) >= cptr.ldI64o(svm, $instance_globals_saved_m_moves)) {
        ...
        if (!rloc(mtmp, NHM.RLOC_MSG))
            m_into_limbo(mtmp);
    } else if ((is_rider(cptr.ldPtro(mtmp, $monst_data)) || control_teleport(cptr.ldPtro(mtmp, $monst_data))) && (rng_log_enabled() ? (rng_log_set_caller(__sl1, 2285, __sl139), rn2(13)) : rn2(13)) && enexto(cc, cptr.ldI16(u), cptr.ldI16o(u, $you_uy), cptr.ldPtro(mtmp, $monst_data))) {
        rloc_to(mtmp, cptr.ldI16(cc), cptr.ldI16o(cc, $nhcoord_y));
    } else {
        if (!rloc(mtmp, NHM.RLOC_MSG))
            return 0;
