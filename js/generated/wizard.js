...
export function tactics(mtmp) {
    ...
    switch (strat) {
        ...
        if (In_W_tower(mx, my, cptr.add(u, $you_uz)) || ((cptr.ldI32o(mtmp, $monst_iswiz) & 1) | 0 && !sx.v && !mon_has_amulet(mtmp))) {
            if (!noteleport_level(mtmp) && !rn2((3 + ((cptr.ldI32o(mtmp, $monst_mhp) / 10) | 0)) | 0))
...
export function cuss(mtmp) {
    ...
    if ((cptr.ldI32o(mtmp, $monst_iswiz) & 1)) {
        if (!rn2(5)) {
            ...
            ;
            verbalize(rn2(2) ? __s_even_now_thy_life_force_ebbs_s : __s_savor_thy_breath_s_it_be_thy_last, cptr.ldPtro(random_insult, rn2(28), 8));
        } else if (cptr.ldI32o(mtmp, $monst_mhp) < 5 && !rn2(2)) {
            ;
            verbalize(rn2(2) ? __s_i_shall_return : __s_i_ll_be_back);
        } else {
            ;
            verbalize(__s_s_s, cptr.ldPtro(random_malediction, rn2(11), 8), cptr.ldPtro(random_insult, rn2(28), 8));
        }
