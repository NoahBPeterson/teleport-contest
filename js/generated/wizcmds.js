...
function makemap_unmakemon(mtmp, migratory) {
    let ndx = (cptr.ldI32o((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_pmidx));
    if (cptr.ldU16o(cptr.ldPtro(mtmp, FLD.monst_data), FLD.permonst_geno) & NHM.G_UNIQ)
        cptr.st1o2(svm, ndx, 12, FLD.instance_globals_saved_m_mvitals + FLD.mvitals_mvflags, cptr.ld1uo2(svm, ndx, 12, FLD.instance_globals_saved_m_mvitals + FLD.mvitals_mvflags) & -2);
    if (cptr.ld1uo2(svm, ndx, 12, FLD.instance_globals_saved_m_mvitals))
        (cptr.st1o2(svm, ndx, 12, FLD.instance_globals_saved_m_mvitals, cptr.ld1uo2(svm, ndx, 12, FLD.instance_globals_saved_m_mvitals) + -1)) - (-1);
    if ((cptr.ldI32o(mtmp, FLD.monst_isgd) & 1)) {
        cptr.stI32o(mtmp, FLD.monst_isgd, 0);
    } else if ((cptr.ldI32o((mtmp), FLD.monst_mhp) < 1)) {
        return;
    ...
    if (migratory) {
        cptr.stI64o(mtmp, FLD.monst_mstate, cptr.ldI64o(mtmp, FLD.monst_mstate) | 1n);
        cptr.stI64o(mtmp, FLD.monst_mstate, cptr.ldI64o(mtmp, FLD.monst_mstate) & (-77n));
...
export function makemap_remove_mons() {
    ...
    for (mprev = cptr.add(gm, FLD.instance_globals_m_migrating_mons); (mtmp = cptr.ldPtr(mprev)) !== null; ) {
        if (cptr.ldPtro(mtmp, FLD.monst_mextra) && (((cptr.ldI32o(mtmp, FLD.monst_isshk) & 1) | 0 && on_level(cptr.add(u, FLD.you_uz), cptr.add((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_eshk)), FLD.eshk_shoplevel))) || ((cptr.ldI32o(mtmp, FLD.monst_ispriest) & 1) | 0 && on_level(cptr.add(u, FLD.you_uz), cptr.add((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_epri)), FLD.epri_shrlevel))) || ((cptr.ldI32o(mtmp, FLD.monst_isgd) & 1) | 0 && on_level(cptr.add(u, FLD.you_uz), cptr.add((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_egd)), FLD.egd_gdlevel))))) {
...
export function wiz_map() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        cptr.stI64o2(u, NHC.CONFUSION, 24, FLD.you_uprops + FLD.prop_intrinsic, cptr.stI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic, 0n));
        ...
        cptr.stI64o2(u, NHC.CONFUSION, 24, FLD.you_uprops + FLD.prop_intrinsic, save_Hconf);
        cptr.stI64o2(u, NHC.HALLUC, 24, FLD.you_uprops + FLD.prop_intrinsic, save_Hhallu);
    } else
...
export function wiz_genesis() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        cptr.st1o(iflags, FLD.instance_flags_debug_mongen, mongen_saved);
    } else
...
export function wiz_kill() {
    ...
    let prompt = __sl2;
    let save_verbose = cptr.ld1so(flags, FLD.flag_verbose);
    let save_autodescribe = cptr.ld1so(iflags, FLD.instance_flags_autodescribe);
    let uarehere = cptr.alloc(4); cptr.memcpy(uarehere, cptr.add(u, FLD.you_uz), 4);
    ...
    for (; ; ) {
        ...
        if (((cptr.ldI16(cc)) == cptr.ldI16(u) && (cptr.ldI16o(cc, FLD.nhcoord_y)) == cptr.ldI16o(u, FLD.you_uy))) {
            if (cptr.ldPtro(u, FLD.you_usteed)) {
                void cptr.sprintf(cptr.decay(qbuf), __sl6, mon_nam(cptr.ldPtro(u, FLD.you_usteed)));
            ...
            if (!mtmp) {
                void cptr.sprintf(cptr.decay(qbuf), __sl7, (cptr.ldI16o(gu, FLD.instance_globals_u_urole + FLD.Role_mnum) == NHC.PM_SAMURAI) ? __sl8 : __sl9);
                if (paranoid_query(1, cptr.decay(qbuf))) {
                    void cptr.sprintf(cptr.add(svk, FLD.kinfo_name), __sl10, (cptr.ldPtro2(genders, cptr.ld1so(flags, FLD.flag_female) ? 1 : 0, 48, FLD.Gender_his)));
            ...
            mtmp = (dist2(((cptr.ldI16(cc))), ((cptr.ldI16o(cc, FLD.nhcoord_y))), cptr.ldI16(u), cptr.ldI16o(u, FLD.you_uy)) <= 2) ? cptr.ldPtro(u, FLD.you_ustuck) : null;
        } else {
        ...
        if (mtmp) {
            let tame = !!cptr.ld1so(mtmp, FLD.monst_mtame);
            let seen = ((canseemon(mtmp) || sensemon(mtmp)) || ((cptr.ldI32o(u, FLD.you_uswallow) & 1) | 0 && cptr.eq(mtmp, cptr.ldPtro(u, FLD.you_ustuck))) ? 1 : 0);
            let flgs = (5 | ((tame && (cptr.ldPtro((mtmp), FLD.monst_mextra) && (cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra))))) ? NHM.SUPPRESS_SADDLE : 0));
            ...
            if (!cptr.ld1so(iflags, FLD.instance_flags_menu_requested)) {
                You(__sl14, (((cptr.ldU64o((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mflags2) & 2n) != 0n) || cptr.eq((cptr.ldPtro(mtmp, FLD.monst_data)), cptr.add(mons, NHC.PM_MANES, 96)) || ((cptr.ld1so((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mlet) == NHC.S_GOLEM) || cptr.ld1so((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mlet) == NHC.S_VORTEX)) ? __sl15 : __sl16, Mn);
                xkilled(mtmp, NHM.XKILL_NOMSG);
            } else {
                cptr.st1o(svc, FLD.context_info_mon_moving, 1);
                pline(__sl17, upstart(Mn), (((cptr.ldU64o((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mflags2) & 2n) != 0n) || cptr.eq((cptr.ldPtro(mtmp, FLD.monst_data)), cptr.add(mons, NHC.PM_MANES, 96)) || ((cptr.ld1so((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mlet) == NHC.S_GOLEM) || cptr.ld1so((cptr.ldPtro(mtmp, FLD.monst_data)), FLD.permonst_mlet) == NHC.S_VORTEX)) ? __sl18 : __sl19);
                monkilled(mtmp, null, NHM.AD_PHYS);
                cptr.st1o(svc, FLD.context_info_mon_moving, 0);
            }
            if (cptr.ld1uo(u, FLD.you_utotype) || !on_level(cptr.add(u, FLD.you_uz), uarehere))
                break;
        } else {
            There(__sl20);
            break;
...
export function wiz_flip_level() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        if (c && cptr.strchr(cptr.decay(__static_wiz_flip_level_choices), c)) {
            ...
            pline(__sl24, cptr.ldPtro(c_common_strings, FLD.c_common_strings_c_Never_mind));
        }
    }
    return NHM.ECMD_OK;
}
...
export function wiz_level_change() {
    ...
    if (newlevel.v == cptr.ldI32o(u, FLD.you_ulevel)) {
        You(__sl27);
    } else if (newlevel.v < cptr.ldI32o(u, FLD.you_ulevel)) {
        ...
        if (newlevel.v < 1)
            newlevel.v = 1;
        while (cptr.ldI32o(u, FLD.you_ulevel) > newlevel.v)
            losexp(__sl29);
    } else {
...
export function wiz_telekinesis() {
    ...
    do {
        ...
        if (ans < 0 || cptr.ldI16(cc) < 1)
            return NHM.ECMD_CANCEL;
        if ((((mtmp = (cptr.ldPtro3(svl, cptr.ldI16(cc), 168, cptr.ldI16o(cc, FLD.nhcoord_y), 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters))) !== null) && (canseemon(mtmp) || sensemon(mtmp))) || ((cptr.ldI16(cc)) == cptr.ldI16(u) && (cptr.ldI16o(cc, FLD.nhcoord_y)) == cptr.ldI16o(u, FLD.you_uy))) {
            if (!getdir(__sl32))
                return NHM.ECMD_CANCEL;
            if (mtmp) {
                mhurtle(mtmp, cptr.ldI32o(u, FLD.you_dx), cptr.ldI32o(u, FLD.you_dy), 6);
                if (!(cptr.ldI32o((mtmp), FLD.monst_mhp) < 1) && (canseemon(mtmp) || sensemon(mtmp))) {
                    cptr.stI16(cc, cptr.ldI16o(mtmp, FLD.monst_mx));
                    cptr.stI16o(cc, FLD.nhcoord_y, cptr.ldI16o(mtmp, FLD.monst_my));
                }
            } else {
                hurtle(cptr.ldI32o(u, FLD.you_dx), cptr.ldI32o(u, FLD.you_dy), 6, 0);
                cptr.stI16(cc, cptr.ldI16(u)), cptr.stI16o(cc, FLD.nhcoord_y, cptr.ldI16o(u, FLD.you_uy));
            }
        }
    } while (cptr.ld1uo(u, FLD.you_utotype) == NHC.UTOTYPE_NONE);
    return NHM.ECMD_OK;
}
...
export function wiz_panic() {
    if (cptr.ld1so(iflags, FLD.instance_flags_debug_fuzzer)) {
        cptr.stI32o(u, FLD.you_uhp, cptr.stI32o(u, FLD.you_uhpmax, 1000));
        cptr.stI32o(u, FLD.you_uen, cptr.stI32o(u, FLD.you_uenmax, 1000));
        return NHM.ECMD_OK;
    }
...
export function wiz_fuzzer() {
    ...
    if (paranoid_query(1, __sl37)) {
        if (yn_function(__sl38, cptr.decay(ynchars), 110, 1) == 110) {
            ...
            cptr.st1o(iflags, FLD.instance_flags_debug_fuzzer, NHC.fuzzer_impossible_panic);
        }
    }
    return NHM.ECMD_OK;
}
    ...
    for (y = 0; y < NHM.ROWNO; y++) {
        for (x = startx, curx = 0; x < stopx; x++, curx = i16(curx + 2)) {
            if (((x) == cptr.ldI16(u) && (y) == cptr.ldI16o(u, FLD.you_uy))) {
                ...
                v = cptr.ld1uo3(svl, x, 756, y, 36, FLD.instance_globals_saved_l_level + FLD.rm_seenv) & 255;
                if (v == 0)
        ...
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(row));
    }
...
export function wiz_show_vision() {
    ...
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(row));
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl41);
    for (y = 0; y < NHM.ROWNO; y++) {
        for (x = 1; x < NHM.COLNO; x++) {
            if (((x) == cptr.ldI16(u) && (y) == cptr.ldI16o(u, FLD.you_uy))) {
                cptr.st1o(cptr.decay(row), x, 64, 1);
            } else {
                v = cptr.ld1uo(cptr.ldPtro(cptr.ldPtro(gv, FLD.instance_globals_v_viz_array), y, 8), x);
        ...
        for (x = 79; x >= 1; x--)
            if (cptr.ld1so(cptr.decay(row), x, 1) != 32)
                break;
        cptr.st1o(cptr.decay(row), (x + 1) | 0, 0, 1);
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.add(cptr.decay(row), 1, 1));
    }
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(win, 1);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(win);
    return NHM.ECMD_OK;
    ...
    for (y = 0; y < NHM.ROWNO; y++) {
        for (x = 0; x < NHM.COLNO; x++) {
            ...
            if (((x) == cptr.ldI16(u) && (y) == cptr.ldI16o(u, FLD.you_uy)))
                ...
                cptr.st1o(cptr.decay(row), x, schar(((48 + (((cptr.ldI32o(lev, FLD.rm_flags) & 31) | 0) & NHM.WM_MASK)) | 0)), 1);
            else if (cptr.ld1so(lev, FLD.rm_typ) == NHC.CORR)
                cptr.st1o(cptr.decay(row), x, 35, 1);
            else if (((cptr.ld1so(lev, FLD.rm_typ)) >= NHC.ROOM) || ((cptr.ld1so(lev, FLD.rm_typ)) == NHC.DOOR))
...
export function wiz_map_levltyp() {
    ...
    }
    {
        ...
        let slev = Is_special(cptr.add(u, FLD.you_uz));
        void cptr.sprintf(cptr.decay(dsc), __sl43, cptr.ldI16o(u, FLD.you_uz), cptr.ldI16o(u, FLD.you_uz + FLD.d_level_dlevel));
        if (slev) {
            void cptr.sprintf(eos(cptr.decay(dsc)), __sl44, cptr.add(slev, FLD.s_level_proto));
            if ((cptr.ldI32o(slev, FLD.s_level_flags + FLD.d_flags_maze_like) & 1))
                void cptr.strcat(cptr.decay(dsc), __sl45);
            if ((cptr.ldI32o(slev, FLD.s_level_flags + FLD.d_flags_hellish) & 1))
                void cptr.strcat(cptr.decay(dsc), __sl46);
            if ((cptr.ldI32o(slev, FLD.s_level_flags) & 1))
                void cptr.strcat(cptr.decay(dsc), __sl47);
            if ((cptr.ldI32o(slev, FLD.s_level_flags + FLD.d_flags_rogue_like) & 1))
                void cptr.strcat(cptr.decay(dsc), __sl48);
        }
        if (cptr.ld1uo(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags))
            void cptr.sprintf(eos(cptr.decay(dsc)), __sl49, cptr.ld1uo(defsyms, NHC.S_fountain, 24), cptr.ld1uo(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags));
        if (cptr.ld1uo(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_nsinks))
            void cptr.sprintf(eos(cptr.decay(dsc)), __sl49, cptr.ld1uo(defsyms, NHC.S_sink, 24), cptr.ld1uo(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_nsinks));
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_vault) & 1))
        ...
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_temple) & 1))
            void cptr.strcat(cptr.decay(dsc), __sl52);
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_court) & 1))
            void cptr.strcat(cptr.decay(dsc), __sl53);
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_zoo) & 1))
        ...
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_barracks) & 1))
            void cptr.strcat(cptr.decay(dsc), __sl56);
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_beehive) & 1))
            void cptr.strcat(cptr.decay(dsc), __sl57);
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_has_swamp) & 1))
        ...
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_hardfloor) & 1))
        ...
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_shortsighted) & 1))
            void cptr.strcat(cptr.decay(dsc), __sl63);
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_graveyard) & 1))
        ...
        if ((cptr.ldI32o(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_flags + FLD.levelflags_is_cavernous_lev) & 1))
        ...
        if (cptr.ldI16o(u, FLD.you_uz) == 0)
            ...
            let brname = cptr.add(svd, cptr.ldI16o(u, FLD.you_uz), 112);
        ...
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(dsc));
    }
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(win, 1);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(win);
    return;
...
export function wiz_levltyp_legend() {
    ...
    let buf = new Uint8Array(256);
    win = (cptr.ldPtro(windowprocs, FLD.window_procs_win_create_nhwindow))(NHM.NHW_TEXT);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl82);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl41);
    fmt = __sl83;
...
export function wiz_smell() {
    ...
    do {
        ...
        if (((cptr.ldI16(cc)) == cptr.ldI16(u) && (cptr.ldI16o(cc, FLD.nhcoord_y)) == cptr.ldI16o(u, FLD.you_uy))) {
            if (cptr.ldPtro(u, FLD.you_usteed)) {
                mptr = cptr.ldPtro(cptr.ldPtro(u, FLD.you_usteed), FLD.monst_data);
            } else {
                mptr = cptr.ldPtro(gy, FLD.instance_globals_y_youmonst + FLD.monst_data);
                is_you = 1;
            }
        } else if ((mtmp = (cptr.ldPtro3(svl, cptr.ldI16(cc), 168, cptr.ldI16o(cc, FLD.nhcoord_y), 8, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monsters))) !== null) {
        ...
        if (mptr) {
            ...
            if (((glyph) == NHC.GLYPH_INVIS_OFF))
                unmap_invisible(cptr.ldI16(cc), cptr.ldI16o(cc, FLD.nhcoord_y));
        }
    } while (1);
    return NHM.ECMD_OK;
}
...
export function wiz_intrinsic() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        for (i = 0; (propname = property_by_index(i, p)) !== null; ++i) {
            ...
            oldtimeout = cptr.ldI64o2(u, p.v, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n;
            if (oldtimeout)
        ...
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_end_menu))(win, __sl96);
        ...
        for (j = 0; j < n; ++j) {
            ...
            oldtimeout = cptr.ldI64o2(u, p.v, 24, FLD.you_uprops + FLD.prop_intrinsic) & 16777215n;
            amt = (cptr.ldI64o2(pick_list.v, j, 24, FLD.mi_count) == -1n) ? 30 : Number(BigInt.asIntN(32, cptr.ldI64o2(pick_list.v, j, 24, FLD.mi_count)));
            if (amt <= 0)
                continue;
            ...
            switch (p.v) {
                ...
                {
                    if (p.v != NHC.GLIB)
                        incr_itimeout(cptr.add(cptr.add(cptr.add(u, FLD.you_uprops), p.v, 24), FLD.prop_intrinsic), amt);
                    cptr.st1(disp, 1);
...
function size_obj(otmp) {
    ...
    if (cptr.ldPtro(otmp, FLD.obj_oextra)) {
        sz = (sz + 32) | 0;
        if ((cptr.ldPtr(cptr.ldPtro((otmp), FLD.obj_oextra))))
            sz = (sz + ((Number(BigInt.asIntN(32, cptr.strlen((cptr.ldPtr(cptr.ldPtro((otmp), FLD.obj_oextra)))))) + 1) | 0)) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((otmp), FLD.obj_oextra), FLD.oextra_omonst)))
            sz = (sz + size_monst((cptr.ldPtro(cptr.ldPtro((otmp), FLD.obj_oextra), FLD.oextra_omonst)), 0)) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((otmp), FLD.obj_oextra), FLD.oextra_omailcmd)))
            sz = (sz + ((Number(BigInt.asIntN(32, cptr.strlen((cptr.ldPtro(cptr.ldPtro((otmp), FLD.obj_oextra), FLD.oextra_omailcmd))))) + 1) | 0)) | 0;
    }
    return sz;
}
...
function count_obj(chain, total_count, total_size, top, recurse) {
    ...
    for (count = (size = 0n), obj = chain; obj; obj = cptr.ldPtr(obj)) {
        ...
        if (recurse && cptr.ldPtro(obj, FLD.obj_cobj))
            count_obj(cptr.ldPtro(obj, FLD.obj_cobj), total_count, total_size, 1, 1);
    }
...
function mon_invent_chain(win, src, chain, total_count, total_size) {
    ...
    for (mon = chain; mon; mon = cptr.ldPtr(mon))
        count_obj(cptr.ldPtro(mon, FLD.monst_minvent), count, size, 1, 0);
    if (count.v || size.v) {
        cptr.stI64(total_count, cptr.ldI64(total_count) + count.v);
        cptr.stI64(total_size, cptr.ldI64(total_size) + size.v);
        void cptr.sprintf(cptr.decay(buf), cptr.decay(template), src, count.v, size.v);
...
function contained_stats(win, src, total_count, total_size) {
    ...
    let size = cptr.box(0n);
    let mon;
    count_obj(cptr.ldPtro(gi, FLD.instance_globals_i_invent), count, size, 0, 1);
    count_obj(cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_objlist), count, size, 0, 1);
    count_obj(cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_buriedobjlist), count, size, 0, 1);
    count_obj(cptr.ldPtro(gm, FLD.instance_globals_m_migrating_objs), count, size, 0, 1);
    for (mon = cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monlist); mon; mon = cptr.ldPtr(mon))
        count_obj(cptr.ldPtro(mon, FLD.monst_minvent), count, size, 0, 1);
    for (mon = cptr.ldPtro(gm, FLD.instance_globals_m_migrating_mons); mon; mon = cptr.ldPtr(mon))
        count_obj(cptr.ldPtro(mon, FLD.monst_minvent), count, size, 0, 1);
    if (count.v || size.v) {
        cptr.stI64(total_count, cptr.ldI64(total_count) + count.v);
        cptr.stI64(total_size, cptr.ldI64(total_size) + size.v);
...
function size_monst(mtmp, incl_wsegs) {
    let sz = 320;
    if ((cptr.ldI32o(mtmp, FLD.monst_wormno) & 31) | 0 && incl_wsegs)
        sz = (sz + size_wseg(mtmp)) | 0;
    if (cptr.ldPtro(mtmp, FLD.monst_mextra)) {
        sz = (sz + 64) | 0;
        if ((cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra))))
            sz = (sz + ((Number(BigInt.asIntN(32, cptr.strlen((cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra)))))) + 1) | 0)) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_egd)))
            sz = (sz + 652) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_epri)))
            sz = (sz + 56) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_eshk)))
            sz = (sz + 4960) | 0;
        if ((cptr.ldPtro(cptr.ldPtro((mtmp), FLD.monst_mextra), FLD.mextra_emin)))
            sz = (sz + 8) | 0;
...
function misc_stats(win, total_count, total_size) {
    ...
    for (idx = 0; idx < NHC.NUM_OBJECTS; ++idx)
        if (cptr.ldPtro2(objects, idx, 120, FLD.objclass_oc_uname)) {
            ++count.v;
            size.v += BigInt.asIntN(64, (BigInt.asUintN(64, cptr.strlen(cptr.ldPtro2(objects, idx, 120, FLD.objclass_oc_uname)) + 1n)));
        }
    if (count.v || size.v) {
        cptr.stI64(total_count, cptr.ldI64(total_count) + count.v);
        cptr.stI64(total_size, cptr.ldI64(total_size) + size.v);
...
function you_sanity_check() {
    ...
    if (cptr.ldI32o(u, FLD.you_uhp) > cptr.ldI32o(u, FLD.you_uhpmax)) {
        impossible(__sl119, cptr.ldI32o(u, FLD.you_uhp), cptr.ldI32o(u, FLD.you_uhpmax));
    ...
    if ((cptr.ldI32o(u, FLD.you_umonnum) != cptr.ldI32o(u, FLD.you_umonster)) && cptr.ldI32o(u, FLD.you_mh) > cptr.ldI32o(u, FLD.you_mhmax)) {
        impossible(__sl120, cptr.ldI32o(u, FLD.you_mh), cptr.ldI32o(u, FLD.you_mhmax));
        cptr.stI32o(u, FLD.you_mh, cptr.ldI32o(u, FLD.you_mhmax));
    }
    if (cptr.ldI32o(u, FLD.you_uen) > cptr.ldI32o(u, FLD.you_uenmax)) {
        impossible(__sl121, cptr.ldI32o(u, FLD.you_uen), cptr.ldI32o(u, FLD.you_uenmax));
...
function levl_sanity_check() {
    ...
    for (y = 0; y < NHM.ROWNO; y++) {
        for (x = 1; x < NHM.COLNO; x++) {
            if ((does_block(x, y, cptr.add(cptr.add(cptr.add(svl, FLD.instance_globals_saved_l_level), x, 756), y, 36)) ? 1 : 0) != get_viz_clear(x, y))
...
export function sanity_check() {
    if (cptr.ld1so(iflags, FLD.instance_flags_sanity_no_check)) {
        cptr.st1o(iflags, FLD.instance_flags_sanity_no_check, 0);
        return;
    }
    (cptr.stI32o(program_state, FLD.sinfo_in_sanity_check, cptr.ldI32o(program_state, FLD.sinfo_in_sanity_check) + 1)) - (1);
    you_sanity_check();
    obj_sanity_check();
    timer_sanity_check();
    mon_sanity_check();
...
function migrsort_cmp(vptr1, vptr2) {
    ...
    let d1 = cptr.ldI16o(m1, FLD.monst_mux);
    let l1 = cptr.ldI16o(m1, FLD.monst_muy);
    let d2 = cptr.ldI16o(m2, FLD.monst_mux);
    let l2 = cptr.ldI16o(m2, FLD.monst_muy);
    if (d1 != d2)
        return (d1 - d2) | 0;
    if (l1 != l2)
        return (l1 - l2) | 0;
    return (cptr.ldI32o(m1, FLD.monst_m_id) < cptr.ldI32o(m2, FLD.monst_m_id)) ? -1 : (cptr.ldI32o(m1, FLD.monst_m_id) > cptr.ldI32o(m2, FLD.monst_m_id));
}
...
function list_migrating_mons(nextlevl) {
    ...
    for (mtmp = cptr.ldPtro(gm, FLD.instance_globals_m_migrating_mons); mtmp; mtmp = cptr.ldPtr(mtmp)) {
        if (cptr.ldI16o(mtmp, FLD.monst_mux) == cptr.ldI16o(u, FLD.you_uz) && cptr.ldI16o(mtmp, FLD.monst_muy) == cptr.ldI16o(u, FLD.you_uz + FLD.d_level_dlevel))
            ++here;
        else if (cptr.ldI16o(mtmp, FLD.monst_mux) == cptr.ldI16(nextlevl) && cptr.ldI16o(mtmp, FLD.monst_muy) == cptr.ldI16o(nextlevl, FLD.d_level_dlevel))
            ++nxtlv;
        else
            ++other;
    }
    if (((((here + nxtlv) | 0) + other) | 0) == 0) {
        ...
        if (n > 0) {
            ...
            for (mtmp = cptr.ldPtro(gm, FLD.instance_globals_m_migrating_mons); mtmp; mtmp = cptr.ldPtr(mtmp)) {
                if (c == 97)
                    showit = 1;
                else if (cptr.ldI16o(mtmp, FLD.monst_mux) == cptr.ldI16o(u, FLD.you_uz) && cptr.ldI16o(mtmp, FLD.monst_muy) == cptr.ldI16o(u, FLD.you_uz + FLD.d_level_dlevel))
                    showit = schar((c == 99));
                else if (cptr.ldI16o(mtmp, FLD.monst_mux) == cptr.ldI16(nextlevl) && cptr.ldI16o(mtmp, FLD.monst_muy) == cptr.ldI16o(nextlevl, FLD.d_level_dlevel))
                    showit = schar((c == 110));
                else
            ...
            for (n = 0; (mtmp = cptr.ldPtro(marray, n, 8)) !== null; ++n) {
                ...
                if ((cptr.ldPtro((mtmp), FLD.monst_mextra) && (cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra)))))
                    void cptr.sprintf(eos(cptr.decay(buf)), __sl136, (cptr.ldPtr(cptr.ldPtro((mtmp), FLD.monst_mextra))));
                if (c == 111 || c == 97)
                    void cptr.sprintf(eos(cptr.decay(buf)), __sl137, cptr.ldI16o(mtmp, FLD.monst_mux), cptr.ldI16o(mtmp, FLD.monst_muy));
                xyloc = cptr.ldI16o2(mtmp, 0, 4, FLD.monst_mtrack);
                if (xyloc == NHM.MIGR_EXACT_XY) {
                    x = cptr.ldI16o2(mtmp, 1, 4, FLD.monst_mtrack);
...
export function wiz_show_stats() {
    ...
    win = (cptr.ldPtro(windowprocs, FLD.window_procs_win_create_nhwindow))(NHM.NHW_TEXT);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl140);
    total_obj_count.v = (total_obj_size.v = 0n);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(stats_hdr));
    void cptr.sprintf(cptr.decay(buf), __sl141, 216n);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(buf));
    obj_chain(win, __sl122, cptr.ldPtro(gi, FLD.instance_globals_i_invent), 1, total_obj_count, total_obj_size);
    obj_chain(win, __sl142, cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_objlist), 1, total_obj_count, total_obj_size);
    obj_chain(win, __sl143, cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_buriedobjlist), 0, total_obj_count, total_obj_size);
    obj_chain(win, __sl144, cptr.ldPtro(gm, FLD.instance_globals_m_migrating_objs), 0, total_obj_count, total_obj_size);
    obj_chain(win, __sl145, cptr.ldPtro(gb, FLD.instance_globals_b_billobjs), 0, total_obj_count, total_obj_size);
    mon_invent_chain(win, __sl146, cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monlist), total_obj_count, total_obj_size);
    mon_invent_chain(win, __sl147, cptr.ldPtro(gm, FLD.instance_globals_m_migrating_mons), total_obj_count, total_obj_size);
    contained_stats(win, __sl148, total_obj_count, total_obj_size);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(stats_sep));
    ...
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(buf));
    mon_chain(win, __sl106, cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monlist), 1, total_mon_count, total_mon_size);
    mon_chain(win, __sl151, cptr.ldPtro(gm, FLD.instance_globals_m_migrating_mons), 0, total_mon_count, total_mon_size);
    if (cptr.ldPtro(gm, FLD.instance_globals_m_mydogs))
        mon_chain(win, __sl152, cptr.ldPtro(gm, FLD.instance_globals_m_mydogs), 0, total_mon_count, total_mon_size);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(stats_sep));
    ...
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl41);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl154);
    ...
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl41);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl156);
...
export function wiz_display_macros() {
    ...
    for (glyph = 0; glyph < NHC.MAX_GLYPH; ++glyph) {
        if (((glyph) >= NHC.GLYPH_CMAP_STONE_OFF && (glyph) < ((NHC.GLYPH_CMAP_C_OFF + ((((NHC.S_goodpos - NHC.S_digbeam) | 0) + 1) | 0)) | 0))) {
            ...
            if (test == no_glyph) {
                if (!trouble++)
                    (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(__static_wiz_display_macros_display_issues));
    ...
    if (!trouble)
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl164);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(win, 0);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(win);
    return NHM.ECMD_OK;
}
...
export function wiz_show_nhuuid() {
    pline(__sl165, cptr.add(svn, FLD.instance_globals_saved_n_nhuuid));
    return NHM.ECMD_OK;
}
...
export function wiz_mon_diff() {
    ...
    for (ptr = cptr.add(mons, 0, 96); cptr.ld1so(ptr, FLD.permonst_mlet); ptr = cptr.add(ptr, 1, 96), cnt++) {
        ...
        if (mdiff) {
            if (!trouble++)
                (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, cptr.decay(__static_wiz_mon_diff_window_title));
    ...
    if (!trouble)
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_putstr))(win, 0, __sl168);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_display_nhwindow))(win, 0);
    (cptr.ldPtro(windowprocs, FLD.window_procs_win_destroy_nhwindow))(win);
    return NHM.ECMD_OK;
}
...
export function wiz_objprobs() {
    ...
    let otyp;
    let oclass = cptr.ld1so2(objects, NHC.FIRST_OBJECT, 120, FLD.objclass_oc_class);
...
export function wiz_migrate_mons() {
    ...
    if ((((cptr.ldI16o((cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_stronghold_level)), FLD.d_level_dlevel) || cptr.ldI16((cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_stronghold_level)))) && on_level(cptr.add(u, FLD.you_uz), cptr.add(svd, FLD.instance_globals_saved_d_dungeon_topology + FLD.dgn_topology_d_stronghold_level)))))
        ...
        cptr.stI16(tolevel, 0), cptr.stI16o(tolevel, FLD.d_level_dlevel, 0);
    list_migrating_mons(tolevel);
    cptr.st1o(cptr.decay(inbuf), 0, cptr.st1o(cptr.decay(inbuf), 1, 0, 1), 1);
    if (cptr.ldI16(tolevel) || cptr.ldI16o(tolevel, FLD.d_level_dlevel))
    ...
    while (mcount > 0) {
        if (use_random_mon) {
            ...
            mtmp = cptr.ldPtro(svl, FLD.instance_globals_saved_l_level + FLD.dlevel_t_monlist);
        }
        if (mtmp)
...
export function wiz_custom() {
    if (cptr.ld1so(flags, FLD.flag_debug)) {
        ...
        if (cptr.ldI32o2(gs, NHC.PRIMARYSET, 48, FLD.instance_globals_s_symset + FLD.symsetentry_handling)) {
            void cptr.sprintf(eos(cptr.decay(bufa)), __sl177, cptr.ldPtro(known_handling, cptr.ldI32o2(gs, NHC.PRIMARYSET, 48, FLD.instance_globals_s_symset + FLD.symsetentry_handling), 8));
        }
        void cptr.sprintf(cptr.decay(buf), __sl24, cptr.decay(bufa));
        wizcustom_glyphids(win);
        (cptr.ldPtro(windowprocs, FLD.window_procs_win_end_menu))(win, cptr.decay(bufa));
...
export function wizcustom_callback(win, glyphnum, id) {
    ...
    if (win && id) {
        ...
        if (cptr.ldPtro(cgm, FLD.glyph_map_u) || cptr.ldI32o(cgm, FLD.glyph_map_customcolor) != 0) {
            void cptr.sprintf(cptr.decay(bufa), __sl178, glyphnum, id);
            void cptr.sprintf(cptr.decay(bufb), __sl179, cptr.ld1uo2(gs, cptr.ldI32o(cgm, FLD.glyph_map_sym + FLD.classic_representation_symidx), 1, FLD.instance_globals_s_showsyms), cptr.ldI32o(cgm, FLD.glyph_map_sym));
            void cptr.sprintf(cptr.decay(bufc), __sl180, BigInt(cptr.ldI32o(cgm, FLD.glyph_map_customcolor) >>> 0));
            cptr.st1o(cptr.decay(bufu), 0, 0, 1);
            if (cptr.ldPtro(cgm, FLD.glyph_map_u) && cptr.ldPtro(cptr.ldPtro(cgm, FLD.glyph_map_u), FLD.unicode_representation_utf8str)) {
                void cptr.sprintf(cptr.decay(bufu), __sl181, BigInt(cptr.ldI32(cptr.ldPtro(cgm, FLD.glyph_map_u)) >>> 0));
                cp = cptr.ldPtro(cptr.ldPtro(cgm, FLD.glyph_map_u), FLD.unicode_representation_utf8str);
                while (cptr.ld1u(cp)) {
