...
function throne_sit_effect() {
        ...
        switch (effect) {
            ...
            if (Luck() < 0 || (HSee_invisible() & 117440512n)) {
                if ((cptr.ldI32o(svl, $instance_globals_saved_l_level + $dlevel_t_flags + $levelflags_nommap) & 1)) {
                    ...
                    make_confused(BigInt.asIntN(64, (HConfusion() & 16777215n) + BigInt(rnd(30))), 0);
                } else {
            ...
            make_confused(BigInt.asIntN(64, (HConfusion() & 16777215n) + BigInt(((rn2(7) + 16) | 0))), 0);
            break;
            default:
    ...
    if (!special_throne && !rn2(3) && (!wizard() || yn_function(__s_analyze_throne, cptr.decay(ynchars), 110, 1) == 121)) {
            ...
            if (cptr.ldI32o(u, $you_utrap)) {
                ...
                if (cptr.ldI32o(u, $you_utraptype) == NHC.TT_BEARTRAP) {
                    ...
                    if (trap && ((cptr.ldI32o(trap, $trap_ttyp) & 31) | 0) == NHC.SPIKED_PIT) {
                        ...
                        losehp(Half_physical_damage() ? rn2(2) : 1, __s_sitting_on_an_iron_spike, NHM.KILLED_BY);
...
export function rndcurse() {
    ...
    if (cptr.ldPtro(u, $you_usteed) && !rn2(4) && (otmp = which_armor(cptr.ldPtro(u, $you_usteed), 1048576n)) !== null && !(cptr.ldI32o(otmp, $obj_cursed) & 1)) {
        if ((cptr.ldI32o(otmp, $obj_blessed) & 1))
            unbless(otmp);
        else
            curse(otmp);
