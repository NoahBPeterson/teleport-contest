        ...
        if (((monnear(mtmp, cptr.ldI16(u), cptr.ldI16o(u, $you_uy)) && levl_follower(mtmp)) || ((cptr.ldI32o(u, $you_uhave) & 1) | 0 && (cptr.ldI32o(mtmp, $monst_iswiz) & 1) | 0)) && (!helpless(mtmp) || (cptr.eq(mtmp, cptr.ldPtro(u, $you_usteed)))) && !(cptr.ldU64o(mtmp, $monst_mstrategy) & 536870912n)) {
            ...
            if (stay_behind) {
                if ((cptr.ldI32o(mtmp, $monst_mleashed) & 1)) {
                    pline(__sl26, humanoid(cptr.ldPtro(mtmp, $monst_data)) ? ((cptr.ldI32o(mtmp, $monst_female) & 1) | 0 ? __sl27 : __sl28) : __sl29);
                    m_unleash(mtmp, 0);
                }
                if (cptr.eq(mtmp, cptr.ldPtro(u, $you_usteed))) {
                    impossible(__sl30);
...
export function dogfood(mon, obj) {
    ...
    switch (cptr.ld1so(obj, $obj_oclass)) {
        ...
        if (cptr.ldI16o(obj, $obj_otyp) == NHC.CORPSE && is_rider(fptr))
            return NHC.TABU;
        if ((cptr.ldI16o(obj, $obj_otyp) == NHC.CORPSE || cptr.ldI16o(obj, $obj_otyp) == NHC.EGG) && (touch_petrifies(fptr) || cptr.eq((fptr), cptr.add(mons, NHC.PM_MEDUSA, 96))) && !Resists_Elem(mon, NHC.STONE_RES))
            return NHC.POISON;
        ...
        switch (cptr.ldI16o(obj, $obj_otyp)) {
            ...
            case NHC.CORPSE:
            if ((BigInt.asIntN(64, peek_at_iced_corpse_age(obj) + 50n) <= cptr.ldI64o(svm, $instance_globals_saved_m_moves) && !(fx == NHC.PM_LIZARD || fx == NHC.PM_LICHEN) && cptr.ld1so(mptr, $permonst_mlet) != NHC.S_FUNGUS) || (acidic(fptr) && !Resists_Elem(mon, NHC.ACID_RES)) || (poisonous(fptr) && !Resists_Elem(mon, NHC.POISON_RES)))
                return NHC.POISON;
