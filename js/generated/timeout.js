...
function slip_or_trip() {
    ...
    if (otmp && on_foot) {
        ...
        */
        ...
        pline(__s_s_s_s_the_ice, cptr.ldPtro(u, $you_usteed) ? upstart(x_monnam(cptr.ldPtro(u, $you_usteed), NHM.ARTICLE_THE, null, NHM.SUPPRESS_SADDLE, 0)) : __s_you, vtense(cptr.ldPtro(u, $you_usteed) ? __s_steed : __s_you__2, rn2(2) ? __s_slip : __s_slide), is_ice(cptr.ldI16(u), cptr.ldI16o(u, $you_uy)) ? __s_on : __s_off);
        ...
        if (!on_foot && ((saddle = which_armor(cptr.ldPtro(u, $you_usteed), 1048576n)) === null || !(cptr.ldI32o(saddle, $obj_cursed) & 1)) && (!ice_only || !rn2(3))) {
