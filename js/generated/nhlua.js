...
function nhl_getmap(L) {
    ...
    if (isok(x.v, y.v)) {
        ...
        lua_createtable(L, 0, 0);
        nhl_add_table_entry_int(L, __s_glyph, BigInt(cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level)));
        nhl_add_table_entry_int(L, __s_typ, BigInt(cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)));
        nhl_add_table_entry_str(L, __s_typ_name, levltyp_to_name(cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)));
        ...
        nhl_add_table_entry_int(L, __s_seenv, BigInt(cptr.ld1uo3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_seenv) >>> 0));
        nhl_add_table_entry_bool(L, __s_horizontal, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_horizontal) & 1)));
        nhl_add_table_entry_bool(L, __s_lit, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_lit) & 1)));
        nhl_add_table_entry_bool(L, __s_waslit, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_waslit) & 1)));
        nhl_add_table_entry_int(L, __s_roomno, BigInt((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_roomno) & 63) >>> 0));
        nhl_add_table_entry_bool(L, __s_edge, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_edge) & 1)));
        nhl_add_table_entry_bool(L, __s_candig, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_candig) & 1)));
        ...
        if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.DOOR)) {
            nhl_add_table_entry_bool(L, __s_nodoor, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) == NHM.D_NODOOR)));
            nhl_add_table_entry_bool(L, __s_broken, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.D_BROKEN)));
            nhl_add_table_entry_bool(L, __s_isopen, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.D_ISOPEN)));
            nhl_add_table_entry_bool(L, __s_closed, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.D_CLOSED)));
            nhl_add_table_entry_bool(L, __s_locked, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.D_LOCKED)));
            nhl_add_table_entry_bool(L, __s_trapped, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.D_TRAPPED)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.ALTAR)) {
            nhl_add_table_entry_bool(L, __s_shrine, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.AM_SHRINE)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.THRONE)) {
            nhl_add_table_entry_bool(L, __s_looted, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.T_LOOTED)));
        } else if (cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ) == NHC.TREE) {
            nhl_add_table_entry_bool(L, __s_looted, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.TREE_LOOTED)));
            nhl_add_table_entry_bool(L, __s_swarm, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.TREE_SWARM)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.FOUNTAIN)) {
            nhl_add_table_entry_bool(L, __s_looted, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.F_LOOTED)));
            nhl_add_table_entry_bool(L, __s_warned, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.F_WARNED)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.SINK)) {
            nhl_add_table_entry_bool(L, __s_pudding, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.S_LPUDDING)));
            nhl_add_table_entry_bool(L, __s_dishwasher, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.S_LDWASHER)));
            nhl_add_table_entry_bool(L, __s_ring, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, $instance_globals_saved_l_level + $rm_flags) & 31) | 0) & NHM.S_LRING)));
        }
        lua_settable(L, -3);
        return 1;
    } else {
...
export function save_luadata(nhfp) {
    ...
    lua_data_len.v = (Strlen_(lua_data, __s_save_luadata, 1491) + 1) >>> 0;
...
export function nhl_loadlua(L, fname) {
    ...
    let llret;
    __lbl_give_up: {
        altfname = alloc((Strlen_(fname, __s_nhl_loadlua, 2347) + 3) >>> 0);
