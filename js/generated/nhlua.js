...
export function l_nhcore_init() {
    ...
    if ((cptr.stPtro(gl, FLD.instance_globals_l_luacore, nhl_init(sbi))) !== null) {
        if (!nhl_loadlua(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), __sl7)) {
...
export function l_nhcore_done() {
    if (cptr.ldPtro(gl, FLD.instance_globals_l_luacore)) {
        nhl_done(cptr.ldPtro(gl, FLD.instance_globals_l_luacore));
        cptr.stPtro(gl, FLD.instance_globals_l_luacore, null);
    }
    end_luapat();
}
...
export function l_nhcore_call(callidx) {
    ...
    if (callidx < 0 || callidx >= NHC.NUM_NHCORE_CALLS || !cptr.ldPtro(gl, FLD.instance_globals_l_luacore) || !cptr.ld1so(cptr.decay(nhcore_call_available), callidx, 1))
        return;
    lua_getglobal(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), __sl9);
    if (!(lua_type(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1) == 5)) {
        nhl_done(cptr.ldPtro(gl, FLD.instance_globals_l_luacore));
        cptr.stPtro(gl, FLD.instance_globals_l_luacore, null);
        return;
    }
    lua_getfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, cptr.ldPtro(nhcore_call_names, callidx, 8));
    ltyp = lua_type(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1);
    if (ltyp == 6) {
        nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 0, 1, __sl10, NHC.NHLpa_panic);
    } else {
...
function nhl_gettrap(L) {
    ...
    if (isok(x.v, y.v)) {
        ...
        if (ttmp) {
            lua_createtable(L, 0, 0);
            nhl_add_table_entry_int(L, __sl31, BigInt(cptr.ldI16o(ttmp, FLD.trap_tx)));
            nhl_add_table_entry_int(L, __sl32, BigInt(cptr.ldI16o(ttmp, FLD.trap_ty)));
            nhl_add_table_entry_int(L, __sl33, BigInt((cptr.ldI32o(ttmp, FLD.trap_ttyp) & 31) >>> 0));
            nhl_add_table_entry_str(L, __sl34, get_trapname_bytype((cptr.ldI32o(ttmp, FLD.trap_ttyp) & 31) | 0));
            nhl_add_table_entry_bool(L, __sl35, schar((cptr.ldI32o(ttmp, FLD.trap_tseen) & 1)));
            nhl_add_table_entry_bool(L, __sl36, schar((cptr.ldI32o(ttmp, FLD.trap_madeby_u) & 1)));
            nhl_add_table_entry_bool(L, __sl37, schar((cptr.ldI32o(ttmp, FLD.trap_once) & 1)));
            switch ((cptr.ldI32o(ttmp, FLD.trap_ttyp) & 31) | 0) {
                case NHC.SQKY_BOARD:
                nhl_add_table_entry_int(L, __sl38, BigInt(cptr.ldI16o(ttmp, FLD.trap_vl)));
                break;
                case NHC.ROLLING_BOULDER_TRAP:
                nhl_add_table_entry_int(L, __sl39, BigInt(cptr.ldI16o(ttmp, FLD.trap_launch)));
                nhl_add_table_entry_int(L, __sl40, BigInt(cptr.ldI16o(ttmp, FLD.trap_launch + FLD.nhcoord_y)));
                nhl_add_table_entry_int(L, __sl41, BigInt(cptr.ldI16o(ttmp, FLD.trap_vl)));
                nhl_add_table_entry_int(L, __sl42, BigInt(cptr.ldI16o(ttmp, FLD.trap_vl + FLD.nhcoord_y)));
                break;
                case NHC.PIT:
                case NHC.SPIKED_PIT:
                nhl_add_table_entry_int(L, __sl43, BigInt(cptr.ld1uo(ttmp, FLD.trap_vl) >>> 0));
                break;
            }
            return 1;
        } else {
...
function nhl_getmap(L) {
    ...
    if (isok(x.v, y.v)) {
        ...
        lua_createtable(L, 0, 0);
        nhl_add_table_entry_int(L, __sl46, BigInt(cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level)));
        nhl_add_table_entry_int(L, __sl47, BigInt(cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)));
        nhl_add_table_entry_str(L, __sl48, levltyp_to_name(cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)));
        ...
        nhl_add_table_entry_int(L, __sl50, BigInt(cptr.ld1uo3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_seenv) >>> 0));
        nhl_add_table_entry_bool(L, __sl51, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_horizontal) & 1)));
        nhl_add_table_entry_bool(L, __sl52, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_lit) & 1)));
        nhl_add_table_entry_bool(L, __sl53, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_waslit) & 1)));
        nhl_add_table_entry_int(L, __sl54, BigInt((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_roomno) & 63) >>> 0));
        nhl_add_table_entry_bool(L, __sl55, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_edge) & 1)));
        nhl_add_table_entry_bool(L, __sl56, schar((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_candig) & 1)));
        ...
        if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) == NHC.DOOR)) {
            nhl_add_table_entry_bool(L, __sl59, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) == NHM.D_NODOOR)));
            nhl_add_table_entry_bool(L, __sl60, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.D_BROKEN)));
            nhl_add_table_entry_bool(L, __sl61, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.D_ISOPEN)));
            nhl_add_table_entry_bool(L, __sl62, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.D_CLOSED)));
            nhl_add_table_entry_bool(L, __sl63, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.D_LOCKED)));
            nhl_add_table_entry_bool(L, __sl64, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.D_TRAPPED)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) == NHC.ALTAR)) {
            nhl_add_table_entry_bool(L, __sl65, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.AM_SHRINE)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) == NHC.THRONE)) {
            nhl_add_table_entry_bool(L, __sl66, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.T_LOOTED)));
        } else if (cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ) == NHC.TREE) {
            nhl_add_table_entry_bool(L, __sl66, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.TREE_LOOTED)));
            nhl_add_table_entry_bool(L, __sl67, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.TREE_SWARM)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) == NHC.FOUNTAIN)) {
            nhl_add_table_entry_bool(L, __sl66, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.F_LOOTED)));
            nhl_add_table_entry_bool(L, __sl68, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.F_WARNED)));
        } else if (((cptr.ld1so3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_typ)) == NHC.SINK)) {
            nhl_add_table_entry_bool(L, __sl69, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.S_LPUDDING)));
            nhl_add_table_entry_bool(L, __sl70, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.S_LDWASHER)));
            nhl_add_table_entry_bool(L, __sl71, schar((((cptr.ldI32o3(svl, x.v, 756, y.v, 36, FLD.instance_globals_saved_l_level + FLD.rm_flags) & 31) | 0) & NHM.S_LRING)));
        }
        lua_settable(L, -3);
        return 1;
    } else {
...
function nhl_is_genocided(L) {
    ...
    if (argc == 1) {
        ...
        lua_pushboolean(L, (i != NHC.NON_PM) && (cptr.ld1uo2(svm, i, 12, FLD.instance_globals_saved_m_mvitals + FLD.mvitals_mvflags) & NHM.G_GENOD) ? 1 : 0);
    } else {
        nhl_error(L, __sl73);
    }
    return 1;
...
function nhl_variable(L) {
    ...
    lua_getglobal(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), __sl104);
    if (!(lua_type(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1) == 5)) {
        impossible(__sl105);
        return 0;
    }
    if (argc == 1) {
        ...
        lua_getfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, key);
        typ = lua_type(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1);
        if (typ == 4)
            lua_pushstring(L, lua_tolstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, null));
        else if (typ == 0)
            lua_pushnil(L);
        else if (typ == 1)
            lua_pushboolean(L, lua_toboolean(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1));
        else if (typ == 3)
            lua_pushinteger(L, lua_tointegerx(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, null));
        else if (typ == 5) {
            lua_getglobal(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), __sl106);
            lua_pushvalue(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2);
            nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 1, 1, __sl107, NHC.NHLpa_panic);
            luaL_loadstring(L, lua_tolstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, null));
        ...
        typ = lua_type(L, -1);
        if (typ == 4) {
            lua_pushstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), lua_tolstring(L, -1, null));
            lua_setfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2, key);
        } else if (typ == 0) {
            lua_pushnil(cptr.ldPtro(gl, FLD.instance_globals_l_luacore));
            lua_setfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2, key);
        } else if (typ == 1) {
            lua_pushboolean(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), lua_toboolean(L, -1));
            lua_setfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2, key);
        } else if (typ == 3) {
            lua_pushinteger(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), lua_tointegerx(L, -1, null));
            lua_setfield(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2, key);
        } else if (typ == 5) {
            ...
            luaL_loadstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), lua_tolstring(L, -1, null));
            nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 0, 0, __sl112, NHC.NHLpa_panic);
        } else
            nhl_error(L, __sl113);
        return 0;
    } else
...
export function get_nh_lua_variables() {
    ...
    lua_getglobal(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), __sl115);
    if (lua_type(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1) == 6) {
        if (nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 0, 1, __sl116, NHC.NHLpa_impossible)) {
            return key;
        }
        key = dupstr(lua_tolstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -1, null));
    }
    lua_settop(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), -2);
    return key;
}
...
export function restore_luadata(nhfp) {
    ...
    if (!cptr.ldPtro(gl, FLD.instance_globals_l_luacore))
        l_nhcore_init();
    luaL_loadstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), lua_data);
    cptr.free(lua_data);
    nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 0, 0, __sl120, NHC.NHLpa_panic);
}
...
function nhl_stairways(L) {
    ...
    while (tmp) {
        ...
        lua_createtable(L, 0, 0);
        nhl_add_table_entry_bool(L, __sl121, cptr.ld1so(tmp, FLD.stairway_up));
        nhl_add_table_entry_bool(L, __sl122, cptr.ld1so(tmp, FLD.stairway_isladder));
        nhl_add_table_entry_int(L, __sl123, BigInt(cptr.ldI16(tmp)));
        nhl_add_table_entry_int(L, __sl124, BigInt(cptr.ldI16o(tmp, FLD.stairway_sy)));
        nhl_add_table_entry_int(L, __sl125, BigInt(cptr.ldI16o(tmp, FLD.stairway_tolev)));
        nhl_add_table_entry_int(L, __sl126, BigInt(cptr.ldI16o(tmp, FLD.stairway_tolev + FLD.d_level_dlevel)));
        lua_settable(L, -3);
...
function nhl_flip_level(L) {
    ...
    flip_level(flp, schar((!cptr.ld1so(gi, FLD.instance_globals_i_in_mklev))));
    return 0;
}
...
function nhl_callback(L) {
    ...
    if (argc == 2 || argc == 3) {
        ...
        lua_getglobal(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), rm ? __sl138 : __sl139);
        lua_pushstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), cb);
        lua_pushstring(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), fn);
        nhl_pcall_handle(cptr.ldPtro(gl, FLD.instance_globals_l_luacore), 2, 0, __sl140, NHC.NHLpa_panic);
    }
    return 0;
}
...
function nhl_gamestate(L) {
    ...
    do {
        if (debugcore(__sl141, 1)) {
            ...
            pline(__sl142, cptr.ldI16o(u, FLD.you_uz), cptr.ldI16o(u, FLD.you_uz + FLD.d_level_dlevel), reststate ? 84 : 70, cptr.ld1so(gg, FLD.instance_globals_g_gmst_stored) ? 116 : 102);
    ...
    if (reststate && cptr.ld1so(gg, FLD.instance_globals_g_gmst_stored)) {
        ...
        pline(__sl143, cptr.ldI64o(svm, FLD.instance_globals_saved_m_moves));
        ...
        while (!cptr.eq((otmp = cptr.ldPtro(gg, FLD.instance_globals_g_gmst_invent)), (null))) {
            ...
            extract_nobj(otmp, cptr.add(gg, FLD.instance_globals_g_gmst_invent));
            addinv_nomerge(otmp);
            if (wornmask)
        ...
        impossible(__sl149, reststate ? __sl150 : __sl151, cptr.ld1so(gg, FLD.instance_globals_g_gmst_stored) ? __sl152 : __sl153);
    }
    update_inventory();
    return 0;
}
...
function nhl_meta_u_index(L) {
    ...
    if (!strcmp(tkey, __sl202)) {
        nhl_push_obj(L, cptr.ldPtro(gi, FLD.instance_globals_i_invent));
        return 1;
    } else if (!strcmp(tkey, __sl203)) {
        lua_pushstring(L, cptr.ldPtro(gu, FLD.instance_globals_u_urole));
        return 1;
    } else if (!strcmp(tkey, __sl204)) {
        lua_pushinteger(L, cptr.ldI64o(svm, FLD.instance_globals_saved_m_moves));
        return 1;
    } else if (!strcmp(tkey, __sl205)) {
        lua_pushinteger(L, BigInt((cptr.ldI32o(u, FLD.you_uhave) & 1) >>> 0));
        return 1;
    } else if (!strcmp(tkey, __sl206)) {
        lua_pushinteger(L, BigInt(depth(cptr.add(u, FLD.you_uz))));
        return 1;
    } else if (!strcmp(tkey, __sl207)) {
        lua_pushboolean(L, Invocation_lev(cptr.add(u, FLD.you_uz)));
        return 1;
    }
    nhl_error(L, __sl208);
    return 0;
...
export function nhl_pcall(L, nargs, nresults, name) {
    ...
    if (nud.v && (cptr.ldI32o(nud.v, FLD.nhl_user_data_steps) || cptr.ldI32o(nud.v, FLD.nhl_user_data_perpcall))) {
        ...
        }
        {
            ...
            try {
                if (__sv1) {
                    panic(__sl235, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name) ? cptr.ldPtro(nud.v, FLD.nhl_user_data_name) : __sl236);
                }
            } catch (__e1) {
    ...
    if (nud.v && cptr.ldI32o(nud.v, FLD.nhl_user_data_perpcall) && cptr.ldI32o(gl, FLD.instance_globals_l_loglua)) {
        ...
        livelog_printf(32768n, __sl237, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name), ic);
    }
    if (nud.v && cptr.ldI32o(nud.v, FLD.nhl_user_data_memlimit) && cptr.ldI32o(gl, FLD.instance_globals_l_loglua)) {
        livelog_printf(32768n, __sl238, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name), BigInt(nhl_getmeminuse(L) >>> 0));
    }
    return rv;
}
...
export function nhl_pcall_handle(L, nargs, nresults, name, npa) {
    ...
    if (rv) {
        ...
        switch (npa) {
            ...
            panic(__sl239, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name) ? cptr.ldPtro(nud.v, FLD.nhl_user_data_name) : __sl236, lua_tolstring(L, -1, null));
            break;
            case NHC.NHLpa_impossible:
            impossible(__sl240, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name) ? cptr.ldPtro(nud.v, FLD.nhl_user_data_name) : __sl236, lua_tolstring(L, -1, null));
            lua_settop(L, -2);
        }
    }
    return rv;
    ...
    if (L) {
        ...
        if (cptr.ldI32o(gl, FLD.instance_globals_l_loglua)) {
            if (nud.v && cptr.ldI32o(nud.v, FLD.nhl_user_data_osteps)) {
                let ic = BigInt((Math.imul(cptr.ldI32o(nud.v, FLD.nhl_user_data_statctr), NHM.NHL_SB_STEPSIZE) >>> 0) >>> 0);
                livelog_printf(32768n, __sl252, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name), ic);
            }
            if (nud.v && cptr.ldI32o(nud.v, FLD.nhl_user_data_memlimit) && !cptr.ldI32o(nud.v, FLD.nhl_user_data_perpcall)) {
                livelog_printf(32768n, __sl253, cptr.ldI32o(nud.v, FLD.nhl_user_data_sid), cptr.ldPtro(nud.v, FLD.nhl_user_data_name), BigInt(nhl_getmeminuse(L) >>> 0));
            }
        }
        lua_close(L);
        if (nud.v)
...
function nhl_clearfromtable(L, flag, tndx, todo) {
    while (cptr.ldI32(todo) != NHC.EOT) {
        ...
        if (cptr.ldI32(todo) == NHC.NEVER || !flag) {
            lua_setfield(L, tndx, cptr.ldPtro(todo, FLD.e_fnname));
        }
...
function nhl_alloc(ud, ptr, osize, nsize) {
    ...
    if (nud && cptr.ldPtr(nud) && cptr.ldI32o(nud, FLD.nhl_user_data_memlimit)) {
        if (nhl_getmeminuse(cptr.ldPtr(nud)) > cptr.ldI32o(nud, FLD.nhl_user_data_memlimit))
            return (null);
    }
...
function nhl_warn(userdata, msg_fragment, to_be_continued) {
    ...
    if (!to_be_continued) {
        paniclog(__sl320, cptr.add(gl, FLD.instance_globals_l_lua_warnbuf));
