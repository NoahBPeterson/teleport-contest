...
export function move_special(mtmp, in_his_shop, appr, uondoor, avoid, omx, omy, ggx, ggy) {
    ...
    __lbl_pick_move: for (;;) {
        ...
        if (nix != omx || niy != omy) {
            ...
            newsym(nix, niy);
            if ((cptr.ldI32o(mtmp, 180) & 1) | 0 && !in_his_shop && inhishop(mtmp))
...
function histemple_at(priest, x, y) {
    return schar((priest && (cptr.ldI32o(priest, 192) & 1) | 0 && (cptr.ld1so((cptr.ldPtro(cptr.ldPtro((priest), 312), 16)), 5) == cptr.ld1s(in_rooms(x, y, NHC.TEMPLE))) && on_level(cptr.add((cptr.ldPtro(cptr.ldPtro((priest), 312), 16)), 10), cptr.add(u, 24)) ? 1 : 0));
}
...
export function priestname(mon, article, reveal_high_priest, pname) {
    ...
    if ((cptr.ldI32o(mon, 192) & 1) | 0 || aligned_priest) {
        ...
        if (cptr.ld1so(mon, 65) && !strncmpi((what), (__sl9), -1))
...
export function findpriest(roomno) {
    ...
    for (mtmp = cptr.ldPtro(svl, 89056); mtmp; mtmp = cptr.ldPtr(mtmp)) {
        if ((cptr.ldI32o((mtmp), 52) < 1))
            continue;
        if ((cptr.ldI32o(mtmp, 192) & 1) | 0 && (cptr.ld1so((cptr.ldPtro(cptr.ldPtro((mtmp), 312), 16)), 5) == roomno) && histemple_at(mtmp, cptr.ldI16o(mtmp, 28), cptr.ldI16o(mtmp, 30)))
            return mtmp;
    }
    return null;
}
...
export function intemple(roomno) {
    ...
    if ((priest = findpriest(schar(roomno))) !== null) {
        ...
        if (!(rng_log_enabled() ? (rng_log_set_caller(__sl0, 519, __sl20), rn2(5)) : rn2(5)) && (mtmp = makemon(cptr.add(mons, NHC.PM_GHOST, 96), cptr.ldI16(u), cptr.ldI16o(u, 2), NHM.MM_NOMSG)) !== null) {
...
export function priest_talk(priest) {
    ...
    if (!inhistemple(priest) || !(cptr.ldI32o(priest, 168) & 1) || ((cptr.ldI32o((priest), 144) & 1) | 0 || !(cptr.ldI32o((priest), 160) & 1))) {
    ...
    if ((cptr.ldI32o(priest, 168) & 1) | 0 && cptr.ld1s(in_rooms(cptr.ldI16o(priest, 28), cptr.ldI16o(priest, 30), NHC.TEMPLE)) && !has_shrine(priest)) {
        ;
        verbalize(__sl48);
        cptr.stI32o(priest, 168, 0);
        return;
    ...
    if (!money_cnt(cptr.ldPtro(gi, 8))) {
        if (coaligned && !strayed) {
            ...
            if (pmoney > 0n) {
                let bits;
                bits = ((cptr.ldI64o2(u, NHC.HALLUC, 24, 128) && !(cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 128) || cptr.ldI64o2(u, NHC.HALLUC_RES, 24, 112)))) ? currency(pmoney) : ((pmoney == 1n) ? __sl49 : __sl50);
...
export function in_your_sanctuary(mon, x, y) {
    ...
    if (cptr.ldI32o(u, 2176) <= -4)
        return 0;
    if ((roomno = temple_occupied(cptr.add(u, 68))) == 0 || roomno != cptr.ld1s(in_rooms(x, y, NHC.TEMPLE)))
        return 0;
