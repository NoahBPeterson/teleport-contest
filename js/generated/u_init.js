...
function u_init_role() {
    ...
    switch (Role_switch()) {
        ...
        {
            ini_inv(Monk);
            ini_inv(cptr.ldPtro(__static_u_init_role_M_spell, ((rng_log_enabled() ? (rng_log_set_caller(__s_u_init_c, 699, __s_u_init_role), rn2(90)) : rn2(90)) / 30) | 0, 8));
            ...
            if (cptr.ldI16o(inv_subs, i, 6) == cptr.ldI16o(gu, $instance_globals_u_urace + $Race_mnum) && cptr.ldI16o(obj, $obj_otyp) == cptr.ldI16o2(inv_subs, i, 6, $inv_sub_item_otyp)) {
                {
                    if (debugcore(__s_u_init_c, 1)) {
                        ...
                        pline(__s_ini_inv_substituting_s_for_s_s, (cptr.ldPtro(obj_descr, cptr.ldI16((cptr.add(objects, cptr.ldI16o2(inv_subs, i, 6, $inv_sub_subs_otyp), 120))), 16)), (cptr.ldI16(trop) == 0) ? __s_random : __s_empty, (cptr.ldPtro(obj_descr, cptr.ldI16((cptr.add(objects, cptr.ldI16o(obj, $obj_otyp), 120))), 16)));
