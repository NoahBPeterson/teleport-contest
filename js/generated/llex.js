...
function save(ls, c) {
    ...
    if (BigInt.asUintN(64, (cptr.ldU64o((b), FLD.Mbuffer_n)) + 1n) > (cptr.ldU64o((b), FLD.Mbuffer_buffsize))) {
        ...
        (cptr.stPtr((b), (((luaM_saferealloc_(cptr.ldPtro(ls, FLD.LexState_L), (cptr.ldPtr((b))), BigInt.asUintN(64, (cptr.ldU64o((b), FLD.Mbuffer_buffsize)) * 1n), BigInt.asUintN(64, (newsize) * 1n)))))), cptr.stU64o((b), FLD.Mbuffer_buffsize, newsize));
    }
...
export function luaX_token2str(ls, token) {
    if (token < 256) {
        if ((cptr.ld1uo(cptr.decay(luai_ctype_), ((token) + 1) | 0, 1) & 4))
            return luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl39, token);
        else
            return luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl40, token);
    } else {
        let s = cptr.ldPtro(luaX_tokens, (token - 256) | 0, 8);
        if (token < NHC.TK_EOS)
            return luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl41, s);
        else
            return s;
    }
}
...
function txtToken(ls, token) {
    switch (token) {
        ...
        case NHC.TK_INT:
        save(ls, 0);
        return luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl41, (cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))));
        default:
...
function lexerror(ls, msg, token) {
    msg = luaG_addinfo(cptr.ldPtro(ls, FLD.LexState_L), msg, cptr.ldPtro(ls, FLD.LexState_source), cptr.ldI32o(ls, FLD.LexState_linenumber));
    if (token)
        luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl42, msg, txtToken(ls, token));
    luaD_throw(cptr.ldPtro(ls, FLD.LexState_L), 3);
}

/** C ref: llex.c:119 — @param {CPtr} ls @param {CPtr} msg */
export function luaX_syntaxerror(ls, msg) {
    lexerror(ls, msg, cptr.ldI32o(ls, FLD.LexState_t));
}
...
export function luaX_newstring(ls, str, l) {
    ...
    if (!(((((cptr.ld1uo(((o)), FLD.TValue_tt_))) & 15)) == 0))
        ...
        ;
        luaH_finishset(L, cptr.ldPtro(ls, FLD.LexState_h), stv, o, stv);
        {
...
function inclinenumber(ls) {
    ...
    (void 0);
    (cptr.stI32(ls, (((cptr.stU64((cptr.ldPtro(ls, FLD.LexState_z)), cptr.ldU64((cptr.ldPtro(ls, FLD.LexState_z))) + -1n)) - (-1n)) > 0n ? (uchar(((cptr.ld1s(cptr.postinc(() => cptr.ldPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p), (v) => { cptr.stPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p, v); })))))) : luaZ_fill(cptr.ldPtro(ls, FLD.LexState_z)))));
...
export function luaX_setinput(L, ls, z, source, firstchar) {
    ...
    cptr.stPtro(ls, FLD.LexState_envn, (luaS_newlstr(L, __sl38, BigInt.asUintN(64, (5n / 1n) - 1n))));
    (cptr.stPtr((cptr.ldPtro(ls, FLD.LexState_buff)), (((luaM_saferealloc_(cptr.ldPtro(ls, FLD.LexState_L), (cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))), BigInt.asUintN(64, (cptr.ldU64o((cptr.ldPtro(ls, FLD.LexState_buff)), FLD.Mbuffer_buffsize)) * 1n), 32n))))), cptr.stU64o((cptr.ldPtro(ls, FLD.LexState_buff)), FLD.Mbuffer_buffsize, 32n));
}
...
function check_next2(ls, set) {
    ...
    if (cptr.ldI32(ls) == cptr.ld1so(set, 0) || cptr.ldI32(ls) == cptr.ld1so(set, 1)) {
        (save(ls, cptr.ldI32(ls)), (cptr.stI32(ls, (((cptr.stU64((cptr.ldPtro(ls, FLD.LexState_z)), cptr.ldU64((cptr.ldPtro(ls, FLD.LexState_z))) + -1n)) - (-1n)) > 0n ? (uchar(((cptr.ld1s(cptr.postinc(() => cptr.ldPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p), (v) => { cptr.stPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p, v); })))))) : luaZ_fill(cptr.ldPtro(ls, FLD.LexState_z))))));
        return 1;
    } else
        return 0;
}
...
function read_numeral(ls, seminfo) {
    ...
    if ((cptr.ld1uo(cptr.decay(luai_ctype_), ((cptr.ldI32(ls)) + 1) | 0, 1) & 1))
        (save(ls, cptr.ldI32(ls)), (cptr.stI32(ls, (((cptr.stU64((cptr.ldPtro(ls, FLD.LexState_z)), cptr.ldU64((cptr.ldPtro(ls, FLD.LexState_z))) + -1n)) - (-1n)) > 0n ? (uchar(((cptr.ld1s(cptr.postinc(() => cptr.ldPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p), (v) => { cptr.stPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p, v); })))))) : luaZ_fill(cptr.ldPtro(ls, FLD.LexState_z))))));
    save(ls, 0);
    if (luaO_str2num((cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))), obj) == 0n)
...
function read_long_string(ls, seminfo, sep) {
        ...
        for (; ; ) {
            switch (cptr.ldI32(ls)) {
                case -1:
                {
                    ...
                    let msg = luaO_pushfstring(cptr.ldPtro(ls, FLD.LexState_L), __sl51, what, line);
    ...
    if (seminfo)
        cptr.stPtr(seminfo, luaX_newstring(ls, cptr.add((cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))), sep), BigInt.asUintN(64, (cptr.ldU64o((cptr.ldPtro(ls, FLD.LexState_buff)), FLD.Mbuffer_n)) - BigInt.asUintN(64, 2n * sep))));
}
...
function readutf8esc(ls) {
    ...
    while ((void (((save(ls, cptr.ldI32(ls)), (cptr.stI32(ls, (((cptr.stU64((cptr.ldPtro(ls, FLD.LexState_z)), cptr.ldU64((cptr.ldPtro(ls, FLD.LexState_z))) + -1n)) - (-1n)) > 0n ? (uchar(((cptr.ld1s(cptr.postinc(() => cptr.ldPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p), (v) => { cptr.stPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p, v); })))))) : luaZ_fill(cptr.ldPtro(ls, FLD.LexState_z))))))))), (cptr.ld1uo(cptr.decay(luai_ctype_), ((cptr.ldI32(ls)) + 1) | 0, 1) & 16)) {
        i++;
...
function read_string(ls, del, seminfo) {
    ...
    (save(ls, cptr.ldI32(ls)), (cptr.stI32(ls, (((cptr.stU64((cptr.ldPtro(ls, FLD.LexState_z)), cptr.ldU64((cptr.ldPtro(ls, FLD.LexState_z))) + -1n)) - (-1n)) > 0n ? (uchar(((cptr.ld1s(cptr.postinc(() => cptr.ldPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p), (v) => { cptr.stPtro((cptr.ldPtro(ls, FLD.LexState_z)), FLD.ZIO_p, v); })))))) : luaZ_fill(cptr.ldPtro(ls, FLD.LexState_z))))));
    cptr.stPtr(seminfo, luaX_newstring(ls, cptr.add((cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))), 1), BigInt.asUintN(64, (cptr.ldU64o((cptr.ldPtro(ls, FLD.LexState_buff)), FLD.Mbuffer_n)) - 2n)));
}
        ...
        switch (cptr.ldI32(ls)) {
            ...
            default:
            {
                if ((cptr.ld1uo(cptr.decay(luai_ctype_), ((cptr.ldI32(ls)) + 1) | 0, 1) & 1)) {
                    ...
                    ts = luaX_newstring(ls, (cptr.ldPtr((cptr.ldPtro(ls, FLD.LexState_buff)))), (cptr.ldU64o((cptr.ldPtro(ls, FLD.LexState_buff)), FLD.Mbuffer_n)));
...
export function luaX_next(ls) {
    ...
    if (cptr.ldI32o(ls, FLD.LexState_lookahead) != NHC.TK_EOS) {
        ...
        cptr.stI32o(ls, FLD.LexState_t, llex(ls, cptr.add(ls, FLD.LexState_t + FLD.Token_seminfo)));
}

/** C ref: llex.c:576 — @param {CPtr} ls @returns {CInt} */
export function luaX_lookahead(ls) {
    (void 0);
    cptr.stI32o(ls, FLD.LexState_lookahead, llex(ls, cptr.add(ls, FLD.LexState_lookahead + FLD.Token_seminfo)));
