...
export function luaM_free_(L, block, osize) {
    ...
    (void 0);
    ((cptr.ldPtr(g))(cptr.ldPtro(g, FLD.global_State_ud), block, osize, 0n));
...
function tryagain(L, block, osize, nsize) {
    ...
    if (((((((cptr.ld1uo(((cptr.add(g, FLD.global_State_nilvalue))), FLD.TValue_tt_))) & 15)) == 0) && !cptr.ld1uo(g, FLD.global_State_gcstopem))) {
        luaC_fullgc(L, 1);
        return ((cptr.ldPtr(g))(cptr.ldPtro(g, FLD.global_State_ud), block, osize, nsize));
    } else
        return (null);
}
...
export function luaM_realloc_(L, block, osize, nsize) {
    ...
    let g = (cptr.ldPtro(L, FLD.lua_State_l_G));
    (void 0);
    newblock = ((cptr.ldPtr(g))(cptr.ldPtro(g, FLD.global_State_ud), block, osize, nsize));
...
export function luaM_malloc_(L, size, tag) {
    if (size == 0n)
        ...
        let g = (cptr.ldPtro(L, FLD.lua_State_l_G));
        let newblock = ((cptr.ldPtr(g))(cptr.ldPtro(g, FLD.global_State_ud), (null), BigInt.asUintN(64, BigInt(tag)), size));
