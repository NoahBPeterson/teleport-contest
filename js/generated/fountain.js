...
export function drinksink() {
    ...
    switch ((rng_log_enabled() ? (rng_log_set_caller(__sl2, 604, __sl74), rn2(20)) : rn2(20))) {
        ...
        pline(__sl83, Blind() ? __sl84 : hcolor((cptr.ldPtro2(obj_descr, cptr.ldI16o((cptr.add(objects, cptr.ldI16o(otmp, FLD.obj_otyp), 120)), FLD.objclass_oc_descr_idx), 16, FLD.objdescr_oc_descr))));
