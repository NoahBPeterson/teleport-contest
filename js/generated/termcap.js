...
export function term_startup(wid, hgt) {
    ...
    for (i = 0; digit(cptr.ld1so(SO, i)); ++i)
        continue;
    cptr.stPtro(tc_lcl_data, FLD.tc_lcl_data_tc_HI, dupstr(cptr.add(SO, i)));
    for (i = 0; digit(cptr.ld1so(ME, i)); ++i)
        continue;
    cptr.stPtro(tc_lcl_data, FLD.tc_lcl_data_tc_HE, dupstr(cptr.add(ME, i)));
    dynamic_HIHE = 1;
...
export function cl_end() {
    if (CE) {
        ...
        tty_curs(BASE_WINDOW, (cptr.ldI16o(ttyDisplay, FLD.DisplayDesc_curx) + 1) | 0, cptr.ldI16o(ttyDisplay, FLD.DisplayDesc_cury));
    }
}
