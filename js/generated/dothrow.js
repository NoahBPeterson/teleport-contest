...
export function release_camera_demon(obj, x, y) {
    let mtmp;
    if (!(rng_log_enabled() ? (rng_log_set_caller(__s_dothrow_c, 2460, __s_release_camera_demon), rn2(3)) : rn2(3)) && (mtmp = makemon(cptr.add(mons, (rng_log_enabled() ? (rng_log_set_caller(__s_dothrow_c, 2461, __s_release_camera_demon), rn2(3)) : rn2(3)) ? NHC.PM_HOMUNCULUS : NHC.PM_IMP, $sizeof_permonst), x, y, NHM.MM_NOMSG)) !== null) {
        if (canspotmon(mtmp))
