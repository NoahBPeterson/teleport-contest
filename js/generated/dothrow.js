...
function throw_obj(obj, shotlimit) {
    ...
    __lbl_unsplit_stack: {
        ...
        if ((is_art(obj, NHC.ART_MJOLLNIR) && (acurr(NHC.A_STR)) < 125) || (cptr.ldI16o(obj, $obj_otyp) == NHC.BOULDER && !throws_rocks(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)))) {
            pline(__sl2);
            res = NHM.ECMD_TIME;
            break __lbl_unsplit_stack;
        }
        ...
        if (cptr.ldI64o(obj, $obj_quan) > 1n && (is_ammo(obj) ? matching_launcher(obj, uwep.v) : cptr.ld1so(obj, $obj_oclass) == NHC.WEAPON_CLASS) && !(HConfusion() || HStun())) {
            ...
            if (!weakmultishot) {
                ...
                if (uwep.v && is_quest_artifact(uwep.v) && (is_ammo(obj) && matching_launcher(obj, uwep.v)))
                    ++multishot;
            }
            if (multishot > 1 && skill == -22 && (is_ammo(obj) && matching_launcher(obj, uwep.v)) && (acurrstr()) < ((cptr.ldI16o(gu, $instance_globals_u_urace + $Race_mnum) == NHC.PM_GNOME) ? 16 : 18))
        ...
        cptr.st1o(gm, $instance_globals_m_m_shot + $multishot_s, schar(((is_ammo(obj) && matching_launcher(obj, uwep.v)) ? 1 : 0)));
...
function ok_to_throw(shotlimit_p) {
    ...
    if (notake(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data))) {
        You(__sl11);
        return 0;
    } else if (nohands(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data))) {
        You_cant(__sl12);
        return 0;
    }
...
function throw_ok(obj) {
    ...
    if ((uwep.v && cptr.ld1so2(objects, cptr.ldI16o(uwep.v, $obj_otyp), 120, $objclass_oc_subtyp) == NHC.P_SLING) && cptr.ld1so(obj, $obj_oclass) == NHC.GEM_CLASS)
        return NHC.GETOBJ_SUGGEST;
    if (throws_rocks(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)) && cptr.ldI16o(obj, $obj_otyp) == NHC.BOULDER)
        return NHC.GETOBJ_SUGGEST;
    return NHC.GETOBJ_DOWNPLAY;
}
    ...
    for (otmp = cptr.ldPtro(gi, $instance_globals_i_invent); otmp; otmp = cptr.ldPtr(otmp)) {
        if (cptr.ldI64o(otmp, $obj_owornmask) || cptr.ld1so(otmp, $obj_oartifact) || !(cptr.ldI32o(otmp, $obj_dknown) & 1)) {
            ...
            if ((uwep.v && cptr.ld1so2(objects, cptr.ldI16o(uwep.v, $obj_otyp), 120, $objclass_oc_subtyp) == NHC.P_SLING))
                oammo = otmp;
            else if ((is_ammo(otmp) && matching_launcher(otmp, uswapwep.v)))
                altammo = otmp;
            else if (!omisc)
                omisc = otmp;
            ...
            if ((is_ammo(otmp) && matching_launcher(otmp, uwep.v)))
                oammo = otmp;
            else if ((is_ammo(otmp) && matching_launcher(otmp, uswapwep.v)))
                altammo = otmp;
            else
...
function find_launcher(ammo) {
    ...
    for (oX = null, otmp = cptr.ldPtro(gi, $instance_globals_i_invent); otmp; otmp = cptr.ldPtr(otmp)) {
        if ((cptr.ldI32o(otmp, $obj_cursed) & 1) | 0 && (cptr.ldI32o(otmp, $obj_bknown) & 1) | 0)
            continue;
        if ((is_ammo(ammo) && matching_launcher(ammo, otmp))) {
...
export function dofire() {
    ...
    if (uquiver.v && is_ammo(uquiver.v) && cptr.ld1so(iflags, $instance_flags_fireassist) && !skip_fireassist) {
        ...
        if (uwep.v && is_pole(uwep.v) && could_pole_mon())
            return use_pole(uwep.v, 1);
        if ((is_ammo(uquiver.v) && matching_launcher(uquiver.v, uwep.v))) {
            obj = uquiver.v;
        } else if ((is_ammo(uquiver.v) && matching_launcher(uquiver.v, uswapwep.v))) {
            cmdq_add_ec(NHC.CQ_CANNED, doswapweapon);
            cmdq_add_ec(NHC.CQ_CANNED, dofire);
            return res;
...
export function hurtle_step(arg, x, y) {
    ...
    if (!Passes_walls() || !(may_pass = may_passwall(x, y))) {
        ...
        let open_door = schar((IS_DOOR(ltyp) && (((cptr.ldI32o(lev, $rm_flags) & 31) | 0) & NHM.D_ISOPEN) != 0 ? 1 : 0));
        ...
        if (((cptr.ld1so3(svl, x, 756, y, 36, $instance_globals_saved_l_level + $rm_typ)) < NHC.POOL) || closed_door(x, y) || odoor_diag) {
            why = IS_TREE(ltyp) ? __sl29 : (IS_OBSTRUCTED(ltyp) ? __sl30 : (odoor_diag ? __sl31 : __sl32));
            if (odoor_diag)
                You(__sl33);
            pline(__sl34);
            ...
            if (bigmonst(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)) || too_much) {
                why = __sl41;
    ...
    if ((mon = (cptr.ldPtro3(svl, x, 168, y, 8, $instance_globals_saved_l_level + $dlevel_t_monsters))) !== null) {
        ...
        if (!((glyph_is_normal_male_monster(glyph) || glyph_is_normal_female_monster(glyph)) || (glyph_is_male_pet(glyph) || glyph_is_female_pet(glyph)) || (glyph_is_ridden_male_monster(glyph) || glyph_is_ridden_female_monster(glyph)) || (glyph_is_detected_male_monster(glyph) || glyph_is_detected_female_monster(glyph))) && !glyph_is_invisible(glyph))
...
function check_shop_obj(obj, x, y, broken) {
    ...
    if (broken || !costly_xy || cptr.ld1s(in_rooms(x, y, NHC.SHOPBASE)) != cptr.ld1so(u, $you_ushops)) {
        ...
        if (cptr.ld1s(oshops) == cptr.ld1so(u, $you_ushops) || cptr.ld1s(oshops) == cptr.ld1so(u, $you_ushops0)) {
            if (is_unpaid(obj)) {
                let gtg = Has_contents(obj) ? contained_gold(obj, 1) : 0n;
...
function toss_up(obj, hitsroof) {
    ...
    if (cptr.ld1so(obj, $obj_oclass) == NHC.POTION_CLASS) {
        ...
        let harmless = schar((stone_missile(obj) && (passes_walls(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)) && !unsolid(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data))) ? 1 : 0));
        let artimsg = 0;
...
export function throwit(obj, wep_mask, twoweap, oldslot) {
    ...
    if (((cptr.ldI32o(obj.v, $obj_cursed) & 1) | 0 || (cptr.ldI32o(obj.v, $obj_greased) & 1) | 0) && (cptr.ldI32o(u, $you_dx) || cptr.ldI32o(u, $you_dy)) && !(rng_log_enabled() ? (rng_log_set_caller(__sl6, 1526, __sl91), rn2(7)) : rn2(7))) {
        let slipok = 1;
        if ((is_ammo(obj.v) && matching_launcher(obj.v, uwep.v))) {
    ...
    if ((cptr.ldI32o(u, $you_uswallow) & 1)) {
        ...
        if (tethered_weapon)
            tmp_at(-3, i16(((cptr.ldI16o((obj.v), $obj_otyp) == NHC.STATUE) ? ((Hallucination()) ? (((random_monster(rn2_on_display_rng)) + ((!(rn2_on_display_rng)(2)) ? NHC.GLYPH_MON_MALE_OFF : NHC.GLYPH_MON_FEM_OFF)) | 0) : ((cptr.ldI32o((obj.v), $obj_corpsenm) + (((cptr.ld1so((obj.v), $obj_spe) & NHM.CORPSTAT_GENDER) == NHM.CORPSTAT_FEMALE) ? ((cptr.ld1so((obj.v), $obj_where) == NHM.OBJ_FLOOR && ((cptr.stPtro(go, $instance_globals_o_otg_otmp, cptr.ldPtro(cptr.ldPtro3(svl, cptr.ldI16o((obj.v), $obj_ox), 168, cptr.ldI16o((obj.v), $obj_oy), 8, $instance_globals_saved_l_level + $dlevel_t_objects), $obj_v))) !== null) && (cptr.ldI16o((obj.v), $obj_otyp) != NHC.BOULDER || cptr.ldI16o(cptr.ldPtro(go, $instance_globals_o_otg_otmp), $obj_otyp) == NHC.BOULDER)) ? NHC.GLYPH_STATUE_FEM_PILETOP_OFF : NHC.GLYPH_STATUE_FEM_OFF) : ((cptr.ld1so((obj.v), $obj_where) == NHM.OBJ_FLOOR && ((cptr.stPtro(go, $instance_globals_o_otg_otmp, cptr.ldPtro(cptr.ldPtro3(svl, cptr.ldI16o((obj.v), $obj_ox), 168, cptr.ldI16o((obj.v), $obj_oy), 8, $instance_globals_saved_l_level + $dlevel_t_objects), $obj_v))) !== null) && (cptr.ldI16o((obj.v), $obj_otyp) != NHC.BOULDER || cptr.ldI16o(cptr.ldPtro(go, $instance_globals_o_otg_otmp), $obj_otyp) == NHC.BOULDER)) ? NHC.GLYPH_STATUE_MALE_PILETOP_OFF : NHC.GLYPH_STATUE_MALE_OFF))) | 0)) : ((Hallucination()) ? (((cptr.stI32o(go, $instance_globals_o_otg_temp, random_object(rn2_on_display_rng))) == NHC.CORPSE) ? ((random_monster(rn2_on_display_rng) + NHC.GLYPH_BODY_OFF) | 0) : ((cptr.ldI32o(go, $instance_globals_o_otg_temp) + NHC.GLYPH_OBJ_OFF) | 0)) : ((cptr.ldI16o((obj.v), $obj_otyp) == NHC.CORPSE) ? (((cptr.ldI32o((obj.v), $obj_corpsenm) + ((cptr.ld1so((obj.v), $obj_where) == NHM.OBJ_FLOOR && ((cptr.stPtro(go, $instance_globals_o_otg_otmp, cptr.ldPtro(cptr.ldPtro3(svl, cptr.ldI16o((obj.v), $obj_ox), 168, cptr.ldI16o((obj.v), $obj_oy), 8, $instance_globals_saved_l_level + $dlevel_t_objects), $obj_v))) !== null) && (cptr.ldI16o((obj.v), $obj_otyp) != NHC.BOULDER || cptr.ldI16o(cptr.ldPtro(go, $instance_globals_o_otg_otmp), $obj_otyp) == NHC.BOULDER)) ? NHC.GLYPH_BODY_PILETOP_OFF : NHC.GLYPH_BODY_OFF)) | 0)) : (obj_is_generic(obj.v) ? (((cptr.ld1so((obj.v), $obj_oclass) + ((cptr.ld1so((obj.v), $obj_where) == NHM.OBJ_FLOOR && ((cptr.stPtro(go, $instance_globals_o_otg_otmp, cptr.ldPtro(cptr.ldPtro3(svl, cptr.ldI16o((obj.v), $obj_ox), 168, cptr.ldI16o((obj.v), $obj_oy), 8, $instance_globals_saved_l_level + $dlevel_t_objects), $obj_v))) !== null) && (cptr.ldI16o((obj.v), $obj_otyp) != NHC.BOULDER || cptr.ldI16o(cptr.ldPtro(go, $instance_globals_o_otg_otmp), $obj_otyp) == NHC.BOULDER)) ? NHC.GLYPH_OBJ_PILETOP_OFF : NHC.GLYPH_OBJ_OFF)) | 0)) : (((cptr.ldI16o((obj.v), $obj_otyp) + ((cptr.ld1so((obj.v), $obj_where) == NHM.OBJ_FLOOR && ((cptr.stPtro(go, $instance_globals_o_otg_otmp, cptr.ldPtro(cptr.ldPtro3(svl, cptr.ldI16o((obj.v), $obj_ox), 168, cptr.ldI16o((obj.v), $obj_oy), 8, $instance_globals_saved_l_level + $dlevel_t_objects), $obj_v))) !== null) && (cptr.ldI16o((obj.v), $obj_otyp) != NHC.BOULDER || cptr.ldI16o(cptr.ldPtro(go, $instance_globals_o_otg_otmp), $obj_otyp) == NHC.BOULDER)) ? NHC.GLYPH_OBJ_PILETOP_OFF : NHC.GLYPH_OBJ_OFF)) | 0))))))));
        ...
        crossbowing = schar(((is_ammo(obj.v) && matching_launcher(obj.v, uwep.v)) && weapon_type(uwep.v) == NHC.P_CROSSBOW ? 1 : 0));
    ...
    if (!cptr.ldPtro(gt, $instance_globals_t_thrownobj)) {
        ...
        if ((!((cptr.ld1so3(svl, cptr.ldI16o(gb, $instance_globals_b_bhitpos), 756, cptr.ldI16o(gb, $instance_globals_b_bhitpos + $nhcoord_y), 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.AIR || (cptr.ld1so3(svl, cptr.ldI16o(gb, $instance_globals_b_bhitpos), 756, cptr.ldI16o(gb, $instance_globals_b_bhitpos + $nhcoord_y), 36, $instance_globals_saved_l_level + $rm_typ)) == NHC.CLOUD || ((cptr.ld1so3(svl, cptr.ldI16o(gb, $instance_globals_b_bhitpos), 756, cptr.ldI16o(gb, $instance_globals_b_bhitpos + $nhcoord_y), 36, $instance_globals_saved_l_level + $rm_typ)) >= NHC.POOL && (cptr.ld1so3(svl, cptr.ldI16o(gb, $instance_globals_b_bhitpos), 756, cptr.ldI16o(gb, $instance_globals_b_bhitpos + $nhcoord_y), 36, $instance_globals_saved_l_level + $rm_typ)) <= NHC.DRAWBRIDGE_UP)) && breaktest(obj.v)) || cptr.ld1so(obj.v, $obj_oclass) == NHC.VENOM_CLASS) {
            ...
            nh_delay_output()();
            tmp_at(-7, 0);
            breakmsg(obj.v, schar(cansee(cptr.ldI16o(gb, $instance_globals_b_bhitpos), cptr.ldI16o(gb, $instance_globals_b_bhitpos + $nhcoord_y))));
...
function tmiss(obj, mon, maybe_wakeup) {
    ...
    if (!canseemon(mon) || (M_AP_TYPE(mon) && M_AP_TYPE(mon) != NHC.M_AP_MONSTER))
...
export function thitmonst(mon, obj) {
    ...
    let otyp = cptr.ldI16o(obj, $obj_otyp);
    let hmode;
    let guaranteed_hit = schar(engulfing_u(mon));
    let dieroll;
    ...
    if (is_orc(cptr.ldPtro(mon, $monst_data)) && (Upolyd() ? (is_elf(cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data))) : ((cptr.ldI16o(gu, $instance_globals_u_urace + $Race_mnum) == NHC.PM_ELF))))
        tmp++;
    if (guaranteed_hit) {
        tmp = (tmp + 1000) | 0;
    }
    if (cptr.ld1so(obj, $obj_oclass) == NHC.GEM_CLASS && (cptr.ld1so((cptr.ldPtro(mon, $monst_data)), $permonst_mlet) == NHC.S_UNICORN && likes_gems(cptr.ldPtro(mon, $monst_data))) && ((cptr.ldI32o2(objects, cptr.ldI16o(obj, $obj_otyp), 120, $objclass_oc_material) & 31) | 0) != NHC.MINERAL && !(uwep.v && cptr.ld1so2(objects, cptr.ldI16o(uwep.v, $obj_otyp), 120, $objclass_oc_subtyp) == NHC.P_SLING)) {
        if (helpless(mon)) {
            tmiss(obj, mon, 0);
            return 0;
...
export function hero_breaks(obj, x, y, breakflags) {
    ...
    let in_view = schar((Blind() ? 0 : (from_invent || cansee(x, y) ? 1 : 0)));
...
export function breaks(obj, x, y) {
    let in_view = schar((Blind() ? 0 : cansee(x, y)));
    if (!breaktest(obj))
        return 0;
    breakmsg(obj, in_view);
