...
function put_monsters_to_sleep(distance) {
    ...
    for (mtmp = cptr.ldPtro(svl, $instance_globals_saved_l_level + $dlevel_t_monlist); mtmp; mtmp = cptr.ldPtr(mtmp)) {
        if ((cptr.ldI32o((mtmp), $monst_mhp) < 1))
            continue;
        if (dist2((cptr.ldI16o((mtmp), $monst_mx)), (cptr.ldI16o((mtmp), $monst_my)), cptr.ldI16(u), cptr.ldI16o(u, $you_uy)) < distance && sleep_monst(mtmp, d(10, 10), NHC.TOOL_CLASS)) {
...
function do_pit(x, y, tu_pit) {
    ...
    if (mtmp) {
        ...
        if (Levitation() || Flying() || ((cptr.ldU64o((cptr.ldPtro(gy, $instance_globals_y_youmonst + $monst_data)), $permonst_mflags1) & 16n) != 0n)) {
            ...
            losehp(((Half_physical_damage()) ? ((((rnd(6) + 1) | 0) / 2) | 0) : rnd(6)), __s_fell_into_a_chasm, NHM.NO_KILLER_PREFIX);
            ...
            set_utrap(((rn2(6) + 2) | 0) >>> 0, NHC.TT_PIT);
            losehp(((Half_physical_damage()) ? ((((rnd(keepfooting ? 2 : 4) + 1) | 0) / 2) | 0) : rnd(keepfooting ? 2 : 4)), __s_hurt_in_a_chasm, NHM.NO_KILLER_PREFIX);
            if (keepfooting)
...
function do_improvisation(instr) {
    ...
    switch (cptr.ldI16o(itmp, $obj_otyp)) {
        ...
        if (!mundane) {
            ...
            You(__s_s_s__2, rn2(2) ? __s_butcher : (rn2(2) ? __s_manage : __s_pull_off), an(cptr.ldPtro(beats, rn2(8), 8)));
            ;
        }
