...
function make_corpse(mtmp, corpseflags) {
    ...
    switch (mndx) {
        ...
        num = d(2, 4);
        while (num--) {
            obj.v = mksobj_at(rn2(2) ? NHC.QUARTERSTAFF : (rn2(3) ? NHC.SMALL_SHIELD : (rn2(3) ? NHC.CLUB : (rn2(3) ? NHC.ELVEN_SPEAR : NHC.BOOMERANG))), x, y, 1, 0);
        }
        free_mgivenname(mtmp);
        break;
        ...
        num = rn2(3);
        while (num-- > 0) {
            obj.v = mksobj_at(rn2(2) ? NHC.LEASH : (rn2(3) ? NHC.BULLWHIP : NHC.GRAPPLING_HOOK), x, y, 1, 0);
        }
        free_mgivenname(mtmp);
        break;
        ...
        num = d(2, 4);
        while (num--)
            obj.v = mksobj_at(rn2(4) ? NHC.LEATHER_ARMOR : (rn2(3) ? NHC.LEATHER_CLOAK : NHC.SADDLE), x, y, 1, 0);
        free_mgivenname(mtmp);
        break;
...
export function m_consume_obj(mtmp, otmp) {
    ...
    if (cptr.eq(otmp, uball.v)) {
        ...
        if (cptr.ldI16o(otmp, $obj_otyp) == NHC.EGG && corpsenm == NHC.PM_PYROLISK)
            explode(cptr.ldI16o(mtmp, $monst_mx), cptr.ldI16o(mtmp, $monst_my), -11, d(3, 6), 0, NHC.EXPL_FIERY);
...
export function mpickstuff(mtmp) {
    ...
    if (!cptr.ld1so(mtmp, $monst_mtame) && cptr.ld1s(in_rooms(cptr.ldI16o(mtmp, $monst_mx), cptr.ldI16o(mtmp, $monst_my), NHC.SHOPBASE)) && rn2(25))
        return 0;
...
export function mondead(mtmp) {
    ...
    if (cptr.eq(cptr.ldPtro(mtmp, $monst_data), cptr.add(mons, NHC.PM_STEAM_VORTEX, $sizeof_permonst)))
        create_gas_cloud(cptr.ldI16o(mtmp, $monst_mx), cptr.ldI16o(mtmp, $monst_my), (rn2(10) + 5) | 0, 0);  /* harmless */
...
function m_respond_shrieker(mtmp) {
    ...
    if (!rn2(10)) {
        ...
        void makemon(rn2(13) ? null : cptr.add(mons, (cptr.ld1uo2(mons, NHC.PM_PURPLE_WORM, $sizeof_permonst, $permonst_difficulty) > ((((((level_difficulty()) + cptr.ldI32o(u, $you_ulevel)) | 0) / 2) | 0))) ? NHC.PM_BABY_PURPLE_WORM : NHC.PM_PURPLE_WORM, $sizeof_permonst), 0, 0, NHM.NO_MM_FLAGS);
    }
    aggravate();
}
