...
export function strbuf_append(strbuf, str) {
    ...
    strbuf_reserve(strbuf, (len + (cptr.ldPtro(strbuf, FLD.strbuf_t_str) ? Number(BigInt.asIntN(32, cptr.strlen(cptr.ldPtro(strbuf, FLD.strbuf_t_str)))) : 0)) | 0);
...
export function strbuf_reserve(strbuf, len) {
    ...
    if (len > cptr.ldI32(strbuf)) {
        ...
        cptr.stPtro(strbuf, FLD.strbuf_t_str, alloc(cptr.ldI32(strbuf) >>> 0));
